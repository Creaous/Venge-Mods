pc.SpriteAnimationClip.prototype._onSpriteAssetLoad = function (t) {
    ...
    if (t.resource)
        if (t.resource.atlas) this.sprite = t.resource;
            ...
            s.off("load:" + e, this._onTextureAtlasLoad, this), s.once("load:" + e, this._onTextureAtlasLoad, this);
        }
    ...
    (function () {
        ...
        Tween.prototype = {
            to: function (t, i, e, n, s, r) {
                return (this._properties = _parseProperties(t)), (this.duration = i), e && (this.easing = e), n && this.delay(n), s && this.repeat(s), r && this.yoyo(r), this;
            },
            from: function (t, i, e, n, s, r) {
                return (this._properties = _parseProperties(t)), (this.duration = i), e && (this.easing = e), n && this.delay(n), s && this.repeat(s), r && this.yoyo(r), (this._from = !0), this;
            },
            rotate: function (t, i, e, n, s, r) {
                return (this._properties = _parseProperties(t)), (this.duration = i), e && (this.easing = e), n && this.delay(n), s && this.repeat(s), r && this.yoyo(r), (this._slerp = !0), this;
            },
            start: function () {
                var t, i, e, n;
            ...
            update: function (t) {
                ...
                ((!this._reverse && this.time > this.duration) || (this._reverse && this.time < 0)) &&
                    (this._count++, (this.complete = !0), (this.playing = !1), this._reverse ? ((i = this.duration - this.time), (this.time = 0)) : ((i = this.time - this.duration), (this.time = this.duration)));
                var e,
                    n,
                ...
                if (
                    ...
                    this.entity && (this.entity._dirtifyLocal(), this.element && this.entity.element && (this.entity.element[this.element] = this.target), this._slerp && this.entity.setLocalRotation(this._quat)),
                    this.fire("update", t),
                    this.complete)
                ) {
            ...
            ElasticInOut: function (t) {
                ...
                return 0 === t
                    ...
                    : (!e || e < 1 ? ((e = 1), (i = 0.1)) : (i = (n * Math.asin(1 / e)) / (2 * Math.PI)),
                      (t *= 2) < 1 ? e * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - i) * (2 * Math.PI)) / n) * -0.5 : e * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - i) * (2 * Math.PI)) / n) * 0.5 + 1);
            },
        };
    })()
),
...
var Utils = {
    ...
    getAssetFromURL: function (e, t) {
        var r = new pc.Asset(e, "texture", { url: "" }),
    ...
    preprocessUsername: function (e, t) {
        return t && !t.originalText ? ((t.originalText = e), this.usernames.push(t)) : (e = Utils.convertRainbow(e)), e;
    },
    ...
    displayUsername: function (e, t) {
        var r = 1;
        return Utils.nameIndex[e] ? (r = Utils.nameIndex[e]) : (Utils.currentNameIndex++, (Utils.nameIndex[e] = Utils.currentNameIndex + "")), pc.settings && !0 === pc.settings.hideUsernames ? "HIDDEN" + r : Utils.preprocessUsername(e, t);
    },
    ...
    slug: function (e) {
        ...
        for (var t = "àáäâèéëêìíïîòóöôùúüûñç·/_,:;", r = 0, n = t.length; r < n; r++) e = e.replace(new RegExp(t.charAt(r), "g"), "aaaaeeeeiiiioooouuuunc------".charAt(r));
        return (e = e
            .replace(/[^a-z0-9 -]/g, "")
            .replace(/\s+/g, "-")
            .replace(/-+/g, "-"));
    ...
    mmssmm: function (e) {
        var t = e,
            ...
            a = "MM:SS:XX";
        return n < 10 && (n = "0" + n), o < 10 && (o = "0" + o), r < 100 && (r = "0" + r), (a = (a = (a = a.replace(/MM/, o)).replace(/SS/, n)).replace(/XX/, r.toString().slice(0, 2)));
    },
    mmss: function (e) {
        var t = e,
            r = Math.floor((1e3 * t) % 1e3),
            ...
            o = Math.floor(((1e3 * t) / 6e4) % 60),
            a = "MM:SS";
        return n < 10 && (n = "0" + n), o < 10 && (o = "0" + o), r < 100 && (r = "0" + r), (a = (a = a.replace(/MM/, o)).replace(/SS/, n)), e >= 0 ? a : "00:00";
    },
    ...
    closestPointLine: function (e, t, r) {
        ...
        return (i = (r.x - t.x) * (e.y - t.y) - (r.y - t.y) * (e.x - t.x)), { point: { x: t.x + n * c, y: t.y + o * c }, left: i < 1, dot: i, t: c };
    },
...
var setMat4Forward = (function () {
    ...
    return (
        ...
        function (n, o, a) {
            ...
            var i = n.data;
            return (i[0] = e.x), (i[1] = e.y), (i[2] = e.z), (i[3] = 0), (i[4] = t.x), (i[5] = t.y), (i[6] = t.z), (i[7] = 0), (i[8] = r.x), (i[9] = r.y), (i[10] = r.z), (i[11] = 0), (i[15] = 1), n;
        }
    );
})();
...
Movement.attributes.add("defaultSpeed", { type: "number" }),
    Movement.attributes.add("defaultSensitivity", { type: "number" }),
    Movement.attributes.add("focusSensitivity", { type: "number" }),
    Movement.attributes.add("defaultLookSense", { type: "number" }),
    Movement.attributes.add("focusLookSense", { type: "number" }),
    Movement.attributes.add("focusSpeedFactor", { type: "number" }),
    Movement.attributes.add("strafingSpeed", { type: "number" }),
    Movement.attributes.add("nearGround", { type: "number", default: 4 }),
    Movement.attributes.add("collisionHeight", { type: "number" }),
    Movement.attributes.add("airHeight", { type: "number" }),
    Movement.attributes.add("groundFriction", { type: "number", default: 0.8 }),
    Movement.attributes.add("slideHopFriction", { type: "number", default: 0.2 }),
    Movement.attributes.add("jumpDuration", { type: "number" }),
    Movement.attributes.add("jumpForce", { type: "number" }),
    Movement.attributes.add("jumpHeightSpeed", { type: "number" }),
    Movement.attributes.add("jumpLandTime", { type: "number", default: 0.25 }),
    Movement.attributes.add("bounceJumpDuration", { type: "number" }),
    Movement.attributes.add("bounceJumpForce", { type: "number" }),
    Movement.attributes.add("gravity", { type: "number" }),
    Movement.attributes.add("gravitySpeed", { type: "number", default: 0.05 }),
    Movement.attributes.add("gravityStep", { type: "number" }),
    Movement.attributes.add("suicideHeight", { type: "number", default: -2 }),
    Movement.attributes.add("defaultFov", { type: "number" }),
    Movement.attributes.add("defaultNonFov", { type: "number", default: 75 }),
    Movement.attributes.add("airDamping", { type: "number" }),
    Movement.attributes.add("groundDamping", { type: "number" }),
    Movement.attributes.add("stopDamping", { type: "number" }),
    Movement.attributes.add("stoppingSpeed", { type: "number", default: 0.25 }),
    Movement.attributes.add("movementAnimationSpeed", { type: "number" }),
    Movement.attributes.add("movementAnimationFactor", { type: "number" }),
    Movement.attributes.add("movementAngleFactor", { type: "number" }),
    Movement.attributes.add("movementSwingSpeed", { type: "number" }),
    Movement.attributes.add("movementSwingFactor", { type: "number" }),
    Movement.attributes.add("footSpeed", { type: "number", default: 500 }),
    Movement.attributes.add("lookXEntity", { type: "entity" }),
    Movement.attributes.add("weaponPositionEntity", { type: "entity" }),
    Movement.attributes.add("focusPositionEntity", { type: "entity" }),
    Movement.attributes.add("cameraEntity", { type: "entity" }),
    Movement.attributes.add("cameraNonFOVEntity", { type: "entity" }),
    Movement.attributes.add("lookEntity", { type: "entity" }),
    Movement.attributes.add("farPoint", { type: "entity" }),
    Movement.attributes.add("autoLockEntity", { type: "entity" }),
    Movement.attributes.add("angleEntity", { type: "entity" }),
    Movement.attributes.add("armEntity", { type: "entity" }),
    Movement.attributes.add("armRightEntity", { type: "entity" }),
    Movement.attributes.add("shoulderEntity", { type: "entity" }),
    Movement.attributes.add("headEntity", { type: "entity" }),
    Movement.attributes.add("handEntity", { type: "entity" }),
    Movement.attributes.add("senseHolder", { type: "entity" }),
    Movement.attributes.add("movementHolder", { type: "entity" }),
    Movement.attributes.add("takePoint", { type: "entity" }),
    Movement.attributes.add("weaponCenter", { type: "entity" }),
    Movement.attributes.add("weaponFront", { type: "entity" }),
    Movement.attributes.add("gamepadLookPoint", { type: "entity" }),
    Movement.attributes.add("meleeCenter", { type: "entity" }),
    Movement.attributes.add("meleePoint", { type: "entity" }),
    Movement.attributes.add("meleePoints", { type: "entity", array: !0 }),
    Movement.attributes.add("shurikenPoint1", { type: "entity" }),
    Movement.attributes.add("shurikenPoint2", { type: "entity" }),
    Movement.attributes.add("shurikenPoint3", { type: "entity" }),
    Movement.attributes.add("axeEntity", { type: "entity" }),
    Movement.attributes.add("throwPoint", { type: "entity" }),
    Movement.attributes.add("interfaceEntity", { type: "entity" }),
    (Movement.prototype.initialize = function () {
        (this.locked = !1),
            ...
            (this.collision = { start: { name: "" }, end: { name: "" } }),
            (this.spreadCount = 0),
            (this.spreadNumber = 0),
            (this.jumpSpread = 0),
            ...
            (this.timer = { inspect0: !1, inspect1: !1, inspect2: !1 }),
            (this.tween = { inspect0: !1, inspect1: !1, inspect2: !1 }),
            (this.lastHeight = 0),
    ...
    (Movement.prototype.onMouseWheel = function (t) {
        ...
        t.wheelDelta < 0 ? this.entity.fire("Player:WeaponIndex", "Previous") : t.wheelDelta > 0 && this.entity.fire("Player:WeaponIndex", "Next");
    }),
    ...
    (Movement.prototype.onGamepadLook = function (t, i) {
        ...
        this.isFocusing
            ? ((this.lookX -= t * this.focusSensitivity * pc.settings.sensivity * this.mouseInvertAxis), (this.lookY -= i * this.focusSensitivity * pc.settings.sensivity * this.mouseInvertAxis))
            : ((this.lookX -= t * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis), (this.lookY -= i * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis)),
            this.isFocusing
                ? ((this.senseX -= t * this.focusLookSense * this.mouseInvertAxis), (this.senseY -= i * this.focusLookSense * this.mouseInvertAxis))
                : ((this.senseX -= t * this.defaultLookSense * this.mouseInvertAxis), (this.senseY -= i * this.defaultLookSense * this.mouseInvertAxis)),
            (this.lookX = this.lookX % 360);
    }),
    (Movement.prototype.onGamepadTick = function () {
        (this.isMobileForward = !1), (this.isMobileBackward = !1), (this.isMobileLeft = !1), (this.isMobileRight = !1);
    }),
    (Movement.prototype.onGamepadAction = function (t) {
        "JUMP" == t && this.jump(), "BUTTON1" == t && this.triggerKeyF(), "BUTTON2" == t && this.triggerKeyE(), "BUTTON3" == t && this.reload();
    }),
    ...
    (Movement.prototype.onRespawn = function () {
        (this.entity.rigidbody.linearVelocity.x = 0), (this.entity.rigidbody.linearVelocity.y = 0), (this.entity.rigidbody.linearVelocity.z = 0), (this.entity.collision.enabled = !0), this.setAmmoFull();
    }),
    ...
    (Movement.prototype.setCurrentWeapon = function () {
        (this.currentWeapon = this.entity.script.weaponManager.currentWeapon), (this.currentWeapon.player = this.entity), this.takeout(), (this.interface.capacityEntity.element.text = this.currentWeapon.capacity + "");
    }),
    (Movement.prototype.onCollisionStart = function (t) {
        return (
            ...
            !!pc.isMapLoaded &&
            (t.other &&
                (("Bounce" != t.other.name && "BouncePad" != t.other.name) || this.bounceJump(this.airTime, t.other),
                ("Water" == t.other.name || t.other.tags.list().indexOf("Water") > -1) && this.app.fire("Network:Drown", !0),
                "Kill" == t.other.name && this.app.fire("Network:RequestRespawn", this.entity.getPosition().clone()),
            ...
            void ((t.contacts[0].localPoint.y < -1.5 || (t.contacts[0].localPoint.y < 0.001 && t.other && "Box" == t.other.name)) && ((this.isCollided = !0), this.land())))
        );
    }),
    ...
    (Movement.prototype.setMouseState = function () {
        (this.isMouseLocked = pc.Mouse.isPointerLocked()), this.isMouseLocked ? this.app.fire("Overlay:Pause", !1) : this.app.fire("Overlay:Pause", !0), this.app.fire("Overlay:Message@Hide", !0);
    }),
    (Movement.prototype.onMouseDown = function (t) {
        return (
            ...
            2 === t.button && ((this.isFocusing = !0), (this.focusStartTime = this.now()), this.cancelInspect(!0), this.app.fire("Overlay:SetAmmo", !0)),
    ...
    (Movement.prototype.onMouseMove = function (t) {
        return (
            ...
            (this.isMouseLocked &&
                (this.isFocusing
                    ? ((this.lookX -= t.movementX * this.focusSensitivity * pc.settings.adsSensivity * this.animation.movementFactor),
                      (this.lookY -= t.movementY * this.focusSensitivity * pc.settings.adsSensivity * this.mouseInvertAxis * this.animation.movementFactor))
                    : ((this.lookX -= t.movementX * this.defaultSensitivity * pc.settings.sensivity * this.animation.movementFactor),
                      (this.lookY -= t.movementY * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis * this.animation.movementFactor)),
                this.isFocusing
                    ? ((this.senseX -= t.movementX * this.focusLookSense * this.mouseInvertAxis), (this.senseY -= t.movementY * this.focusLookSense * this.mouseInvertAxis))
                    : ((this.senseX -= t.movementX * this.defaultLookSense * this.mouseInvertAxis), (this.senseY -= t.movementY * this.defaultLookSense * this.mouseInvertAxis))),
    ...
    (Movement.prototype.onTouchShoot = function (t) {
        return !this.player.isDeath && !pc.isFinished && !this.locked && !pc.isPauseActive && !!this.isMobile && ((this.leftMouse = "true" == t), void this.scanShootables());
    }),
    ...
    (Movement.prototype.onMouseUp = function (t) {
        return !this.player.isDeath && !this.player.isGliding && !pc.isFinished && (2 === t.button && (this.isFocusing = !1), void (0 === t.button && (this.leftMouse && (this.isMouseReleased = !0), (this.leftMouse = !1))));
    }),
    (Movement.prototype.setCameraAngle = function (t) {
        (this.lookY = Math.max(-90, this.lookY)),
            ...
            this.isLanded ? (this.currentLook = this.lookX + this.animation.cameraImpact) : (this.currentLook = pc.math.lerpAngle(this.currentLook, this.lookX + this.animation.cameraImpact, 0.01)),
    ...
    (Movement.prototype.setHandAngle = function (t) {
        (this.senseX = pc.math.lerp(this.senseX, 0, 0.1)),
            ...
            this.senseHolder.setLocalEulerAngles(0.5 * this.senseX + 0.5 * this.senseY + this.animation.cameraImpact, 0.5 * this.senseX, 2 * -this.senseY);
    }),
    ...
    (Movement.prototype.setKeyboard = function () {
        return (
            ...
            (this.jumpingTime + this.jumpLandTime < this.timestamp && this.currentHeight < this.nearGround && ((this.isForward = !1), (this.isBackward = !1), (this.isLeft = !1), (this.isRight = !1)),
            ...
            this.app.keyboard.wasPressed(pc.KEY_X) && ((this.leftMouse = !0), (this.isMouseReleased = !0)),
            this.app.keyboard.wasReleased(pc.KEY_X) && (this.leftMouse = !1),
            this.app.keyboard.wasPressed(pc.KEY_L) && (this.app.mouse.enablePointerLock(), this.app.fire("Overlay:Pause", !1)),
    ...
    (Movement.prototype.setMovement = function () {
        ...
        (e *= this.animation.movementFactor),
            ...
            this.currentWeapon && "Heavy" == this.currentWeapon.weight ? ((e *= 0.75), (this.animation.movementFactorStatic = 0.65)) : (this.animation.movementFactorStatic = 1),
            (this.force.x = 0),
            (this.force.z = 0),
            !this.isForward || this.isLeft || this.isRight ? this.isForward && ((this.force.x += t.x * o * e), (this.force.z += t.z * o * e)) : ((this.force.x += t.x * s * e), (this.force.z += t.z * s * e)),
    ...
    (Movement.prototype.setMovementAnimation = function (t) {
        ...
        var i = Math.sin(this.forwardCount / this.movementAnimationSpeed) * this.movementAnimationFactor * this.movementSpeed * this.animation.movementFactor * this.animation.movementFactorStatic * pc.settings.weaponBobbing,
            ...
            o = Math.cos(this.forwardCount / this.movementSwingSpeed) * this.movementSwingFactor * this.movementSpeed * pc.settings.weaponBobbing;
        !this.isFocusing && this.movementSpeed > 0.8
            ? (this.animation.movementPositionZ = pc.math.lerp(this.animation.movementPositionZ, -0.04, 0.08))
            : (this.animation.movementPositionZ = pc.math.lerp(this.animation.movementPositionZ, 0, 0.1)),
            this.isJumping ? ((i = 0), (e = 0), (s = 0), (this.animation.jumpHeight = pc.math.lerp(this.animation.jumpHeight, this.deltaHeight, 0.15))) : (this.animation.jumpHeight = pc.math.lerp(this.animation.jumpHeight, 0, 0.1));
        ...
        p = Math.min(p, 0.08);
        var m = 0.4;
        this.currentWeapon && "Shotgun" == this.currentWeapon.type && (m = 0.8);
        var c = this.handEntity.getLocalPosition().lerp(this.handEntity.getLocalPosition(), n.getLocalPosition(), m);
        this.currentWeapon && "Sniper" == this.currentWeapon.type && this.isFocusing && this.now() - this.focusStartTime > 60
            ? ((this.currentWeapon.modelEntity.enabled = !1), (this.currentWeapon.armEntity.enabled = !1), (this.currentWeapon.scopeOverlay.enabled = !1))
            : ((this.currentWeapon.modelEntity.enabled = !0), this.currentWeapon.armEntity && (this.currentWeapon.armEntity.enabled = !0)),
            this.handEntity.setLocalPosition(c),
            this.movementHolder.setLocalPosition(0.1 * s * a + this.animation.bounceZ + this.animation.movementPositionZ, (i + p) * a + this.animation.landAngle * a, 0.2 * -s * a),
        ...
        if (
            ...
            this.movementHolder.setLocalEulerAngles(
                u + this.animation.movementAngleX + this.animation.shootSwing + this.directionSenseX + s * this.movementAngleFactor * a + this.animation.jumpAngle * a * this.randomDirection,
            ...
            this.headEntity.setLocalEulerAngles(0.2 * -this.animation.jumpAngle * a - this.animation.cameraShootBounce, 0, 0),
            this.weaponCenter.setLocalEulerAngles(
                ...
                this.animation.bounceAngle + this.animation.activeBounce + this.animation.weaponAngleZ + 80 * e * a
            ),
            ...
            this.isLeft
                ...
                : this.currentSpeed > 0.1 && ((this.forwardCount += t), (this.movementSpeed = pc.math.lerp(this.movementSpeed, 0, 0.1))),
            this.isShooting < this.timestamp)
        ) {
            var l = 1;
            this.isFocusing && (l = 0.12),
                this.isLeft ? (this.directionSenseX = pc.math.lerp(this.directionSenseX, -25 * l, 0.07)) : this.isRight && (this.directionSenseX = pc.math.lerp(this.directionSenseX, 17 * l, 0.07)),
        ...
        if (
            ...
            this.isForward || this.isBackward || (this.movementSpeed = pc.math.lerp(this.movementSpeed, 0, 0.05)),
            this.isLeft || this.isRight || (this.movementSpeed = pc.math.lerp(this.movementSpeed, 0, 0.01)),
            this.isJumping ? (this.lastHeight > this.currentHeight ? (this.deltaHeight += t * this.jumpHeightSpeed) : (this.deltaHeight -= t * this.jumpHeightSpeed)) : (this.deltaHeight = pc.math.lerp(this.deltaHeight, 0, 0.01)),
        ...
        pc.isFinished || this.locked || ("Melee" != this.currentWeapon.type && (pc.settings.hideArms || (this.interface.crosshairEntity.enabled = !this.isFocusing), (this.interface.focusBulletsEntity.enabled = this.isFocusing))),
    ...
    (Movement.prototype.triggerKeyE = function () {
        return !(this.playerAbilities.isHitting > this.timestamp) && !this.player.isGliding && (this.cancelReload(), !this.playerAbilities.isThrowing && (this.cancelInspect(!0), void this.playerAbilities.triggerKeyE()));
    }),
    (Movement.prototype.triggerKeyF = function () {
        return this.now() - this.lastThrowDate < 1e3 * this.playerAbilities.throwCooldown
            ...
            : !(this.isReloading > this.timestamp) &&
                  ...
                  !this.player.isGliding &&
                  ((this.isFocusing = !1), this.player.throw(), this.stopFiring(), this.playerAbilities.triggerKeyF(), void (this.lastThrowDate = this.now()));
    }),
    (Movement.prototype.now = function () {
        return this.app._time;
    }),
    (Movement.prototype.slowMovement = function (t) {
        this.app.tween(this.animation).to({ movementFactor: 0.1 }, t, pc.Linear).start();
    }),
    (Movement.prototype.fastMovement = function () {
        this.app.tween(this.animation).to({ movementFactor: 1 }, 0.4, pc.Linear).start();
    }),
    (Movement.prototype.enableMovement = function () {
        (this.isForward = !1), (this.isBackward = !1), (this.isLeft = !1), (this.isRight = !1), pc.isFinished || (this.interface.crosshairEntity.enabled = !0), (this.locked = !1);
    }),
    ...
    (Movement.prototype.setFocus = function (t) {
        t || ((this.isFocusing = !1), (this.isFocused = !1), (this.isShooting = !1), (this.leftMouse = !1), (this.isMouseReleased = !0), this.disableZoom());
    }),
                ...
                : (Math.random() > 0.6 && this.app.fire("Player:Speak", "Attack", 4),
                  !(Math.random() > 0.8) &&
                      ...
                      (this.timer.inspect0 = setTimeout(
                          function (t) {
                              t.tween.inspect0 = t.app.tween(t.animation).to({ movementAngleX: 26.2, movementAngleY: 47.65, movementAngleZ: 2.89 }, 0.5, pc.BackInOut).start();
                          },
                          1,
                          this
                      )),
                      (this.timer.inspect1 = setTimeout(
                          function (t) {
                              t.tween.inspect1 = t.app.tween(t.animation).to({ movementAngleX: -66.53, movementAngleY: 18.52, movementAngleZ: 20.29 }, 0.6, pc.BackInOut).start();
                          },
                          1200,
                          this
                      )),
                      (this.timer.inspect2 = setTimeout(
                          function (t) {
                              t.tween.inspect2 = t.app.tween(t.animation).to({ movementAngleX: 0, movementAngleY: 0, movementAngleZ: 0 }, 0.5, pc.BackInOut).start();
                          },
                          2e3,
                          this
                      )),
    ...
    (Movement.prototype.cancelInspect = function (t) {
        t
            ? ((this.animation.movementAngleX = 0), (this.animation.movementAngleY = 0), (this.animation.movementAngleZ = 0), (this.inspectAfterReload = !1))
            : setTimeout(
                  function (t) {
                      (t.animation.movementAngleX = 0), (t.animation.movementAngleY = 0), (t.animation.movementAngleZ = 0);
                  },
                  500,
                  this
              ),
    ...
    (Movement.prototype.reload = function () {
        return (
            ...
            !0 === this.currentWeapon.hiddenReload
                ? ((this.timerTween[0] = this.app.tween(this.animation).to({ takeX: 19.86, takeY: 7.07, takeZ: -39.62 }, 0.4 * 0.45 * this.reloadingTime, pc.BackInOut)), this.timerTween[0].start())
                : "Shotgun" == this.currentWeapon.type
                ? ((this.timerTween[0] = this.app.tween(this.animation).to({ weaponAngleX: -68.27, weaponAngleY: 29.63, weaponAngleZ: -14.15 }, 0.4 * 0.45 * this.reloadingTime, pc.BackInOut)),
                  ...
                  this.timerBag.push(
                      setTimeout(
                          function (t) {
                              (t.timerTween[1] = t.app.tween(t.animation).to({ weaponAngleX: -65.42, weaponAngleY: 9.84, weaponAngleZ: 0, bounceAngle: 15 }, 0.1, pc.BackInOut)), t.timerTween[1].start(), t.currentWeapon.magazineThrow();
                          },
                          180 * this.reloadingTime,
                          this
                      )
                  ))
                : ((this.timerTween[2] = this.app.tween(this.animation).to({ weaponAngleX: 29.25, weaponAngleY: 6.02, weaponAngleZ: 30.34 }, 0.4 * 0.45 * this.reloadingTime, pc.BackInOut)),
                  ...
                  this.timerBag.push(
                      setTimeout(
                          function (t) {
                              (t.timerTween[3] = t.app.tween(t.animation).to({ weaponAngleX: 32.25, weaponAngleY: 4.02, weaponAngleZ: 30.34, bounceAngle: 15 }, 0.1, pc.BackInOut)), t.timerTween[3].start(), t.currentWeapon.magazineThrow();
                          },
                          180 * this.reloadingTime,
                          this
                      )
            ...
            this.timerBag.push(
                setTimeout(
                    function (t) {
                        (t.timerTween[4] = t.app.tween(t.animation).to({ bounceAngle: -5 }, 0.1, pc.BackInOut)), t.timerTween[4].start(), t.currentWeapon.magazineAttach();
                    },
            ...
            !1 === this.currentWeapon.hiddenReload &&
                this.timerBag.push(
                    setTimeout(
                        function (t) {
                            (t.timerTween[5] = t.app.tween(t.animation).to({ weaponAngleX: -68.27, weaponAngleY: 29.63, weaponAngleZ: -14.15 }, 0.3, pc.BackInOut)), t.timerTween[5].start();
                        },
            ...
            this.timerBag.push(
                setTimeout(
                    function (t) {
                        (t.timerTween[6] = t.app.tween(t.animation).to({ bounceZ: -0.1 }, 0.15, pc.BackInOut)), t.timerTween[6].start(), t.currentWeapon.reload();
                    },
            ...
            this.timerBag.push(
                setTimeout(
                    function (t) {
                        (t.timerTween[7] = t.app.tween(t.animation).to({ weaponAngleX: 0, weaponAngleY: 0, weaponAngleZ: 0 }, 0.15, pc.BackInOut)), t.timerTween[7].start(), t.takeout();
                    },
    ...
    (Movement.prototype.hideWeapon = function () {
        (this.isWeaponHidden = !0), this.app.tween(this.animation).to({ takeX: -0.52, takeY: 22.19, takeZ: -55.11 }, 0.3, pc.BackInOut).start(), this.entity.sound.play("Takeout"), this.interface.hidePrepare();
    }),
    (Movement.prototype.takeout = function () {
        (this.isWeaponHidden = !1),
            ...
            this.app.tween(this.animation).to({ takeX: 0, takeY: 0, takeZ: 0 }, 0.3, pc.BackInOut).start(),
            this.entity.sound.play("Takeout"),
            this.interface.hidePrepare(),
    ...
    (Movement.prototype.impact = function () {
        ...
        if ((this.app.tween(this.animation).to({ cameraImpact: -t }, 0.09, pc.BackOut).start(), this.now() - this.lastImpactTime < 2e3)) return !1;
    ...
    (Movement.prototype.disableZoom = function () {
        (this.isZoomEffectEnabled = !1), (this.isFocusing = !1), (this.isFocused = !1), this.currentWeapon && "Sniper" == this.currentWeapon.type && (this.currentWeapon.scopeOverlay.enabled = !1);
    }),
    ...
    (Movement.prototype.jump = function () {
        ...
        if (
            ...
            this.app.fire("Character:Sound", t, 0.1 * Math.random()), this.entity.sound.play("Only-Jump"), (this.entity.sound.slots["Only-Jump"].pitch = 0.1 * Math.random() + 1.1);
        }
        if (((this.dynamicGravity = 0), this.app.fire("Overlay:Jump", !0), this.player.fireNetworkEvent("j"), this.isShooting > this.timestamp)) return !1;
        this.app.tween(this.animation).to({ jumpAngle: -11 }, 0.15, pc.BackOut).start();
    }),
    (Movement.prototype.bounceJump = function (t, i) {
        ...
        if (i) {
            var s = i.tags.list();
            s.indexOf("Very-Long") > -1 ? (e = 1.65) : s.indexOf("Long") > -1 ? (e = 1.25) : s.indexOf("Short") > -1 && (e = 0.7);
        }
        if (
            ((this.airTime = this.now()),
            ...
            return !1;
        this.app.tween(this.animation).to({ jumpAngle: -18, cameraShootBounce: 2, fov: 10 }, 0.15, pc.BackOut).start();
    }),
        ...
        if (Math.abs(this.currentHeight - this.lastHeight) > 0.1) {
            ...
            this.entity.sound.play("Land-" + i),
                this.app
                    ...
                    .to({ landAngle: -0.4 * t, cameraShootBounce: -5 * t }, 0.15, pc.BackOut)
                    .start(),
                (this.footForce = 1);
        }
    }),
    (Movement.prototype.setDamping = function (t) {
        if (this.player.isGliding) (this.entity.rigidbody.linearDamping = this.airDamping), this.entity.rigidbody.applyForce(0, 0.5 * this.gravity, 0);
        else if (this.currentHeight > this.defaultHeight && !this.isLanded && !this.playerAbilities.isDashing) {
            var i = Math.min((this.now() - this.airTime) / 1e3, 1);
            (this.dynamicGravity += t * this.gravityStep * this.gravityStep), (this.entity.rigidbody.linearDamping = this.airDamping), this.entity.rigidbody.applyForce(0, this.gravity + this.gravity * i - this.dynamicGravity, 0);
        } else this.movementSpeed < 0.5 ? (this.entity.rigidbody.linearDamping = pc.math.lerp(this.entity.rigidbody.linearDamping, this.stopDamping, this.stoppingSpeed)) : (this.entity.rigidbody.linearDamping = this.groundDamping);
    }),
    (Movement.prototype.setCurrentValues = function (t) {
        this.isLanded ? (this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, 0.2)) : (this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, 0.05)),
    ...
    (Movement.prototype.setGravity = function () {
        ...
        (this.lastHeight = n),
            ...
            this.jumpingTime > this.timestamp && (this.entity.rigidbody.applyForce(0, this.jumpForce, 0), this.entity.rigidbody.applyForce(this.lastVelocity)),
            this.currentHeight > this.collisionHeight
                ? (this.isLanded && (this.lastVelocity = this.entity.rigidbody.linearVelocity.clone()), (this.isLanded = !1))
                : ((this.isLanded = !0),
    ...
    (Movement.prototype.stopMeleeShooting = function () {
        clearTimeout(this.meleeShootingTimer),
            (this.meleeShootingTimer = setTimeout(
                function (t) {
                    t.app.tween(t.animation).to({ takeX: 0, takeY: 0, takeZ: 0 }, 0.1, pc.BackOut).start();
                },
                450,
                this
            ));
    ...
    (Movement.prototype.setThrowShoot = function () {
        this.leftMouse &&
            ...
            this.isShooting > this.timestamp &&
                ...
                this.app.tween(this.animation).rotate({ takeX: -17.14, takeY: -30.81, takeZ: 42.11 }, 0.2, pc.BackOut).start(),
                setTimeout(
                    function (t) {
                        t.app.tween(t.animation).rotate({ takeX: 0, takeY: 0, takeZ: -67.42 }, 0.1, pc.BackOut).start();
                    },
                    200,
                    this
                ),
        ...
        if (
            ...
            if (
                ...
                this.meleeShootingIndex % 2 == 0
                    ? (this.app.tween(this.animation).rotate({ takeX: 137.28, takeY: 0, takeZ: 52.78 }, 0.05, pc.BackOut).start(),
                      setTimeout(
                          function (t) {
                              t.app.tween(t.animation).rotate({ takeX: 137.28, takeY: 110, takeZ: 52.78 }, 0.2, pc.BackOut).start();
                          },
                          100,
                          this
                      ),
                      setTimeout(
                          function (t) {
                              t.playerAbilities.meleeTrigger(t.currentWeapon.damage), t.app.fire("WeaponManager:Swing", "Right");
                          },
                          160,
                          this
                      ))
                    : (this.app.tween(this.animation).to({ takeX: 21.08, takeY: 63.2, takeZ: 17.45 }, 0.05, pc.BackOut).start(),
                      setTimeout(
                          function (t) {
                              t.app.tween(t.animation).to({ takeX: 22.87, takeY: -71.2, takeZ: -26.46 }, 0.3, pc.BackOut).start();
                          },
                          100,
                          this
                      ),
                      setTimeout(
                          function (t) {
                              t.playerAbilities.meleeTrigger(t.currentWeapon.damage), t.app.fire("WeaponManager:Swing", "Left");
                          },
                          160,
                          this
                      )),
            ...
            this.stopMeleeShooting(), this.meleeShootingIndex++, (this.isShootingLocked = !0), (this.isShooting = this.currentWeapon.shootTime + this.timestamp);
        }
        this.isShooting < this.timestamp && this.isShootingLocked && (this.isShootingLocked = !1);
    }),
    (Movement.prototype.stopMeleeShooting = function () {
    ...
    (Movement.prototype.setShakeAnimation = function (t) {
        ...
        this.isFocusing && "Rifle" == this.currentWeapon.type && ((o = -0.05), (n = 0.5), (a = -0.2), (e *= 0.5), (h = 0.05), (r = this.currentWeapon.focusSpread), (m = this.currentWeapon.focusSpread * p)),
            ("Sniper" != this.currentWeapon.type && "Shotgun" != this.currentWeapon.type) || ((a = -5), (h = 5.2)),
            (this.lookY += 0.04 * e),
            (this.spreadNumber = pc.math.lerp(this.spreadNumber, r, 0.1)),
            (this.spreadCount += t),
            this.currentWeapon.ammo--,
            this.app.fire("Overlay:Shoot", !0),
            this.app.tween(this.animation).to({ bounceX: s, bounceZ: o, bounceAngle: n, shootSwing: h }, 0.03, pc.BackOut).start(),
            this.app
                .tween(this.animation)
                .to({ cameraShootBounce: a, cameraBounce: this.animation.cameraBounce + 0.025 * e }, 0.09, pc.BackOut)
                .start(),
            (this.animation.activeBounce = pc.math.lerp(this.animation.activeBounce, -e, 0.05)),
            (this.animation.horizantalSpread = pc.math.lerp(this.animation.horizantalSpread, 0.04 * m, 0.1));
    }),
    (Movement.prototype.updateShakeAnimation = function () {
        this.isShooting > this.timestamp + 0.1 && (this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, 0.2)),
    ...
    (Movement.prototype.setShooting = function (t) {
        ...
        if (
            ...
            this.cancelInspect(!0),
                ...
                ("Sniper" != this.currentWeapon.type && "Shotgun" != this.currentWeapon.type) || ((this.spreadNumber = this.currentWeapon.spread), this.isFocusing && (this.spreadNumber = this.currentWeapon.focusSpread), -5, 5.2),
                this.currentWeapon.shoot(),
            ...
            var o = this.currentWeapon.muzzlePoint.getPosition().clone(),
                ...
                c = this.currentWeapon.distanceMultiplier;
            if ("Shotgun" == this.currentWeapon.type) {
                this.app.fire("EffectManager:Fire", n, p, o, this.player.playerId, m, "Shotgun", c);
                for (var u = 1, l = 0; l < 10; l++)
                    l > 5 && (u = 0.5),
                        ...
                        (p = this.raycastTo.clone().add(new pc.Vec3(a, h, r))),
                        this.app.fire("EffectManager:Fire", n, p, o, this.player.playerId, m, "Shotgun", c);
            } else this.app.fire("EffectManager:Fire", n, p, o, this.player.playerId, m);
    ...
    (Movement.prototype.shake = function () {
        this.app
            .tween(this.animation)
            .to({ cameraShootBounce: 1, cameraBounce: this.animation.cameraBounce + 0.025 }, 0.15, pc.BackOut)
            .start();
    }),
    (Movement.prototype.stopFiring = function () {
        this.currentWeapon && !this.isFireStopped && this.currentWeapon.stopShooting(), (this.isFireStopped = !0);
    }),
    (Movement.prototype.setShootDirection = function () {
        var t = this.app.graphicsDevice.maxPixelRatio,
            i = (this.app.graphicsDevice.width, this.app.graphicsDevice.height, this.cameraEntity.getPosition()),
    ...
    (Movement.prototype.setAutoLock = function (t) {
        this.lastAutoLockTime < this.timestamp && ((this.nearestPlayerPosition = t), (this.lastAutoLockTime = this.timestamp + 0.1));
    }),
    (Movement.prototype.scanShootablesGamepad = function () {
        ...
        for (var e in i) {
            var s = i[e];
            if (s != this.entity && s.script.enemy && "-1" != s.script.enemy.isActivated) t.clone().sub(s.getPosition()).length() < 30 && this.app.fire("Touch:AutoLock", s.getPosition());
        }
    }),
    ...
    (Movement.prototype.checkGlitches = function (t) {
        this.entity.rigidbody.linearVelocity.length() > 300 || this.currentHeight > 100
            ? (this.glitchThreshold > 2 && this.app.fire("Network:Respawn", !0), (this.glitchThreshold += t))
    ...
    (Movement.prototype.update = function (t) {
        (this.lastDelta += t), this.setCameraAngle(), this.setKeyboard(), this.setGravity(), this.setMovement(), this.setDamping(t);
...
"undefined" != typeof document &&
    ...
    ((function (t, e) {
        ...
        function D(t, e) {
            ...
            function m() {
                for (l = n(), P < l - O.threshold && ((v.fps -= v.fps / Math.max(1, (60 * O.smoothing) / O.interval)), (v.duration = 1e3 / v.fps)), w = O.history; w--; )
                    (T[w] = 0 === w ? v.fps : T[w - 1]), (j[w] = 0 === w ? v.duration : j[w - 1]);
                if ((r(), O.heat)) {
            ...
            function V() {
                ...
                if (((C.length = 0), F.graph))
                    for (F.graph.style.width = O.history * o.column.width + (O.history - 1) * o.column.spacing + "px", w = 0; w < O.history; w++)
    ...
    (function (t, e) {
        ...
        (e.theme.dark = e.extend({}, n, {
            ...
            (e.theme.colorful = e.extend({}, n, {
                ...
                container: { heatOn: "backgroundColor", background: "#888", color: "#fff", textShadow: "1px 1px 0 rgba(0,0,0,.2)", boxShadow: "0 0 0 1px rgba(0,0,0,.1)" },
...
Overlay.attributes.add("focusBulletsEntity", { type: "entity" }),
    Overlay.attributes.add("focusAmmoEntity", { type: "entity" }),
    Overlay.attributes.add("focusBulletsMask", { type: "entity" }),
    Overlay.attributes.add("focusBulletsInner", { type: "entity" }),
    Overlay.attributes.add("blackShadow", { type: "entity" }),
    Overlay.attributes.add("cameraEntity", { type: "entity" }),
    Overlay.attributes.add("timeEntity", { type: "entity" }),
    Overlay.attributes.add("ammoEntity", { type: "entity" }),
    Overlay.attributes.add("capacityEntity", { type: "entity" }),
    Overlay.attributes.add("crosshairEntity", { type: "entity" }),
    Overlay.attributes.add("prepareEntity", { type: "entity" }),
    Overlay.attributes.add("reloadingTimeEntity", { type: "entity" }),
    Overlay.attributes.add("infoEntity", { type: "entity" }),
    Overlay.attributes.add("abilityBuyButton", { type: "entity" }),
    Overlay.attributes.add("abilityBuyClock", { type: "entity" }),
    Overlay.attributes.add("abilityBuyKey", { type: "entity" }),
    Overlay.attributes.add("abilityBar", { type: "entity" }),
    Overlay.attributes.add("abilityNotification", { type: "entity" }),
    Overlay.attributes.add("cardEntities", { type: "entity", array: !0 }),
    Overlay.attributes.add("cardEntity", { type: "entity" }),
    Overlay.attributes.add("cardTimer", { type: "entity" }),
    Overlay.attributes.add("cardTitle", { type: "entity" }),
    Overlay.attributes.add("cardBackground", { type: "entity" }),
    Overlay.attributes.add("questEntity", { type: "entity" }),
    Overlay.attributes.add("questIcon", { type: "entity" }),
    Overlay.attributes.add("questText", { type: "entity" }),
    Overlay.attributes.add("abilityBind", { type: "entity" }),
    Overlay.attributes.add("abilityEntity", { type: "entity" }),
    Overlay.attributes.add("abilityHolderEntity", { type: "entity" }),
    Overlay.attributes.add("abilityIcon", { type: "entity" }),
    Overlay.attributes.add("abilityInfo", { type: "entity" }),
    Overlay.attributes.add("friendlyFire", { type: "entity" }),
    Overlay.attributes.add("connectivityIssue", { type: "entity" }),
    Overlay.attributes.add("messageEntity", { type: "entity" }),
    Overlay.attributes.add("messageText", { type: "entity" }),
    Overlay.attributes.add("teamNotification", { type: "entity" }),
    Overlay.attributes.add("teamNotificationText", { type: "entity" }),
    Overlay.attributes.add("whiteShadowEntity", { type: "entity" }),
    Overlay.attributes.add("whiteShadowColor", { type: "entity" }),
    Overlay.attributes.add("statusEntity", { type: "entity" }),
    Overlay.attributes.add("countBackEntity", { type: "entity" }),
    Overlay.attributes.add("damageIndictator", { type: "entity" }),
    Overlay.attributes.add("ricochetIndictator", { type: "entity" }),
    Overlay.attributes.add("explosiveIndicator", { type: "entity" }),
    Overlay.attributes.add("explosiveIndicatorArrow", { type: "entity" }),
    Overlay.attributes.add("explosiveIcon", { type: "entity" }),
    Overlay.attributes.add("leftDamageEntity", { type: "entity" }),
    Overlay.attributes.add("rightDamageEntity", { type: "entity" }),
    Overlay.attributes.add("healthBarEntity", { type: "entity" }),
    Overlay.attributes.add("healthBarColor", { type: "entity" }),
    Overlay.attributes.add("healthValue", { type: "entity" }),
    Overlay.attributes.add("teamNameEntity", { type: "entity" }),
    Overlay.attributes.add("notificationMessage", { type: "entity" }),
    Overlay.attributes.add("notificationKill", { type: "entity" }),
    Overlay.attributes.add("notificationHolder", { type: "entity" }),
    Overlay.attributes.add("announceEntity", { type: "entity" }),
    Overlay.attributes.add("announceInfoEntity", { type: "entity" }),
    Overlay.attributes.add("announceIconEntity", { type: "entity" }),
    Overlay.attributes.add("announceTextBackground", { type: "entity" }),
    Overlay.attributes.add("announceTextEntity", { type: "entity" }),
    Overlay.attributes.add("announceStripeEntity", { type: "entity" }),
    Overlay.attributes.add("reminderEntity", { type: "entity" }),
    Overlay.attributes.add("reminderTextEntity", { type: "entity" }),
    Overlay.attributes.add("leaderboardEntity", { type: "entity" }),
    Overlay.attributes.add("leaderboardItem", { type: "entity" }),
    Overlay.attributes.add("playerStatsEntity", { type: "entity" }),
    Overlay.attributes.add("taskEntity", { type: "entity" }),
    Overlay.attributes.add("taskLabelEntity", { type: "entity" }),
    Overlay.attributes.add("taskTitleEntity", { type: "entity" }),
    Overlay.attributes.add("taskIconEntity", { type: "entity" }),
    Overlay.attributes.add("taskCountEntity", { type: "entity" }),
    Overlay.attributes.add("taskLevelEntity", { type: "entity" }),
    Overlay.attributes.add("achievementEntity", { type: "entity" }),
    Overlay.attributes.add("achievementName", { type: "entity" }),
    Overlay.attributes.add("achievementLevel", { type: "entity" }),
    Overlay.attributes.add("achievementIcon", { type: "entity" }),
    Overlay.attributes.add("holdEntity", { type: "entity" }),
    Overlay.attributes.add("holdBarEntity", { type: "entity" }),
    Overlay.attributes.add("circularEntity", { type: "entity" }),
    Overlay.attributes.add("circularPiece", { type: "entity" }),
    Overlay.attributes.add("circularHolder", { type: "entity" }),
    Overlay.attributes.add("circularSpinner", { type: "entity" }),
    Overlay.attributes.add("skillTimer", { type: "entity" }),
    Overlay.attributes.add("skillCountText", { type: "entity" }),
    Overlay.attributes.add("skillKeyEntity", { type: "entity" }),
    Overlay.attributes.add("skillIcon", { type: "entity" }),
    Overlay.attributes.add("skillClockIcon", { type: "entity" }),
    Overlay.attributes.add("objectiveEntity", { type: "entity" }),
    Overlay.attributes.add("objectiveTextEntity", { type: "entity" }),
    Overlay.attributes.add("meleeIcon", { type: "entity" }),
    Overlay.attributes.add("meleeTimer", { type: "entity" }),
    Overlay.attributes.add("meleeCountText", { type: "entity" }),
    Overlay.attributes.add("meleeKeyEntity", { type: "entity" }),
    Overlay.attributes.add("throwIconEntity", { type: "entity" }),
    Overlay.attributes.add("throwSkillEntity", { type: "entity" }),
    Overlay.attributes.add("meleeIconEntity", { type: "entity" }),
    Overlay.attributes.add("weaponIconEntity", { type: "entity" }),
    Overlay.attributes.add("weaponKeyEntity", { type: "entity" }),
    Overlay.attributes.add("weaponText", { type: "entity" }),
    Overlay.attributes.add("icon1Entity", { type: "entity" }),
    Overlay.attributes.add("icon2Entity", { type: "entity" }),
    Overlay.attributes.add("pointNumberEntity", { type: "entity" }),
    Overlay.attributes.add("pointHolder", { type: "entity" }),
    Overlay.attributes.add("subtitleEntity", { type: "entity" }),
    Overlay.attributes.add("respawnEntity", { type: "entity" }),
    Overlay.attributes.add("leftCinema", { type: "entity" }),
    Overlay.attributes.add("rightCinema", { type: "entity" }),
    Overlay.attributes.add("chatEntity", { type: "entity" }),
    Overlay.attributes.add("chatWrapperEntity", { type: "entity" }),
    Overlay.attributes.add("mapImageEntity", { type: "entity" }),
    Overlay.attributes.add("mapNameEntity", { type: "entity" }),
    Overlay.attributes.add("modeEntity", { type: "entity" }),
    Overlay.attributes.add("weaponButtons", { type: "entity" }),
    Overlay.attributes.add("weaponTimeout", { type: "entity" }),
    Overlay.attributes.add("weaponTimeoutText", { type: "entity" }),
    Overlay.attributes.add("statsEntity", { type: "entity" }),
    Overlay.attributes.add("alreadyStarted", { type: "entity" }),
    Overlay.attributes.add("alreadyStartedCount", { type: "entity" }),
    Overlay.attributes.add("deathBannerEntity", { type: "entity" }),
    Overlay.attributes.add("pauseEntity", { type: "entity" }),
    Overlay.attributes.add("garbageEntity", { type: "entity" }),
    Overlay.attributes.add("ammoAngleFactor", { type: "number", default: 4.15 }),
    Overlay.attributes.add("defaultDamageTime", { type: "number", default: 2 }),
    (Overlay.prototype.initialize = function () {
        (this.isDeath = !1),
            ...
            this.app.on("Game:Settings", this.onSettingsChange, this),
            this.onSettingsChange(),
            this.app.on("Overlay:SetLoading", this.setLoadingScreen, this),
            ...
            setTimeout(
                function (t) {
                    pc.Mouse.isPointerLocked() || pc.isMobile || t.app.fire("Overlay:Message", "Press [L] to lock your mouse.");
                },
                8e3,
                this
            );
    ...
    (Overlay.prototype.onFollowUser = function (t) {
        this.app.fire("Fetcher:Follow", { username: t }), this.app.fire("Network:Chat", t + " followed!");
        var e = [],
    ...
    (Overlay.prototype.onReQueue = function () {
        (this.pauseEntity.enabled = !0),
            ...
            this.app.fire("Fetcher:ReQueue", { country: pc.currentServer, version: pc.serverCode, map: pc.currentMap, max_player: pc.maxPlayers, is_mobile: pc.isMobile ? 1 : 0 }),
            (pc.isRequeuing = !0);
    }),
    (Overlay.prototype.onModeSet = function (t, e, i) {
        (this.modeEntity.element.text = t), this.setLoadingScreen({ result: { map: e } });
        ...
        "GUNGAME" == pc.currentMode ? (this.weaponKeyEntity.parent.enabled = !1) : (this.weaponKeyEntity.parent.enabled = !0),
            "TDM" == pc.currentMode || "PAYLOAD" == pc.currentMode || (pc.currentModeOptions && pc.currentModeOptions.team) || (this.healthBarColor.element.color = pc.colors.health);
    }),
    ...
    (Overlay.prototype.onCharacterSet = function (t) {
        ...
        (this.throwIconEntity.element.textureAsset = e), (this.throwSkillEntity.element.textureAsset = i), (this.meleeIconEntity.element.textureAsset = a);
    }),
    ...
    (Overlay.prototype.onLoaded = function () {
        clearTimeout(this.blackShadowTimer),
            (this.blackShadowTimer = setTimeout(
                function (t) {
    ...
    (Overlay.prototype.onPlayerStats = function (t) {
        t ? ((this.playerStatsEntity.enabled = !0), this.setPlayerStats(this.stats)) : ((this.playerStatsEntity.enabled = !1), this.clearPlayerStats());
    }),
    ...
    (Overlay.prototype.onPause = function (t) {
        ...
        (this.pauseEntity.enabled = t),
            ...
            t
                ? (this.setPausePlayers(this.stats),
                  this.isBannerSet ||
                      (setTimeout(
                          function () {
    ...
    (Overlay.prototype.openReport = function () {
        this.app.fire("View:Pause", "Report"), this.app.fire("Table:Users", { result: this.stats }), this.app.fire("Table:KickUsers", { result: this.stats });
    }),
    (Overlay.prototype.openKickMenu = function () {
        this.app.fire("View:Pause", "Kick"), this.app.fire("Table:KickUsers", { result: this.stats });
    }),
    ...
    (Overlay.prototype.showAttention = function (t) {
        "Melee" == t &&
            ...
            this.meleeTimer.tween(this.meleeTimer.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.4, pc.BackOut).start(),
    ...
    (Overlay.prototype.setPausePlayers = function (t) {
        ...
        for (var a in t) {
            ...
            n.heroSkin && "Default" != n.heroSkin && (l = Utils.getAssetFromURL(n.skin + "-" + n.heroSkin + "-Thumbnail.png"));
            var r = i.clone();
            (r.enabled = !0), r.setLocalPosition(0, s, 0);
            var y = r.findByName("Username");
            (y.element.text = Utils.displayUsername(n.username, y.element)),
                ...
                n.emoji &&
                    ((r.findByName("Username").findByName("Emoji").enabled = !0),
                    (r.findByName("Username").findByName("Emoji").enabled = this.app.assets.find("Charm-" + n.emoji + "-Emoji.png")),
    ...
    (Overlay.prototype.onTeamChange = function (t) {
        ...
        (this.teamNotification.enabled = !0),
            ...
            this.teamNotification.tween(this.teamNotification.getLocalPosition()).to({ x: 0, y: 150, z: 0 }, 0.8, pc.BackOut).start(),
            "red" == t
                ? ((this.teamNotification.element.color = pc.colors.redTeam), (this.healthBarColor.element.color = pc.colors.redTeam), (this.teamNameEntity.element.color = pc.colors.redTeam), (this.teamNameEntity.element.text = "RED"))
                : "blue" == t &&
                  ((this.teamNotification.element.color = pc.colors.blueTeam), (this.healthBarColor.element.color = pc.colors.blueTeam), (this.teamNameEntity.element.color = pc.colors.blueTeam), (this.teamNameEntity.element.text = "BLUE")),
    ...
    (Overlay.prototype.setWhiteShadow = function (t) {
        t
            ? (this.entity.sound.play("White-Shadow"),
              ...
              this.whiteShadowEntity.tween(this.whiteShadowEntity.getLocalScale()).to({ x: 45, y: 45, z: 45 }, 1, pc.SineIn).start(),
              (this.whiteShadowColor.element.opacity = 0),
              this.whiteShadowColor.tween(this.whiteShadowColor.element).to({ opacity: 1 }, 1, pc.SineIn).start(),
              (this.holdEntity.enabled = !0),
              clearTimeout(this.holdTimer),
              this.holdBarEntity.setLocalScale(0.01, 1, 1),
              this.holdAnimation && this.holdAnimation.stop(),
              (this.holdAnimation = this.holdBarEntity.tween(this.holdBarEntity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 1, pc.SineIn)),
            ...
            : this.holdAnimation &&
              ...
              (this.holdAnimation = this.holdBarEntity.tween(this.holdBarEntity.getLocalScale()).to({ x: 0.01, y: 1, z: 1 }, 0.5, pc.SineIn)),
              this.holdAnimation.start(),
    ...
    (Overlay.prototype.setOvertime = function (t) {
        t ? ((this.isOvertime = !0), this.entity.sound.play("Overtime-Loop")) : ((this.isOvertime = !1), this.entity.sound.stop("Overtime-Loop"));
    }),
    ...
    (Overlay.prototype.onPoint = function (t) {
        ...
        (e.element.text = t + ""),
            ...
            e.tween(e.getLocalPosition()).to({ x: 0, y: 0, z: 0 }, 0.2, pc.BackOut).start(),
            e.tween(e.element).to({ opacity: 1 }, 0.2, pc.Linear).start(),
            setTimeout(
                function (t) {
                    t.tween(t.getLocalPosition()).to({ x: 0, y: 50, z: 0 }, 0.2, pc.BackOut).start(), t.tween(t.element).to({ opacity: 0 }, 0.2, pc.Linear).start();
                },
                400,
                e
            ),
    ...
    (Overlay.prototype.onCards = function (t) {
        ...
        this.currentCards)) {
            ...
            0 === l ? (n = 3) : 2 === l && (n = -3),
                this.cardEntities[e].glow || ((this.cardEntities[e].glow = this.cardEntities[e].findByName("Glow")), (this.cardEntities[e].key = this.cardEntities[e].findByName("Key"))),
        ...
        for (var o in this.cardEntities) {
            var l,
                r = this.cardEntities[o],
                y = ((s = 220 * ((l = parseInt(o)) - 1)), l % 2 == 0 ? 0 : 30),
                h = 0.6 * (l + 1);
            r.tween(r.getLocalPosition()).to({ x: s, y: y, z: 0 }, 0.5, pc.BackOut).delay(h).start(),
                r.tween(r.getLocalScale()).to({ x: 0.7, y: 0.7, z: 0.7 }, 1, pc.BackOut).delay(h).start(),
                setTimeout(
                    function (t, e) {
                        (e.key.enabled = !0),
                            (e.glow.enabled = !0),
                            e.glow.tween(e.glow.element).to({ opacity: 0.1 }, 0.2, pc.Linear).delay(0.3).start(),
                            e.glow.tween(e.glow.getLocalScale()).to({ x: 1.1, y: 1.1, z: 1.1 }, 0.2, pc.BackOut).delay(0.3).start(),
                ...
                r.tween(r.element).to({ opacity: 1 }, 0.5, pc.Linear).delay(h).start();
        }
    ...
    (Overlay.prototype.setAbility = function (t) {
        ...
        for (var a in (clearTimeout(this.cardTimeout), (this.isAbilitySelected = !0), this.cardEntities)) {
        ...
        (this.cardTimer.enabled = !1),
            ...
            e.tween(e.getLocalPosition()).to({ x: 0, y: 0, z: 0 }, 0.5, pc.BackOut).start(),
            e.tween(e.getLocalScale()).to({ x: 1.1, y: 1.1, z: 1.1 }, 0.5, pc.BackOut).delay(0.4).start(),
            e.tween(e.getEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.3, pc.BackOut).start(),
            setTimeout(
                function (t) {
                    t.entity.sound.play("Add-Ability"),
                        e.tween(e.getLocalPosition()).to({ x: 600, y: -100, z: 0 }, 0.4, pc.Linear).start(),
                        e.tween(e.getLocalScale()).to({ x: 0.32, y: 0.32, z: 0.32 }, 0.35, pc.Linear).delay(0.05).start(),
                        e.tween(e.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 90 }, 0.2, pc.BackOut).delay(0.2).start(),
                        setTimeout(function () {
                            t.cardBackground.tween(t.cardBackground.element).to({ opacity: 1, color: pc.colors.black }, 0.2, pc.Linear).start();
                        }, 400),
                        setTimeout(function () {
                            t.entity.sound.stop("Card-Selection-Loop"), t.entity.sound.stop("Praying"), (t.cardEntity.enabled = !1);
                        }, 600);
                },
                1400,
                this
    ...
    (Overlay.prototype.setAbilityList = function () {
        ...
        for (var t = this.abilities.length, e = 0; t--; ) {
            if (e < 2) {
                ...
                (a.enabled = !0), a.setLocalPosition(25 * -t, 0, 0), (a.element.textureAsset = i), this.abilityHolder.push(a), this.abilityHolderEntity.addChild(a);
            }
            e++;
        }
    ...
    (Overlay.prototype.onOtherIconSet = function (t, e) {
        ...
        i ? ((this.icon1Entity.element.textureAsset = i), (this.icon1Entity.enabled = !0)) : (this.icon1Entity.enabled = !1);
        var a = this.app.assets.find(e + "-Thumbnail-White.png");
        a ? ((this.icon2Entity.element.textureAsset = a), (this.icon2Entity.enabled = !0)) : (this.icon2Entity.enabled = !1);
    }),
    ...
    (Overlay.prototype.onCircularMenu = function (t) {
        ...
        this.circularHolder.setLocalEulerAngles(0, 0, i),
            ...
            this.circularEntity.tween(this.circularEntity.getLocalPosition()).to({ x: 0, y: 125, z: 0 }, 0.5, pc.BackOut).start(),
            setTimeout(
                function (t) {
                    t.hideCircularMenu();
                },
    ...
    (Overlay.prototype.showDeathBanner = function () {
        if (Date.now() - this.lastBannerShow < 3e4) return !1;
        (this.deathBannerEntity.enabled = !0),
            setTimeout(
                function (t) {
                    pc.app.fire("Ads:BannerSet", "death-venge-728x90", "728x90");
                },
                100,
                this
            ),
    ...
    (Overlay.prototype.onCircularSelect = function (t, e) {
        ...
        if (i > -1) {
            ...
            if (a && a.element && a.element.color) {
                ...
                a.tween(a.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 0.2, pc.BackOut).start(),
                a.setLocalEulerAngles(0, 0, 0),
                a.findByName("Icon").setLocalEulerAngles(0, 0, 0),
                this.circularHolder.tween(this.circularHolder.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.2, pc.BackOut).start(),
    ...
    (Overlay.prototype.hideCircularMenu = function () {
        this.entity.sound.play("Whoosh"),
            this.circularEntity.tween(this.circularEntity.getLocalPosition()).to({ x: 0, y: -300, z: 0 }, 0.5, pc.BackOut).start(),
            setTimeout(
                function (t) {
    ...
    (Overlay.prototype.setLeaderboard = function (t) {
        ...
        for (var s in t) {
            var o = t[s],
                ...
                y = this.app.assets.find(o.skin + "-Thumbnail-2");
            o.heroSkin && "Default" != o.heroSkin && (y = Utils.getAssetFromURL(o.skin + "-" + o.heroSkin + "-Thumbnail.png")), "GUNGAME" == pc.currentMode && (r = this.app.assets.find("Rank-" + o.tier + ".png"));
            var h = this.leaderboardItem.clone();
            (h.enabled = !0),
                this.lastRank[o.username] > -1e3
                    ? (h.setLocalPosition(-3 * parseInt(s), this.lastRank[o.username], 0),
                      h
                          .tween(h.getLocalPosition())
                          .to({ x: -3 * parseInt(s), y: a, z: 0 }, 0.3, pc.Linear)
                          .start(),
                      this.lastRank[o.username] != a && (this.app.fire("Timeline:SortingEffect", !0), this.entity.sound.play("Small-Whoosh")))
                    : h.setLocalPosition(-3 * parseInt(s), a, 0),
                h.setLocalScale(i, i, i),
                h.findByName("Bar").setLocalScale(o.bar, 1, 1),
                (h.findByName("Tier").element.textureAsset = r),
                (h.findByName("Rank").element.text = l + 1 + "."),
                (h.findByName("Character").element.textureAsset = y);
            var c = h.findByName("Username");
            (c.element.text = Utils.displayUsername(o.username, c.element)),
                "red" == o.team
                    ? ((h.findByName("Team").element.color = pc.colors.redTeam), (h.findByName("Team").enabled = !0))
                    : "blue" == o.team
                    ? ((h.findByName("Team").element.color = pc.colors.blueTeam), (h.findByName("Team").enabled = !0))
                    : (h.findByName("Team").enabled = !1),
                o.isMe && ((h.findByName("Username").element.color = pc.colors.me), (h.findByName("Leader").element.color = pc.colors.me), (n = l)),
                o.verified
                    ? ((h.findByName("Username").findByName("Verified").enabled = !0), h.findByName("Username").setLocalPosition(55, -7, 0), (h.element.width = h.findByName("Username").element.width + 90 + 20))
                    : o.emoji
                    ? ((h.findByName("Username").findByName("Emoji").enabled = !0),
                      (statRow.findByName("Username").findByName("Emoji").enabled = this.app.assets.find("Charm-" + stat.emoji + "-Emoji.png")),
                      h.findByName("Username").setLocalPosition(55, -7, 0),
                      (h.element.width = h.findByName("Username").element.width + 90 + 20))
                    : (h.element.width = h.findByName("Username").element.width + 90),
                (h.findByName("Leader").enabled = 0 === l),
                this.leaderboardEntity.addChild(h),
                this.leaderboardItems.push(h),
                (this.lastRank[o.username] = a),
                (a += -45 * (i -= 0.15) - 10);
        }
        (this.leaderboardEntity.element.height = 50 - a),
            this.myLastRank != n &&
                (0 === n && 0 !== this.myLastRank && this.app.fire("Overlay:Subtitle", "You are the leader now!"), 0 === this.myLastRank && 0 !== n && this.app.fire("Overlay:Subtitle", "You are no longer leader."), (this.myLastRank = n));
    }),
    ...
    (Overlay.prototype.setMeleeState = function (t) {
        (this.meleeKeyEntity.enabled = t), (this.meleeTimer.enabled = !t), t ? ((this.meleeIcon.element.color = new pc.Color(1, 1, 1)), this.entity.sound.play("Active")) : (this.meleeIcon.element.color = this.skillClockIcon.element.color);
    }),
    (Overlay.prototype.setSkillState = function (t) {
        (this.skillKeyEntity.enabled = t),
            (this.skillTimer.enabled = !t),
            t
                ? ((this.abilityIcon.element.color = new pc.Color(1, 1, 1)), (this.skillIcon.element.color = new pc.Color(1, 1, 1)), this.entity.sound.play("Active"))
                : ((this.skillIcon.element.color = this.skillClockIcon.element.color), (this.abilityIcon.element.color = this.skillClockIcon.element.color));
    }),
    (Overlay.prototype.onExplosive = function (t) {
        ...
        (this.explosiveEntity = t),
            ...
            (this.explosiveAnimation1 = this.explosiveIndicator.tween(this.explosiveIndicator.getLocalScale()).to({ x: 1.05, y: 1.05, z: 1.05 }, 0.15, pc.Linear).yoyo(!0).loop(!0)),
            (this.explosiveAnimation2 = this.explosiveIndicatorArrow.tween(this.explosiveIndicatorArrow.getLocalScale()).to({ x: 1.35, y: 1.35, z: 1.35 }, 0.1, pc.Linear).yoyo(!0).loop(!0)),
            this.explosiveAnimation1.start(),
            this.explosiveAnimation2.start(),
            this.entity.sound.play("Tick-Tock"),
            setTimeout(
                function (t) {
                    t.explosiveAnimation1.stop(), t.explosiveAnimation2.stop(), t.entity.sound.stop("Tick-Tock"), (t.explosiveIndicator.enabled = !1);
                },
                1500,
                this
            );
    ...
    (Overlay.prototype.updateExplosiveIndicator = function () {
        ...
        if (t.clone().sub(e).length() > 60) return (this.explosiveIndicator.enabled = !1), this.entity.sound.stop("Tick-Tock"), !1;
        var i = Date.now() - this.explosiveEntity.startTime;
        i > 1e3 && i < 1400
            ? ((this.explosiveIndicatorArrow.element.color = pc.colors.danger), this.entity.sound.slots["Emergency-Alarm"].isPlaying || this.entity.sound.play("Emergency-Alarm"))
        ...
        (n -= 180), this.explosiveIndicator.setLocalEulerAngles(0, 0, n), this.explosiveIcon.setLocalEulerAngles(0, 0, -n);
    }),
    ...
    (Overlay.prototype.onTransition = function (t) {
        return (
            ...
            !!pc.isMapLoaded &&
            (t ? ((this.leftCinema.element.color = t), (this.rightCinema.element.color = t)) : ((this.leftCinema.element.color = pc.colors.black), (this.rightCinema.element.color = pc.colors.black)),
            ...
            this.leftCinema.tween(this.leftCinema.getLocalScale()).to({ x: 1.4, y: 1, z: 1 }, 0.35, pc.Linear).start(),
            this.rightCinema.setLocalEulerAngles(0, 0, 15),
            this.rightCinema.setLocalScale(0.1, 0, 0),
            this.rightCinema.tween(this.rightCinema.getLocalScale()).to({ x: 1.4, y: 1, z: 1 }, 0.35, pc.Linear).start(),
            setTimeout(
                function (t) {
                    t.leftCinema.setLocalEulerAngles(0, 0, -15),
                        t.leftCinema.tween(t.leftCinema.getLocalScale()).to({ x: 0.1, y: 1, z: 1 }, 0.35, pc.Linear).start(),
                        t.rightCinema.setLocalEulerAngles(0, 0, -15),
                        t.rightCinema.tween(t.rightCinema.getLocalScale()).to({ x: 0.1, y: 1, z: 1 }, 0.35, pc.Linear).start(),
    ...
    (Overlay.prototype.setDeath = function () {
        this.hideGameplay(), (this.subtitleEntity.enabled = !1), (this.taskEntity.enabled = !1), (this.achievementEntity.enabled = !1), (this.focusBulletsEntity.enabled = !1), this.entity.sound.play("Death-UI"), (this.isDeath = !0);
    }),
    (Overlay.prototype.setHealth = function (t) {
        this.health = t;
        var e = (497 * this.health) / 100;
        this.healthBarEntity.tween(this.healthBarEntity.element).to({ width: e }, 0.5, pc.SineOut).start(),
    ...
    (Overlay.prototype.setStatus = function (t) {
        (this.statusEntity.enabled = !0),
            ...
            this.statusEntity.tween(this.statusEntity.getLocalPosition()).to({ x: 0, y: -85, z: 0 }, 0.2, pc.BackOut).start(),
    ...
    (Overlay.prototype.setRespawn = function () {
        (this.respawnEntity.enabled = !1), (this.isDeath = !1), pc.isFinished || this.showGameplay();
    }),
    (Overlay.prototype.setReminder = function (t) {
        ...
        (this.reminderEntity.enabled = !0),
            ...
            this.reminderEntity.tween(this.reminderEntity.getLocalPosition()).to({ x: 0, y: 130, z: 0 }, 0.25, pc.BackOut).start(),
    ...
    (Overlay.prototype.onTaskMessage = function (t, e, i, a, n, s) {
        ...
        var o = 2500;
        i - e < 5 && (o = 800),
            s ? (this.taskLabelEntity.enabled = !1) : ((this.abilityBuyButton.findByName("TierLevel").element.text = t), (this.taskLabelEntity.enabled = !0)),
    ...
    (Overlay.prototype._onTaskMessage = function (t, e, i, a, n) {
        (this.taskEntity.enabled = !0),
            ...
            this.taskEntity.tween(this.taskEntity.getLocalPosition()).to({ x: 0, y: 25, z: 0 }, 0.25, pc.BackOut).start(),
    ...
    (Overlay.prototype.setTaskHideTimer = function () {
        clearTimeout(this.taskHideTimer),
            (this.taskHideTimer = setTimeout(
                function (t) {
                    t.taskEntity.tween(t.taskEntity.getLocalPosition()).to({ x: 0, y: -75, z: 0 }, 0.1, pc.BackOut).start(),
                        setTimeout(function () {
    ...
    (Overlay.prototype.onUnlock = function (t, e) {
        ...
        for (var a in i) {
            ...
            n.setLocalPosition(84.136, 89.082, 0),
                ...
                (n.element.opacity = 1),
                n.tween(n.getLocalPosition()).to({ x: 640, y: 265 }, 1, pc.BackOut).delay(s).start(),
                n.tween(n.getLocalEulerAngles()).rotate({ z: 165 }, 1, pc.Linear).delay(s).start(),
                n
                    .tween(n.element)
        ...
        (this.achievementEntity.enabled = !0),
            ...
            this.achievementEntity.tween(this.achievementEntity.getLocalPosition()).to({ x: 0, y: 38, z: 0 }, 0.15, pc.BackOut).start(),
            this.hasAbility ||
                ((this.abilityNotification.enabled = !0),
                (this.abilityInfo.enabled = !0),
                this.abilityInfo.setLocalPosition(-145, 0, 0),
                this.abilityInfo.tween(this.abilityInfo.getLocalPosition()).to({ x: -165, y: 0, z: 0 }, 0.3, pc.Linear).yoyo(!0).repeat(7).start(),
                setTimeout(
                    function (t) {
            ...
            setTimeout(
                function (t) {
                    t.achievementEntity.tween(t.achievementEntity.getLocalPosition()).to({ x: 0, y: -75, z: 0 }, 0.1, pc.BackOut).start(),
                        setTimeout(function () {
    ...
    (Overlay.prototype.fullDamage = function () {
        (this.damageTime = this.timestamp + 2 * this.defaultDamageTime), (this.leftDamageEntity.element.opacity = 1), (this.rightDamageEntity.element.opacity = 1);
    }),
    (Overlay.prototype.onRicochet = function (t) {
        if (this.movement.isDeath) return !1;
        (this.ricochetTime = this.timestamp + this.defaultDamageTime), (this.ricochetIndictator.element.opacity = 1), (this.ricochetPosition.x = t.x), (this.ricochetPosition.y = t.y), (this.ricochetPosition.z = t.z);
    }),
    (Overlay.prototype.onDamage = function (t) {
        if (this.movement.isDeath) return !1;
        (this.damageTime = this.timestamp + this.defaultDamageTime), (this.damageIndictator.element.opacity = 1), (this.damagePosition.x = t.x), (this.damagePosition.y = t.y), (this.damagePosition.z = t.z);
        ...
        a > -180 && a < 0 && (this.leftDamageEntity.element.opacity = 0.8),
            ...
            this.damageIndictator.tween(this.damageIndictator.getLocalScale()).to({ x: 0.92, y: 0.92, z: 0.92 }, 0.18, pc.BackInOut).start();
    ...
    (Overlay.prototype.onAnnounce = function (t, e, i, a) {
        (this.announceEntity.enabled = !0), this.announceIconEntity.setLocalScale(3, 3, 3), this.announceIconEntity.tween(this.announceIconEntity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.15, pc.SineOut).start();
        var n = this.app.assets.find(a + ".png");
        if (
            ((this.announceIconEntity.element.textureAsset = n),
            (this.announceIconEntity.element.opacity = 0),
            this.announceIconEntity.tween(this.announceIconEntity.element).to({ opacity: 1 }, 0.15, pc.SineOut).start(),
            (this.announceTextEntity.element.text = t.toUpperCase()),
            (this.announceTextEntity.element.opacity = 0),
            this.announceTextEntity.tween(this.announceTextEntity.element).to({ opacity: 1 }, 0.15, pc.SineOut).delay(0.15).start(),
            this.announceStripeEntity.setLocalScale(2.5, 1, 1),
            this.announceStripeEntity.tween(this.announceStripeEntity.getLocalScale()).to({ x: 0.015, y: 1, z: 1 }, 0.3, pc.SineOut).start(),
            (this.announceStripeEntity.element.opacity = 0.3),
            this.announceStripeEntity.tween(this.announceStripeEntity.element).to({ opacity: 0 }, 0.15, pc.SineOut).delay(0.25).start(),
            (this.announceInfoEntity.element.text = e.toUpperCase()),
            (this.announceInfoEntity.element.opacity = 0),
            this.announceInfoEntity.tween(this.announceInfoEntity.element).to({ opacity: 1 }, 0.3, pc.SineOut).delay(0.5).start(),
            ...
            this.announceInfoEntity.tween(this.announceInfoEntity.getLocalPosition()).to({ x: 0, y: -22, z: 0 }, 0.3, pc.SineOut).delay(0.5).start(),
            ...
            var s = "Announce-" + i;
            Date.now() - this.lastAnnounceDate < 3e3 ? (this.entity.sound.slots[s].pitch += 0.1) : (this.entity.sound.slots[s].pitch = 1), this.entity.sound.play(s);
        }
        this.lastAnnounceDate = Date.now();
    }),
    (Overlay.prototype.updateCrosshair = function (t) {
        var e = this.cameraEntity.getPosition(),
            i = this.movement.lookX % 360;
        if (
            ((this.crosshairEntity.element.width = pc.math.lerp(this.crosshairEntity.element.width, this.defaultCrosshairSize, 0.25)),
            ...
            (this.ricochetIndictator.element.opacity = pc.math.lerp(this.ricochetIndictator.element.opacity, 0, 0.1)), this.ricochetIndictator.setLocalEulerAngles(0, 0, a * pc.math.RAD_TO_DEG - i);
        }
        if (this.damageTime > this.timestamp) {
            var n = Utils.lookAt(e.x, e.z, this.damagePosition.x, this.damagePosition.z);
            (this.damageIndictator.element.opacity = pc.math.lerp(this.damageIndictator.element.opacity, 0, 0.05)),
                (this.leftDamageEntity.element.opacity = pc.math.lerp(this.leftDamageEntity.element.opacity, 0, 0.01)),
                (this.rightDamageEntity.element.opacity = pc.math.lerp(this.rightDamageEntity.element.opacity, 0, 0.01)),
    ...
    (Overlay.prototype.setAmmo = function () {
        ...
        if (((this.ammoEntity.element.text = t + ""), (this.focusAmmoEntity.element.text = t + ""), !this.focusBulletsEntity.enabled)) return !1;
        this.focusBulletsMask.setLocalEulerAngles(0, 0, -(this.maxAmmoValue - this.movement.currentWeapon.ammo) * this.ammoAngleFactor),
            ...
            this.focusAmmoEntity.tween(this.focusAmmoEntity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.2, pc.CircularInOut).start();
    }),
    (Overlay.prototype.onShooting = function () {
        this.crosshairEntity.tween(this.crosshairEntity.element).to({ width: 65, height: 65 }, 0.045, pc.SineOut).start(), this.setAmmo();
    }),
    (Overlay.prototype.onJumping = function () {
        this.crosshairEntity.tween(this.crosshairEntity.element).to({ width: 70, height: 70 }, 0.15, pc.SineOut).start();
    }),
    (Overlay.prototype.onNotification = function (t, e, i, a) {
        var n = 35 * -this.notifications.length,
            s = !1;
        if ("message" == t) ((s = this.notificationMessage.clone()).findByName("Message").element.text = e), (s.element.width = 7 * (Utils.cleanUsername(e).length + 1));
        ...
        (s.enabled = !0),
            ...
            s.tween(s.getLocalPosition()).to({ x: 0, y: n, z: 0 }, 0.15, pc.BackOut).start(),
    ...
    (Overlay.prototype.onTick = function (t, e) {
        this.isOvertime
            ? ((this.timeEntity.element.text = t), (this.timeEntity.element.color = pc.colors.health), (this.timeEntity.element.fontSize = 35))
            : ((this.timeEntity.element.text = Utils.mmss(e)), (this.timeEntity.element.color = pc.colors.white), (this.timeEntity.element.fontSize = 25)),
            t < 0 && !pc.isFinished ? ((this.alreadyStarted.enabled = !0), (this.alreadyStartedCount.element.text = 20 + t)) : (this.alreadyStarted.enabled = !1),
            t >= 0 && t <= 5
                ? ((this.countBackEntity.enabled = !0), (this.countBackEntity.element.text = t), this.entity.sound.play("Count"))
                : ((this.countBackEntity.enabled = !1), this.isOvertime && !pc.isFinished && this.entity.sound.play("Overtime-Count"));
    }),
    (Overlay.prototype.onInfoMessage = function (t) {
        this.infoEntity.enabled || ((this.infoEntity.enabled = !0), (this.infoEntity.findByName("Message").element.text = t + ""), this.app.mouse.disablePointerLock(), (window.onbeforeunload = null));
    }),
    (Overlay.prototype.onInfoClose = function () {
        this.infoEntity.enabled = !1;
    }),
    (Overlay.prototype.showPrepare = function () {
        (this.prepareEntity.enabled = !0), this.prepareEntity.setLocalScale(0.5, 0.5, 0.5), this.prepareEntity.tween(this.prepareEntity.getLocalScale()).to({ x: 1.5, y: 1.5, z: 1.5 }, 0.1, pc.SineOut).start(), (this.reloadingTime = 2.2);
    }),
    ...
    (Overlay.prototype.setPing = function (t) {
        (this.ping = t),
            (this.avgPing += t),
            this.avgPingCount++,
            this.avgPing / this.avgPingCount > 300 && this.avgPingCount > 10 ? (this.connectivityIssue.enabled = !0) : (this.connectivityIssue.enabled = !1),
    ...
    (Overlay.prototype.updateStatsEntity = function (t) {
        ...
        (this.statsEntity.element.text = e + "FPS - " + this.ping + "MS"), (this.lastStatUpdate = Date.now());
    }),
    ...
    (Overlay.prototype.update = function (t) {
        this.updateCrosshair(t),
            ...
            !0 === this.prepareEntity.enabled && ((this.reloadingTimeEntity.element.text = Math.max(this.reloadingTime, 0).toFixed(1)), (this.reloadingTime -= t)),
            (this.timestamp += t);
    });
var Weapon = pc.createScript("weapon");
Weapon.attributes.add("type", { type: "string", enum: [{ Rifle: "Rifle" }, { Shotgun: "Shotgun" }, { Sniper: "Sniper" }, { Melee: "Melee" }, { Throwable: "Throwable" }, { Launcher: "Launcher" }], default: "Rifle" }),
    Weapon.attributes.add("weight", { type: "string", enum: [{ Light: "Light" }, { Heavy: "Heavy" }], default: "Light" }),
    Weapon.attributes.add("isShootable", { type: "boolean", default: !0 }),
    Weapon.attributes.add("isAutomatic", { type: "boolean", default: !0 }),
    Weapon.attributes.add("isFocusable", { type: "boolean", default: !0 }),
    Weapon.attributes.add("isRightHanded", { type: "boolean", default: !1 }),
    Weapon.attributes.add("shootTime", { type: "number", default: 0.1 }),
    Weapon.attributes.add("recoil", { type: "number" }),
    Weapon.attributes.add("spread", { type: "number", default: 500 }),
    Weapon.attributes.add("focusSpread", { type: "number", default: 200 }),
    Weapon.attributes.add("damage", { type: "number", default: 20 }),
    Weapon.attributes.add("distanceMultiplier", { type: "number", default: 1 }),
    Weapon.attributes.add("ammo", { type: "number", default: 20 }),
    Weapon.attributes.add("capacity", { type: "number", default: 20 }),
    Weapon.attributes.add("hiddenReload", { type: "boolean", default: !1 }),
    Weapon.attributes.add("reloadingTime", { type: "number", default: 2.2 }),
    Weapon.attributes.add("cameraShake", { type: "number", default: 10 }),
    Weapon.attributes.add("focusFov", { type: "number", default: 45 }),
    Weapon.attributes.add("barrelName", { type: "string" }),
    Weapon.attributes.add("magazineName", { type: "string" }),
    Weapon.attributes.add("sliderName", { type: "string" }),
    Weapon.attributes.add("sliderLimit", { type: "number", default: -220 }),
    Weapon.attributes.add("hasSlider", { type: "boolean" }),
    Weapon.attributes.add("rotationSlider", { type: "boolean" }),
    Weapon.attributes.add("doodahEntity", { type: "entity" }),
    Weapon.attributes.add("doodahReference", { type: "entity" }),
    Weapon.attributes.add("modelEntity", { type: "entity" }),
    Weapon.attributes.add("armEntity", { type: "entity" }),
    Weapon.attributes.add("rightArmEntity", { type: "entity" }),
    Weapon.attributes.add("magazinePoint", { type: "entity" }),
    Weapon.attributes.add("barrelPoint", { type: "entity" }),
    Weapon.attributes.add("bulletPoint", { type: "entity" }),
    Weapon.attributes.add("muzzlePoint", { type: "entity" }),
    Weapon.attributes.add("handPoint", { type: "entity" }),
    Weapon.attributes.add("rightHandPoint", { type: "entity" }),
    Weapon.attributes.add("ammoEntity", { type: "entity" }),
    Weapon.attributes.add("scopeOverlay", { type: "entity" }),
    (Weapon.prototype.initialize = function () {
        (this.currentDoodahSpeed = 0),
            (this.player = !1),
            (this.locked = !1),
            this.doodahEntity &&
                (this.doodahReference.setLocalPosition(this.entity.findByName("DoodahPoint").getLocalPosition()), (this.accessory = this.doodahEntity.findByName("Model")), !0 === pc.settings.hideCharms && (this.doodahEntity.enabled = !1)),
            this.hasSlider && ((this.slider = this.entity.findByName(this.sliderName)), (this.bounceZ = 0), this.slider && (this.sliderStartPosition = this.slider.getLocalPosition().clone())),
            this.rotationSlider && ((this.slider = this.entity.findByName(this.sliderName)), (this.bounceZ = 0), this.slider && (this.sliderStartRotation = this.slider.getLocalEulerAngles().clone())),
            this.magazineName && ((this.magazine = this.entity.findByName(this.magazineName)), this.magazine && this.magazine.reparent(this.magazinePoint)),
            this.barrelName && ((this.barrel = this.entity.findByName(this.barrelName)), this.barrel && this.barrel.reparent(this.barrelPoint)),
    ...
    (Weapon.prototype.prepare = function () {
        this.armEntity && (this.armEntity.setLocalPosition(this.handPoint.getLocalPosition().clone()), this.armEntity.setLocalEulerAngles(this.handPoint.getLocalEulerAngles().clone())),
            this.rightArmEntity &&
                (this.rightHandPoint
                    ? (this.rightArmEntity.setLocalPosition(this.rightHandPoint.getLocalPosition().clone()), this.rightArmEntity.setLocalEulerAngles(this.rightHandPoint.getLocalEulerAngles().clone()))
                    : this.rightArmEntity.setLocalPosition(0, 0, 0));
    }),
    (Weapon.prototype.hideArms = function () {
        this.armEntity.setLocalPosition(this.handPoint.getLocalPosition().clone()), this.armEntity.tween(this.armEntity.getLocalPosition()).to({ x: -0.3, y: -1.2, z: 0 }, 0.2, pc.BackInOut).start();
    }),
    (Weapon.prototype.magazineThrow = function () {
        this.barrelPoint &&
            (this.barrelPoint.tween(this.barrelPoint.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: -55 }, 0.4, pc.BackInOut).start(),
            this.ammoEntity.setLocalPosition(-500, 0, 0),
            this.ammoEntity.tween(this.ammoEntity.getLocalPosition()).to({ x: 0, y: 0, z: 0 }, 0.2, pc.BackInOut).delay(0.3).start(),
            setTimeout(
                function (t) {
            ...
            this.magazinePoint.tween(this.magazinePoint.getLocalPosition()).to({ x: 0.5, y: -7, z: 0 }, 0.4, pc.BackInOut).start(),
            this.magazinePoint.tween(this.magazinePoint.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 30 }, 0.3, pc.BackInOut).start(),
            this.entity.sound.play("Unload"),
            this.app.fire("Player:Shake", !0);
    }),
    (Weapon.prototype.magazineAttach = function () {
        this.barrelPoint && this.barrelPoint.tween(this.barrelPoint.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.2, pc.BackInOut).start(),
            this.magazinePoint.tween(this.magazinePoint.getLocalPosition()).to({ x: 0, y: 0, z: 0 }, 0.2, pc.BackInOut).start(),
            this.magazinePoint.tween(this.magazinePoint.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.2, pc.BackInOut).start();
        var t = this.handPoint.getLocalPosition().clone();
        this.armEntity.tween(this.armEntity.getLocalPosition()).to({ x: t.x, y: t.y, z: t.z }, 0.2, pc.BackInOut).delay(0.2).start(), this.entity.sound.play("Load"), this.app.fire("Player:Shake", !0);
    }),
    ...
    (Weapon.prototype.focus = function () {
        this.entity.sound.slots.Focus && ((this.entity.sound.slots.Focus.pitch = 1 - 0.1 * Math.random()), this.entity.sound.play("Focus"));
    }),
    ...
    (Weapon.prototype.updateDoodah = function () {
        ...
        (this.currentDoodahSpeed = i > 0.16 && t > 0.1 ? pc.math.lerp(this.currentDoodahSpeed, i, 0.5) : pc.math.lerp(this.currentDoodahSpeed, 0, 0.01)),
    ...
    (Weapon.prototype.update = function (t) {
        if (this.locked) return !1;
        this.hasSlider && this.slider && (this.slider.setLocalPosition(this.sliderStartPosition.x + this.bounceZ, this.sliderStartPosition.y, this.sliderStartPosition.z), (this.bounceZ = pc.math.lerp(this.bounceZ, 0, 0.1))),
            this.rotationSlider && this.slider && (this.slider.setLocalEulerAngles(this.sliderStartRotation.x + this.bounceZ, this.sliderStartRotation.y, this.sliderStartRotation.z), (this.bounceZ = pc.math.lerp(this.bounceZ, 0, 0.1))),
            this.doodahEntity && this.updateDoodah(t);
    });
var EffectManager = pc.createScript("effectManager");
EffectManager.attributes.add("shootRay", { type: "entity" }),
    EffectManager.attributes.add("shootRayCount", { type: "number" }),
    EffectManager.attributes.add("impactEntity", { type: "entity" }),
    EffectManager.attributes.add("splashEntity", { type: "entity" }),
    EffectManager.attributes.add("hitEntity", { type: "entity" }),
    EffectManager.attributes.add("killEffect", { type: "entity" }),
    EffectManager.attributes.add("explosionSmokeEntity", { type: "entity" }),
    EffectManager.attributes.add("bulletEntity", { type: "entity" }),
    EffectManager.attributes.add("skullEntity", { type: "entity" }),
    EffectManager.attributes.add("sprayEntity", { type: "entity" }),
    EffectManager.attributes.add("bulletTranslate", { type: "vec3" }),
    EffectManager.attributes.add("bulletRotate", { type: "vec3" }),
    EffectManager.attributes.add("maxBulletTime", { type: "number", default: 2 }),
    EffectManager.attributes.add("cameraEntity", { type: "entity" }),
    EffectManager.attributes.add("spectatorCameraEntity", { type: "entity" }),
    EffectManager.attributes.add("garbageEntity", { type: "entity" }),
    EffectManager.attributes.add("bulletHolder", { type: "entity" }),
    EffectManager.attributes.add("mapEntity", { type: "entity" }),
    EffectManager.attributes.add("networkEntity", { type: "entity" }),
    EffectManager.attributes.add("rocketEntity", { type: "entity" }),
    EffectManager.attributes.add("grenadeEntity", { type: "entity" }),
    EffectManager.attributes.add("throwPower", { type: "number", default: 1e3 }),
    EffectManager.attributes.add("grenadeTime", { type: "number", default: 1.5 }),
    EffectManager.attributes.add("explosionEntity", { type: "entity" }),
    EffectManager.attributes.add("grappleEntity", { type: "entity" }),
    EffectManager.attributes.add("grapples", { type: "entity", array: !0 }),
    EffectManager.attributes.add("loudSoundEntity", { type: "entity" }),
    EffectManager.attributes.add("impactSoundEntity", { type: "entity" }),
    EffectManager.attributes.add("traceEntity", { type: "entity" }),
    EffectManager.attributes.add("shurikenEntity", { type: "entity" }),
    EffectManager.attributes.add("axeEntity", { type: "entity" }),
    EffectManager.attributes.add("abilityHolder", { type: "entity" }),
    EffectManager.attributes.add("explosionEffect", { type: "entity" }),
    EffectManager.attributes.add("killSphereEntity", { type: "entity" }),
    EffectManager.attributes.add("destructibleEffect", { type: "entity" }),
    EffectManager.attributes.add("crackEffect", { type: "entity" }),
    EffectManager.attributes.add("totemEntity", { type: "entity" }),
    EffectManager.attributes.add("testBox", { type: "entity" }),
    EffectManager.attributes.add("breakable", { type: "string", array: !0 }),
    EffectManager.attributes.add("explosive", { type: "string", array: !0 }),
    EffectManager.attributes.add("impactable", { type: "string", array: !0 }),
    EffectManager.attributes.add("placableObjects", { type: "entity", array: !0 }),
    EffectManager.attributes.add("mapHolder", { type: "entity" }),
    ...
    (EffectManager.prototype.onKillSphere = function (t) {
        (this.killSphereEntity.enabled = !0), this.killSphereEntity.setPosition(t), this.killSphereEntity.setLocalScale(0.1, 0.1, 0.1);
        var e = this.killSphereEntity.model.meshInstances[0].material;
        e.opacity = 1;
        var i = this.killSphereEntity.tween(this.killSphereEntity.getLocalScale()).to({ x: 15, y: 15, z: 15 }, 0.3, pc.CircularOut);
    ...
    (EffectManager.prototype.onSkullShow = function (t) {
        ...
        this.killEffect.setLocalPosition(t),
            ...
            (this.skullAnimation = this.skullEntity.tween(this.skullEntity.getLocalPosition()).to({ y: e.y + 1 }, 1, pc.SineOut)),
    ...
    (EffectManager.prototype.updateLight = function () {
        ...
        t && t.light && ((t.light.shadowUpdateMode = pc.SHADOWUPDATE_THISFRAME), t.light.updateShadow());
    }),
    ...
    (EffectManager.prototype.hitBatching = function () {
        for (var t = 0; t < this.shootRayCount; t++) {
            ...
            (e.sprite = e.findByName("Sprite").sprite), e.setPosition(Utils.nullVector), this.hitParticles.push(e), this.garbageEntity.addChild(e);
        }
    }),
    (EffectManager.prototype.shootRayBatching = function () {
        for (var t = 0; t < this.shootRayCount; t++) {
            var e = this.shootRay.clone();
            (e.sprite1 = e.findByName("RaySmoke1").sprite), (e.sprite2 = e.findByName("RaySmoke2").sprite), (e.trace = e.findByName("Trace")), e.setPosition(Utils.nullVector), this.shootRays.push(e), this.garbageEntity.addChild(e);
        }
        this.shootRay.destroy();
    }),
    (EffectManager.prototype.abilityBatcher = function () {
        (this.axes = []), (this.grenades = []), (this.shurikens = []), (this.currentAxeIndex = 0), (this.currentGrenadeIndex = 0), (this.currentShurikenIndex = 0), (this.currentGrappleIndex = 0);
        for (var t = 0; t < 3; t++) {
            var e = this.grenadeEntity.clone();
            e.setPosition(Utils.nullVector), (e.enabled = !1), this.grenades.push(e), this.abilityHolder.addChild(e);
        }
        for (var i = 0; i < 3; i++) {
            var a = this.axeEntity.clone();
            a.setPosition(Utils.nullVector), (a.enabled = !1), this.axes.push(a), this.abilityHolder.addChild(a);
        }
        for (var s = 0; s < 5; s++) {
            var n = this.shurikenEntity.clone();
            n.setPosition(Utils.nullVector), (n.enabled = !1), this.shurikens.push(n), this.abilityHolder.addChild(n);
        }
    }),
    ...
    (EffectManager.prototype.setDestructible = function (t) {
        ...
        (this.destructibleEffect.enabled = !0), this.destructibleEffect.sound.play("Explosion"), this.app.fire("BakedPhysics:Destructible-Box", t), (this.lastExplosionTime = Date.now());
    }),
    ...
    (EffectManager.prototype.setPlace = function (t, e, i) {
        ...
        if (a) {
            ...
            n.setLocalPosition(s),
                ...
                (n.enabled = !0),
                n.tween(n.getLocalPosition()).to({ x: e.x, y: e.y, z: e.z }, 0.5, pc.BounceOut).start(),
    ...
    (EffectManager.prototype.explosiveDamageRadius = function (t) {
        for (var e in this.explosive) {
            ...
            for (var s in a) {
                ...
                t.clone().sub(o).length() < 10 && n && n.parent && (this.setExplosionEffect(o), n && n.parent && n.parent.destroy());
            }
        }
    }),
    (EffectManager.prototype.breakDamageRadius = function (t) {
        for (var e in this.breakable) {
            ...
            for (var s in a) {
                var n = a[s],
                    o = n.getPosition().clone();
                t.clone().sub(o).length() < 10 && n && n.parent && (this.entity.setPosition(n.getPosition().clone()), this.entity.sound.play(i), n && n.parent && n.parent.destroy());
            }
        }
    }),
    (EffectManager.prototype.checkEntityBreakable = function (t) {
        ...
        for (var i in this.breakable) {
            ...
            t && e.indexOf(a) > -1 && t.parent && (this.entity.setPosition(t.getPosition().clone()), this.entity.sound.play(a), t && t.parent && t.parent.destroy());
        }
        for (var s in this.explosive) {
            var n = this.explosive[s];
            t && e.indexOf(n) > -1 && t.parent && (this.setExplosionEffect(t.getPosition().clone()), t && t.parent && t.parent.destroy());
        }
    }),
    (EffectManager.prototype.onRocket = function (t, e, i) {
        var a = this.rocketEntity.clone();
        a.setPosition(t), a.lookAt(e), (a.enabled = !0), i && (a.script.rocket.isOwner = !0), this.garbageEntity.addChild(a);
    }),
    (EffectManager.prototype.onThrow = function (t, e, i, a, s) {
        ...
        r.collision.on("collisionstart", function (t) {
            ...
            pc.isFinished || this.entity.sound.play("Collision"),
                ...
                t.other && "Player" == t.other.name && Date.now() - this.entity.startTime > 50 && "Star" == this.entity.type
                ...
                "Star" == this.entity.type &&
                    ...
                    i &&
                        ...
                        Date.now() - e.lastSmoke > 700 && (e.explosionSmokeEntity.particlesystem.reset(), e.explosionSmokeEntity.particlesystem.play(), (e.lastSmoke = Date.now())),
    ...
    (EffectManager.prototype.setExplosion = function (t) {
        ...
        (t.exploded = !0),
            ...
            pc.isFinished || ("Grenade" == t.type && (this.app.fire("Network:RadiusEffect", "Grenade", t.getPosition(), t.owner), t.hasSpell && this.app.fire("Spell:Wind", t.getPosition(), "Big"))),
            "Grenade" == t.type && (this.breakDamageRadius(t.getPosition()), this.explosiveDamageRadius(t.getPosition()), (this.lastSmoke = Date.now()));
        for (var i = this.grenades.length; i--; ) this.grenades[i]._guid == t._guid && this.grenades.splice(i, 1);
        t.destroy();
    }),
    ...
    (EffectManager.prototype.onBulletThrow = function (t, e) {
        ...
        s.setPosition(t), s.setLocalEulerAngles(a), (s.time = 0), this.bulletIndex++, this.bulletIndex > this.shootRayCount - 1 && (this.bulletIndex = 0);
    }),
    ...
    (EffectManager.prototype.onAxeThrow = function (t, e, i, a) {
        ...
        r.setLocalPosition(t),
            ...
            r.tween(r.getLocalPosition()).to({ x: o.x, y: o.y, z: o.z }, 0.25, pc.Linear).start(),
            setTimeout(
                function (t, e, n) {
                    t.sound.stop("Loop"),
    ...
    (EffectManager.prototype.onShuriken = function (t, e, i, a, s) {
        ...
        h.setLocalPosition(t),
            ...
            h.tween(h.getLocalPosition()).to({ x: l.x, y: l.y, z: l.z }, 0.2, pc.Linear).start(),
            p &&
                setTimeout(
                    function (t, e, a, s) {
                        (t.ray.enabled = !1), a && (1 === s ? e.dealHitEntity("Shuriken", a, n, i, !0) : e.dealHitEntity("Shuriken", a, n, i, !1));
                    },
                    50,
                    h,
                    this,
    ...
    (EffectManager.prototype.onSpray = function (t, e, i) {
        var a = this.app.systems.rigidbody.raycastFirst(t, e);
        if (!a) return !1;
        if (a.point.clone().sub(t).length() < 10) {
            var s = pc.setFromNormal(a.normal),
                n = this.sprayEntity.clone();
            n.setPosition(a.point), n.setEulerAngles(s), (n.enabled = !0);
            var o = n.findByName("Texture");
            o.opacity = 0;
            var r = o.model.material.clone(),
                p = Utils.getAssetFromURL("Spray-" + i + ".png");
            p &&
                p.ready(function () {
                    (r.diffuseMap = p.resource), (r.opacityMap = p.resource), r.update();
                });
            var l = this.app.tween(o).to({ opacity: 1 }, 0.5, pc.Linear);
            l.on("update", function (t) {
                (r.opacity = o.opacity), r.update();
            }),
                l.start(),
                (o.model.meshInstances[0].material = r),
                setTimeout(
                    function (t) {
                        t && t.destroy();
                    },
    ...
    (EffectManager.prototype.onHit = function (t, e, i, a, s, n) {
        ...
        for (var b in o) {
            ...
            for (var x in this.breakable) {
                var v = this.breakable[x];
                k.indexOf(v) > -1 && !E && (E = M);
            }
            k.length > 0 && (g.indexOf(k[0]) > -1 && (m = !0), g.push(k[0])), m || this.dealHitEntity(t, M, s, a);
        }
    }),
    (EffectManager.prototype.dealHitEntity = function (t, e, i, a, s) {
        ...
        if (o.indexOf("Player") > -1) {
            ...
            if ((l.setPosition(e.point), l.setEulerAngles(r), l.setLocalScale(p, p, p), l.sprite.stop(), pc.controls.player.playerId == a && i > 0)) {
                var h = e.entity,
                    c = !1,
                    y = e.point.clone().sub(h.getPosition().clone());
                h && h.script && h.script.enemy && (h.script.enemy.damage(a, i, y), "-1" !== h.script.enemy.playerId && (c = !0), s && h.script.enemy.dealSpell(t), c && this.app.fire("Hit:Point", h, i)),
            ...
            for (var f in (d.setPosition(e.point), d.setEulerAngles(r), d.setLocalScale(p, p, p), d.sprite1.play("Impact"), d.sprite2.play("Impact"), d.sprite3.play("Impact"), d.sprite4.play("Impact"), this.breakable)) {
                var u = this.breakable[f];
                o.indexOf(u) > -1 && (this.entity.setPosition(e.point), this.entity.sound.play(u), e.entity.parent && e.entity.parent.destroy());
            }
            if (Math.random() > 0.4 || "Melee" == t || "Shuriken" == t || "Axe" == t || "Dash" == t || "Grapple" == t)
                for (var E in this.impactable) {
                    var g = this.impactable[E];
                    o.indexOf(g) > -1 && this.playMaterialImpact(g, e, t);
                }
            "Shuriken" == t || "Grapple" == t
                ? (this.entity.setPosition(e.point), (this.entity.sound.slots["Impact-Iron-Light"].pitch = 0.1 * Math.random() + 1), this.entity.sound.play("Impact-Iron-Light"))
                : ("Melee" != t && "Dash" != t && "Axe" != t) || (this.entity.setPosition(e.point), (this.entity.sound.slots["Impact-Iron"].pitch = 0.1 * Math.random() + 1), this.entity.sound.play("Impact-Iron")),
    ...
    (EffectManager.prototype.onFire = function (t, e, i, a, s, n, o) {
        ...
        if (p) {
            ...
            if (f.indexOf("Player") > -1) {
                ...
                if ((u.setPosition(p.point), u.setEulerAngles(y), u.setLocalScale(d, d, d), u.sprite.stop(), p.entity && p.entity.script && p.entity.script.enemy)) "-1" !== p.entity.script.enemy.playerId && u.sprite.play("Impact");
                ...
                for (var k in (f.indexOf("Moving") > -1 && (E = !1), this.breakable)) {
                    ...
                    f.indexOf(x) > -1 && (this.entity.setPosition(p.point), this.entity.sound.play(x), p.entity.parent.destroy(), (E = !1));
                }
                for (var v in this.explosive) {
                    var S = this.explosive[v];
                    f.indexOf(S) > -1 && (this.setExplosionEffect(p.point), p.entity.parent.destroy(), (E = !1));
                }
                Date.now() - this.lastSmoke > 700 &&
                    (this.explosionSmokeEntity.setLocalScale(2, 2, 2),
                    ...
                    this.explosionSmokeEntity.particlesystem.play(),
                    (this.lastSmoke = Date.now())),
                    E && -1 === p.entity.tags.list().indexOf("Player") ? (m.hole.setLocalScale(0.17, 0.17, 0.17), m.hole.setLocalEulerAngles(0, g, 0)) : m.hole.setLocalScale(0.001, 0.001, 0.001),
        ...
        if ("Melee" != n) {
            ...
            I.setPosition(i),
                ...
                I.sprite2.play("Fire"),
                "Shotgun" == n
                    ? ((I.sprite1.opacity = 0.1), (I.sprite1.speed = 1.2), (I.sprite2.opacity = 0.1), (I.sprite2.speed = 1.2))
                    : "Sniper" == n
                    ? ((I.sprite1.opacity = 0.9), (I.sprite1.speed = 0.5), (I.sprite2.opacity = 0.9), (I.sprite2.speed = 0.5))
                    : s > 40
                    ? ((I.sprite1.opacity = 0.3), (I.sprite1.speed = 0.7), (I.sprite2.opacity = 0.3), (I.sprite2.speed = 0.7))
                    : ((I.sprite1.opacity = 0.1), (I.sprite1.speed = 1.2), (I.sprite2.opacity = 0.1), (I.sprite2.speed = 1.2)),
                I.trace.setLocalPosition(0, 0, -5),
                pc.controls.player.playerId,
                I.trace.tween(I.trace.getLocalPosition()).to({ x: 0, y: 0, z: -l }, 0.2, pc.Linear).start(),
    ...
    (EffectManager.prototype.playMaterialImpact = function (t, e, i) {
        ...
        this.impactSoundEntity.setPosition(e.point), this.impactSoundEntity.sound.play(t + "-" + a), Math.random() > 0.4 && "Melee" != i && this.impactSoundEntity.sound.play("Ricochet-" + a);
    }),
    (EffectManager.prototype.pointDamage = function (t, e, i, a, s) {
        if (pc.controls.player.playerId == i) {
            ...
            t && t.script && t.script.enemy && (t.script.enemy.damage(i, a, n), this.app.fire("Network:PointEffect", pc.controls.player.playerId, s, e, i));
        }
    }),
    (EffectManager.prototype.calculateRichotte = function (t, e, i, a) {
        var s = pc.controls.entity.getPosition().clone(),
            n = Utils.closestPointLine({ x: s.x, y: s.z }, { x: t.x, y: t.z }, { x: e.x, y: e.z });
        if (n && n.point) {
    ...
    (EffectManager.prototype.setPlayerPosition = function (t) {
        ...
        for (var e in this.checkpointEntities) {
            ...
            i.getPosition().clone().sub(t).length() < 3 && !0 === i.enabled && ((i.enabled = !1), this.app.fire("Overlay:Sound", "Checkpoint"));
        }
    }),
    ...
    (EffectManager.prototype.checkDistances = function (t) {
        ...
        for (var i in this.birdEntities) {
            ...
            a &&
                ...
                ((a.enabled = !0), a.setLocalEulerAngles(0, 180 * Math.random(), 0), (a.animation.speed = 1), (a.animation.loop = !0), a.animation.play("Bird-Idle"), (a.isFlied = !1));
        }
    }),
...
WeaponManager.attributes.add("defaultWeapon", { type: "string", default: "Scar" }),
    WeaponManager.attributes.add("armLeftEntity", { type: "entity" }),
    WeaponManager.attributes.add("armRightEntity", { type: "entity" }),
    WeaponManager.attributes.add("weaponHolder", { type: "entity" }),
    WeaponManager.attributes.add("swingLeftEntity", { type: "entity" }),
    WeaponManager.attributes.add("swingRightEntity", { type: "entity" }),
    WeaponManager.attributes.add("muzzleEntity", { type: "entity" }),
    WeaponManager.attributes.add("flameSpeed", { type: "number", default: 0.1 }),
    WeaponManager.attributes.add("maxFlameScale", { type: "number", default: 3 }),
    WeaponManager.attributes.add("weaponIcons", { type: "entity", array: !0 }),
    ...
    (WeaponManager.prototype.onMapLoaded = function (e) {
        "GUNGAME" != pc.currentMode &&
            ...
            (this.timer = setTimeout(
                function (e) {
                    e.setWeapon(e.weapons[0]), e.setWeaponModel(e.weapons[0]);
                },
                100,
                this
            )));
    ...
    (WeaponManager.prototype.setWeaponLayout = function (e) {
        if (e.success && e.weapons)
            for (var t in ((this.weapons = e.weapons), this.weaponIcons)) {
                this.weaponIcons[t].element.textureAsset = this.app.assets.find(e.weapons[t] + "-Thumbnail.png");
            }
    }),
    ...
    (WeaponManager.prototype.setWeapons = function () {
        "GUNGAME" != pc.currentMode && (pc.session && pc.session.weapon ? (this.setWeapon(pc.session.weapon), this.setWeaponModel(pc.session.weapon)) : (this.setWeapon(this.defaultWeapon), this.setWeaponModel(this.defaultWeapon)));
    }),
    ...
    (WeaponManager.prototype.createAnimatedSkin = function (e) {
        var t = this.app,
            n = e.replace(".jpg", ".mp4"),
            a = new pc.Texture(t.graphicsDevice, { format: pc.PIXELFORMAT_R5_G6_B5, autoMipmap: !1 });
        (a.minFilter = pc.FILTER_LINEAR), (a.magFilter = pc.FILTER_LINEAR), (a.addressU = pc.ADDRESS_CLAMP_TO_EDGE), (a.addressV = pc.ADDRESS_CLAMP_TO_EDGE);
    ...
    (WeaponManager.prototype.setSkin = function (e) {
        if (e && this.currentWeaponEntity) {
            var t = this.currentWeaponEntity.model.material.clone(),
                n = !1;
            e.search("Animated") > -1
                ? ((n = this.createAnimatedSkin(e)), (t.diffuseMap = n), t.update())
                : this.getSkinFromURL(e, function (e) {
                      (t.diffuseMap = e), t.update();
                  });
            var a = this,
                i = this.currentWeaponEntity.model.asset;
            this.app.assets.get(i).ready(function () {
                var e = a.currentWeaponEntity.model.meshInstances;
                if (e)
    ...
    (WeaponManager.prototype.triggerShooting = function () {
        (this.currentFlameScale = Math.random() * (this.maxFlameScale / 2) + this.maxFlameScale), (this.currentFlameAngle = 360 * Math.random());
    }),
...
Sprite.attributes.add("type", { type: "string", enum: [{ blending: "blending" }, { "animated-2d": "animated-2d" }], default: "blending" }),
    Sprite.attributes.add("materialEntity", { type: "entity" }),
    Sprite.attributes.add("speed", { type: "number" }),
    Sprite.attributes.add("totalFrameCount", { type: "number" }),
    ...
    (Sprite.prototype.update = function (t) {
        "animated-2d" == this.type && ((this.entity.element.spriteFrame = Math.floor(this.currentSpriteFrame % this.totalFrameCount)), (this.currentSpriteFrame += this.speed * t));
    });
var Hitmarker = pc.createScript("hitmarker");
Hitmarker.attributes.add("hitPointEntity", { type: "entity" }),
    Hitmarker.attributes.add("hitPointHolder", { type: "entity" }),
    Hitmarker.attributes.add("crosshairEntity", { type: "entity" }),
    Hitmarker.attributes.add("distance", { type: "number", default: 100 }),
    Hitmarker.attributes.add("spread", { type: "number", default: 20 }),
    Hitmarker.attributes.add("speed", { type: "number", default: 1 }),
    Hitmarker.attributes.add("duration", { type: "number", default: 1 }),
    Hitmarker.attributes.add("rotateSpeed", { type: "number", default: 1 }),
    Hitmarker.attributes.add("cameraEntity", { type: "entity" }),
    Hitmarker.attributes.add("screenEntity", { type: "entity" }),
    Hitmarker.attributes.add("hitmarkerEntity", { type: "entity" }),
    Hitmarker.attributes.add("defaultPitch", { type: "number", default: 1 }),
    Hitmarker.attributes.add("hitColor", { type: "rgb" }),
    ...
    (Hitmarker.prototype.onHeadshot = function (t, e) {
        ...
        this.app.fire("DealtDamage:Trigger", e, t, !0),
            ...
            this.hitmarkerEntity.tween(this.hitmarkerEntity.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 0.25, pc.BackOut).start(),
            (this.lastHeadshot = Date.now());
    }),
    (Hitmarker.prototype.onHitPoint = function (t, e) {
        this.app.fire("DealtDamage:Trigger", e, t),
            ...
            this.hitmarkerEntity.tween(this.hitmarkerEntity.getLocalScale()).to({ x: 1.8, y: 1.8, z: 1.8 }, 0.15, pc.BackOut).start(),
            (this.lastHitTime = Date.now());
    }),
    (Hitmarker.prototype.trackPoint = function (t, e) {
        ...
        a.x > 0 && a.x < this.app.graphicsDevice.width && a.y > 0 && a.y < this.app.graphicsDevice.height && a.z > 0
            ? (t.direction > 0.5 ? t.rotateLocal(0, 0, this.rotateSpeed * e) : t.rotateLocal(0, 0, -this.rotateSpeed * e), t.setLocalPosition(a.x / r, (n.height - a.y) / r, 0), (t.enabled = !0))
            : (t.enabled = !1);
    }),
    (Hitmarker.prototype.updatePoints = function (t) {
        ...
        if (this.points && this.points.length > 0)
            for (var e = this.points.length; e--; ) {
                var i = this.points[e];
                i && ((i.time -= t * this.speed), i.time < 0 ? (i.destroy(), this.points.splice(e, 1)) : this.trackPoint(i, t));
            }
    }),
    (Hitmarker.prototype.update = function (t) {
        this.updatePoints(t), Date.now() - this.lastHitTime > 350 && (this.hitmarkerEntity.element.opacity = pc.math.lerp(this.hitmarkerEntity.element.opacity, 0, 0.2));
    });
var Rotate = pc.createScript("rotate");
Rotate.attributes.add("axis", { type: "string", enum: [{ x: "x" }, { y: "y" }, { z: "z" }] }),
    Rotate.attributes.add("speed", { type: "number" }),
    Rotate.attributes.add("waveStyle", { type: "boolean" }),
    Rotate.attributes.add("waveWidth", { type: "number" }),
    Rotate.attributes.add("children", { type: "boolean" }),
    Rotate.attributes.add("graphName", { type: "string" }),
    ...
    (Rotate.prototype.update = function (t) {
        ...
        this.waveStyle && ((e = Math.cos(this.timestamp * this.speed) * this.waveWidth), (this.timestamp += 60 * t)),
            this.currentElement
                ? ("x" == this.axis && this.currentElement.rotateLocal(e, 0, 0), "y" == this.axis && this.currentElement.rotateLocal(0, e, 0), "z" == this.axis && this.currentElement.rotateLocal(0, 0, e))
                : this.children && (this.currentElement = this.entity.findByName(this.graphName));
    });
var NetworkManager = pc.createScript("networkManager");
NetworkManager.attributes.add("isDebug", { type: "boolean", default: !0 }),
    NetworkManager.attributes.add("URL", { type: "string" }),
    NetworkManager.attributes.add("testURL", { type: "string" }),
    NetworkManager.attributes.add("characterName", { type: "string", default: "Lilium" }),
    NetworkManager.attributes.add("mapName", { type: "string", default: "Sierra" }),
    NetworkManager.attributes.add("currentMode", { type: "string", default: "POINT" }),
    NetworkManager.attributes.add("enemyEntity", { type: "entity" }),
    NetworkManager.attributes.add("playerHolder", { type: "entity" }),
    NetworkManager.attributes.add("playerEntity", { type: "entity" }),
    NetworkManager.attributes.add("overlayEntity", { type: "entity" }),
    NetworkManager.attributes.add("menuCameraEntity", { type: "entity" }),
    NetworkManager.attributes.add("blackShadow", { type: "entity" }),
    NetworkManager.attributes.add("gameEntity", { type: "entity" }),
    NetworkManager.attributes.add("spectatorEntity", { type: "entity" }),
    (NetworkManager.prototype.initialize = function () {
        "undefined" != typeof VERSION && (this.isDebug = !1),
            ...
            pc.session && pc.session.hash ? ((this.hash = pc.session.hash), pc.session.username && (this.username = pc.session.username)) : (this.hash = !1),
            (this.skin = "Lilium"),
            (this.team = "none"),
            ...
            pc.session && void 0 !== pc.session.character ? ((this.characterName = pc.session.character), (this.skin = pc.session.character)) : (this.skin = this.characterName),
        ...
        var e = 300;
        pc.isMobile && (e = 140),
            (this.options = { maxTime: e, maxPlayer: 4, points: 4, gameMode: this.currentMode, map: this.currentMap, record: !1 }),
            ...
            "DEV" == VERSION_CODE && this.reconnect(),
            (this.blackShadow.enabled = !0);
    }),
    ...
    (NetworkManager.prototype.setOptions = function (e) {
        e
            ? ((this.URL = "wss://" + e.result.server),
              ...
              this.app.fire("Overlay:SetLoading", e))
    ...
    (NetworkManager.prototype.onOpen = function (e) {
        this.log("Network connection is open!"), pc.isRequeuing || (this.app.fire("Overlay:InfoClose", !0), this.app.fire("Overlay:Pause", !1));
    }),
    (NetworkManager.prototype.publicStatus = function (e) {
        e.length > 0 && (pc.isPrivate = e[0]);
    }),
    (NetworkManager.prototype.onClose = function (e) {
        pc.isRequeuing || this.app.fire("Overlay:Info", "Game disconnected, please refresh page!"), this.log("Network connection is close!");
    }),
    (NetworkManager.prototype.kick = function (e) {
        var t = e[0];
        this.app.fire("Overlay:Info", "You have been kicked. Reason : " + t), this.app.mouse.disablePointerLock(), this.app.fire("Player:Lock", !1), this.app.fire("Overlay:Pause", !1);
    }),
    ...
    (NetworkManager.prototype.auth = function (e) {
        !0 === e[0] &&
            (this.send([this.keys.auth, this.roomId, this.username, this.characterName, this.currentWeapon, this.options, this.hash, this.isSpectator]),
            (this.skin = this.characterName),
            this.isSpectator
                ? ((this.playerEntity.enabled = !1), (this.overlayEntity.enabled = !1), (this.spectatorEntity.enabled = !0))
                : ((this.playerEntity.enabled = !0), (this.overlayEntity.enabled = !0), (this.spectatorEntity.enabled = !1)),
            (this.authDate = Date.now()));
    }),
    (NetworkManager.prototype.onLeave = function () {
        this.authDate && Date.now() - this.authDate < 5e4 && pc.currentMode && "CUSTOM" != pc.currentMode && Utils.setItem("LeftEarly", "Left");
    }),
    ...
    (NetworkManager.prototype.mode = function (e) {
        ...
        e[0] &&
            ...
            this.app.fire("Analytics:GameplayStart", !0),
            this.setModeState(this.lastMode, !1),
            this.setModeState(this.currentMode, !0);
        var a = this.app.root.findByName("Result");
        if (a) {
            var i = this.app.root.findByName("ChatWrapper");
            i && (i.setLocalPosition(0, 0, 0), i.reparent(this.app.root.findByName("ChatGame"))), a.destroy();
        }
        if (
            ...
            this.app.fire("Player:Hide", !0),
                Math.random() > 0.7
                    ? (console.log("[EVENT] Reward ads."),
                      this.app.fire("Ads:RewardAds", function () {
                          r.app.fire("Player:Show", !0), pc.app.fire("Analytics:Event", "Ads", "RewardAds");
                      }))
                    : (console.log("[EVENT] Preroll ads."),
                      this.app.fire("Ads:Preroll", function () {
                          r.app.fire("Player:Show", !0), pc.app.fire("Analytics:Event", "Ads", "PrerollAds");
                      }));
        }
    }),
    ...
    (NetworkManager.prototype.setPlayerShow = function () {
        ...
        this.isMuted && (this.currentVolume > 0 ? (this.app.systems.sound.volume = this.currentVolume) : (this.app.systems.sound.volume = 0.25), (this.isMuted = !1)), (pc.isPauseActive = !1), this.send([this.keys.show, !0]);
    }),
    (NetworkManager.prototype.setModeState = function (e, t) {
        for (var a = this.app.root.findByTag("MODE-" + e), i = a.length; i--; ) a[i] && (a[i].enabled = t);
    }),
    ...
    (NetworkManager.prototype.weapon = function (e) {
        if (e.length > 0) {
            ...
            this.playerId == t ? this.app.fire("WeaponManager:Set", a, !0) : i && i.script.enemy.setWeapon(a);
        }
    }),
    (NetworkManager.prototype.setThrow = function (e, t, a) {
        "Grenade" == e || "Grapple" == e || "Axe" == e || "Crack" == e ? this.send([this.keys.throw, e, t.x, t.y, t.z, a.x, a.y, a.z]) : "Shuriken" == e && this.send([this.keys.throw, e, t.x, t.y, t.z, a[0], a[1], a[2]]);
    }),
    ...
    (NetworkManager.prototype.cosmetics = function (e) {
        pc.session && void 0 !== pc.session.character ? this.app.fire("Player:Character", pc.session.character) : this.app.fire("Player:Character", this.characterName),
            e.length > 0 && (this.app.fire("WeaponManager:SetCharm", e[0]), this.app.fire("WeaponManager:SetSpray", e[1]), this.app.fire("Player:Skin", e[2]));
    }),
    ...
    (NetworkManager.prototype.character = function (e) {
        if (e.length > 0) {
            var t = this.getPlayerById(e[0]),
                a = e[1],
                i = e[2];
            e[0] == this.playerId ? this.app.fire("Player:Dance", i) : t && t.script.enemy.setCharacterSkin(a, !1, i);
        }
    }),
    ...
    (NetworkManager.prototype.overtime = function () {
        this.app.fire("Overlay:Announce", "Overtime", "50 seconds", "Overtime", "Overtime-Icon"), this.app.fire("Game:Overtime", !0);
    }),
    ...
    (NetworkManager.prototype.setReport = function (e) {
        this.send([this.keys.report, e]), this.app.fire("View:Pause", "Thanks");
    }),
    ...
    (NetworkManager.prototype.setGuard = function (e) {
        this.send(["guard", e]), e || this.app.fire("Analytics:Event", "Hacker", "VengeGuard"), (this.lastGuardTime = Date.now());
    }),
    (NetworkManager.prototype.objectivePoint = function (e) {
        e.length > 0 && (this.app.fire("Mode:Objective", e[0]), "BLACKCOIN" == this.options.gameMode && this.app.fire("Mode:ShowObjective", "BlackCoin-Point"));
    }),
    (NetworkManager.prototype.objective = function (e) {
        e.length;
    }),
    (NetworkManager.prototype.finish = function (e) {
        if ((this.app.fire("Game:Overtime", !1), this.app.fire("Analytics:GameplayStop", !0), e.length > 0)) {
            var t = e[0];
            for (var a in t) {
                var i = t[a];
    ...
    (NetworkManager.prototype.discardObject = function (e) {
        if (e.length > 0) {
            var t = e[0];
            this.send(["discard_object", t.id, Utils.generateId(t.position), { x: 0, y: 0, z: 0 }]);
        }
    }),
    (NetworkManager.prototype.notification = function (e) {
        ...
        if ("kill" == t) {
            ...
            this.app.fire("Overlay:Notification", "kill", { killer: Utils.displayUsername(r.username), killed: Utils.displayUsername(s.username), killedSkin: s.skin, killerSkin: r.skin, color: o, reason: i, weapon: a.weapon }, !1);
        }
    }),
    (NetworkManager.prototype.damage = function (e) {
        ...
        if (t) {
            var a = t.getPosition();
            this.app.fire("Overlay:Damage", { x: a.x, y: a.y, z: a.z });
        }
    }),
    ...
    (NetworkManager.prototype.announceText = function (e) {
        ...
        r && this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + r.username + "[/color] " + a, !1, i);
    }),
    (NetworkManager.prototype.announce = function (e) {
        ...
        t &&
            ...
            "unlock" == t && o && "UnlockCards" == r && this.app.fire("Overlay:Announce", "Cards Unlocked", "Press [B] to unlock them", "UnlockCards", "Card-Unlock-Icon"),
            "affected" == t && o && (this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + o.username + "[/color] affected by " + n + " with " + r, !1), o.applyAbilityAffect && o.applyAbilityAffect(r)),
            "objective" == t && o && "Capture" == r && this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + o.username + "[/color] captured point!", !1),
            "kill" == t && o && "Suicide" == r && this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + o.username + "[/color] suicided!", !1));
    }),
    (NetworkManager.prototype.task = function (e) {
        var t = e[0],
            ...
            o = null,
            n = t;
        "Tier1" == t && (n = "Tier 1"), "Tier2" == t && (n = "Tier 2"), "Tier3" == t && (n = "Tier 3"), t.indexOf("Level") > -1 && ((s = !0), (o = e[4])), this.app.fire("Overlay:Task", n, a, i, r, o, s);
    }),
    ...
    (NetworkManager.prototype.unlock = function (e) {
        var t = e[0],
            ...
            i = e[2],
            r = a;
        if (("Tier1" == a && (r = "Tier 1"), "Tier2" == a && (r = "Tier 2"), "Tier3" == a && (r = "Tier 3"), "Tier4" == a && (r = "Tier 4"), t == this.playerId)) this.app.fire("Overlay:Unlock", r, i);
        else {
            var s = this.getPlayerScriptById(t).username;
            this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + s + "[/color] unlocked " + a + " abilities!", !1);
        }
    }),
    (NetworkManager.prototype.kill = function (e) {
        ...
        t == this.playerId ? (this.app.fire("Analytics:GameplayStop", !0), this.app.fire("Player:Death", s, i)) : r && r.script.enemy.death(i);
    }),
    ...
    (NetworkManager.prototype.event = function (e) {
        if (e.length > 0) {
            var t = e[0],
                ...
                i = e[1],
                r = !1;
            e.length > 2 && (r = e[2]), t == this.playerId ? this.app.fire("Player:TriggerEvent", i, r) : a && a.script.enemy.triggerEvent(i, r);
        }
    }),
    ...
    (NetworkManager.prototype.place = function (e) {
        if (e) {
            var t = e[0],
                ...
                r = e[3];
            "Totem" == a ? this.app.fire("EffectManager:Totem", i, new pc.Vec3(0, 0, 0), t) : this.app.fire("EffectManager:Place", a, i, r);
        }
    }),
    ...
    (NetworkManager.prototype.teamList = function (e) {
        ...
        (this.currentTeamList = {
            result: [
                { name: "Blue", team: "blue", players: t.join(", "), button: t.length < 2 ? "$button" : "" },
                { name: "Red", team: "red", players: a.join(", "), button: a.length < 2 ? "$button" : "" },
            ],
        }),
    ...
    (NetworkManager.prototype.teamSet = function (e) {
        if (e.length > 0) {
            var t = e[0],
                a = e[1],
                i = this.getPlayerById(t);
            t == this.playerId ? (this.app.fire("Player:Team", a), (pc.currentTeam = a), (this.team = a)) : i && i.script.enemy.setTeam(a);
        }
    }),
    ...
    (NetworkManager.prototype.getPlayerById = function (e) {
        ...
        for (var t = this.players.length; t--; ) if (this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.playerId == e) return this.players[t];
        return !1;
    }),
    (NetworkManager.prototype.getPlayerScriptById = function (e) {
        if (this.playerId == e) return this;
        for (var t = this.players.length; t--; ) if (this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.playerId == e) return this.players[t].script.enemy;
        return !1;
    }),
    (NetworkManager.prototype.removePlayerById = function (e) {
        if (this.playerId == e) return this;
        for (var t = this.players.length; t--; ) this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.playerId == e && this.players.splice(t, 1);
    }),
    (NetworkManager.prototype.left = function (e) {
        if (e.length > 0) {
            ...
            if (t && t.script && t.script.enemy) {
                ...
                this.removePlayerById(e[0]), this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + a + "[/color] left", !1), t.script.enemy.left();
            }
        }
    }),
    ...
    (NetworkManager.prototype.player = function (e) {
        ...
        if (t) {
            ...
            "-1" != t.playerId && this.app.fire("Overlay:Notification", "message", '[color="#58E6FA"]' + a + "[/color] joined", !1), t.playerId != this.playerId && this.createPlayer(t);
        }
    ...
    (NetworkManager.prototype.flag = function (e) {
        if (e.length > 0) {
            var t = e[0],
                a = e[1],
                i = this.getPlayerById(t);
            this.playerId == t ? this.app.fire("Overlay:Objective", "Deliver the flag", a) : i && i.script.enemy && i.script.enemy.setFlag(a);
        }
    }),
    ...
    (NetworkManager.prototype.tick = function (e) {
        var t = parseInt(e[0]),
            a = t;
        0 === t && ((pc.isFinished = !0), (pc.isMapLoaded = !1)), this.app.fire("Server:Tick", t, a), this.app.fire("VengeGuard:Check", !0), this.selfTick();
    }),
...
!(function (t, r) {
    ...
    const r = ["B", "kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"],
        e = (t, r) => {
            let g = t;
            return "string" == typeof r ? (g = t.toLocaleString(r)) : !0 === r && (g = t.toLocaleString()), g;
        };
    for (var g = [], d = [], U = "undefined" != typeof Uint8Array ? Uint8Array : Array, R = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", D = 0, Y = R.length; D < Y; ++D) (g[D] = R[D]), (d[R.charCodeAt(D)] = D);
    function l(t) {
        var r = t.length;
    ...
    function p(t, r, d) {
        for (var U, R, D = [], Y = r; Y < d; Y += 3) (U = ((t[Y] << 16) & 16711680) + ((t[Y + 1] << 8) & 65280) + (255 & t[Y + 2])), D.push(g[((R = U) >> 18) & 63] + g[(R >> 12) & 63] + g[(R >> 6) & 63] + g[63 & R]);
        return D.join("");
    }
    ...
    var q,
        g_toByteArray = function (t) {
            for (
                ...
                (r = (d[t.charCodeAt($)] << 18) | (d[t.charCodeAt($ + 1)] << 12) | (d[t.charCodeAt($ + 2)] << 6) | d[t.charCodeAt($ + 3)]), (Y[q++] = (r >> 16) & 255), (Y[q++] = (r >> 8) & 255), (Y[q++] = 255 & r);
            return (
                2 === D && ((r = (d[t.charCodeAt($)] << 2) | (d[t.charCodeAt($ + 1)] >> 4)), (Y[q++] = 255 & r)),
                1 === D && ((r = (d[t.charCodeAt($)] << 10) | (d[t.charCodeAt($ + 1)] << 4) | (d[t.charCodeAt($ + 2)] >> 2)), (Y[q++] = (r >> 8) & 255), (Y[q++] = 255 & r)),
                Y
            );
        },
        g_fromByteArray = function (t) {
            for (var r, d = t.length, U = d % 3, R = [], D = 0, Y = d - U; D < Y; D += 16383) R.push(p(t, D, D + 16383 > Y ? Y : D + 16383));
            return 1 === U ? ((r = t[d - 1]), R.push(g[r >> 2] + g[(r << 4) & 63] + "==")) : 2 === U && ((r = (t[d - 2] << 8) + t[d - 1]), R.push(g[r >> 10] + g[(r >> 4) & 63] + g[(r << 2) & 63] + "=")), R.join("");
        },
        d_read = function (t, r, g, d, U) {
            var R,
                ...
                W = g ? -1 : 1,
                Z = t[r + V];
            for (V += W, R = Z & ((1 << -$) - 1), Z >>= -$, $ += Y; $ > 0; R = 256 * R + t[r + V], V += W, $ -= 8);
            for (D = R & ((1 << -$) - 1), R >>= -$, $ += d; $ > 0; D = 256 * D + t[r + V], V += W, $ -= 8);
            if (0 === R) R = 1 - X;
            else {
                ...
                r = Math.abs(r),
                    isNaN(r) || r === 1 / 0
                        ...
                        : ((D = Math.floor(Math.log(r) / Math.LN2)),
                          ...
                          D + V >= $ ? ((Y = 0), (D = $)) : D + V >= 1 ? ((Y = (r * q - 1) * Math.pow(2, U)), (D += V)) : ((Y = r * Math.pow(2, V - 1) * Math.pow(2, U)), (D = 0)));
                U >= 8;
        ...
        X =
            ((function (t, r) {
                ...
                function o(t, r, g) {
                    ...
                    if (j(t, ArrayBuffer) || (t && j(t.buffer, ArrayBuffer)))
                        return (function (t, r, g) {
                            ...
                            if (t.byteLength < r + (g || 0)) throw new RangeError('"length" is outside of buffer bounds');
                            var d;
                            return ((d = void 0 === r && void 0 === g ? new Uint8Array(t) : void 0 === g ? new Uint8Array(t, r) : new Uint8Array(t, r, g)).__proto__ = i.prototype), d;
                        })(t, r, g);
                    ...
                    var U = (function (t) {
                        ...
                        return void 0 !== t.length ? ("number" != typeof t.length || F(t.length) ? n(0) : a(t)) : "Buffer" === t.type && Array.isArray(t.data) ? a(t.data) : void 0;
                    })(t);
                    if (U) return U;
                    if ("undefined" != typeof Symbol && null != Symbol.toPrimitive && "function" == typeof t[Symbol.toPrimitive]) return i.from(t[Symbol.toPrimitive]("string"), r, g);
                ...
                function a(t) {
                    for (var r = t.length < 0 ? 0 : 0 | s(t.length), g = n(r), d = 0; d < r; d += 1) g[d] = 255 & t[d];
                    return g;
                }
                function s(t) {
                ...
                function l(t, r, g, d, U) {
                    ...
                    if (("string" == typeof g ? ((d = g), (g = 0)) : g > 2147483647 ? (g = 2147483647) : g < -2147483648 && (g = -2147483648), F((g = +g)) && (g = U ? 0 : t.length - 1), g < 0 && (g = t.length + g), g >= t.length)) {
                        if (U) return -1;
                        g = t.length - 1;
                    } else if (g < 0) {
                        if (!U) return -1;
                    ...
                    if (("string" == typeof r && (r = i.from(r, d)), i.isBuffer(r))) return 0 === r.length ? -1 : p(t, r, g, d, U);
                    if ("number" == typeof r) return (r &= 255), "function" == typeof Uint8Array.prototype.indexOf ? (U ? Uint8Array.prototype.indexOf.call(t, r, g) : Uint8Array.prototype.lastIndexOf.call(t, r, g)) : p(t, [r], g, d, U);
                ...
                function m(t, r, g, d) {
                    return z(
                        (function (t, r) {
                            for (var g, d, U, R = [], D = 0; D < t.length && !((r -= 2) < 0); ++D) (d = (g = t.charCodeAt(D)) >> 8), (U = g % 256), R.push(U), R.push(d);
                            return R;
                        })(r, t.length - g),
                        t,
                        g,
                        ...
                        if (R + W <= g)
                            switch (W) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    128 == (192 & (D = t[R + 1])) && (X = ((31 & $) << 6) | (63 & D)) > 127 && (V = X);
                                    break;
                                case 3:
                                    (D = t[R + 1]), (Y = t[R + 2]), 128 == (192 & D) && 128 == (192 & Y) && (X = ((15 & $) << 12) | ((63 & D) << 6) | (63 & Y)) > 2047 && (X < 55296 || X > 57343) && (V = X);
                                    break;
                                case 4:
                                    (D = t[R + 1]),
                                        (Y = t[R + 2]),
                                        (q = t[R + 3]),
                                        128 == (192 & D) && 128 == (192 & Y) && 128 == (192 & q) && (X = ((15 & $) << 18) | ((63 & D) << 12) | ((63 & Y) << 6) | (63 & q)) > 65535 && X < 1114112 && (V = X);
                            }
                        null === V ? ((V = 65533), (W = 1)) : V > 65535 && ((V -= 65536), U.push(((V >>> 10) & 1023) | 55296), (V = 56320 | (1023 & V))), U.push(V), (R += W);
                    }
                    return (function (t) {
                        var r = t.length;
                        if (r <= d) return String.fromCharCode.apply(String, t);
                        for (var g = "", U = 0; U < r; ) g += String.fromCharCode.apply(String, t.slice(U, (U += d)));
                        return g;
                    })(U);
                }
                (r.kMaxLength = g),
                    ...
                    "undefined" != typeof Symbol && null != Symbol.species && i[Symbol.species] === i && Object.defineProperty(i, Symbol.species, { value: null, configurable: !0, enumerable: !1, writable: !1 }),
                    (i.poolSize = 8192),
                    ...
                    (i.alloc = function (t, r, g) {
                        return (function (t, r, g) {
                            return f(t), t <= 0 ? n(t) : void 0 !== r ? ("string" == typeof g ? n(t).fill(r, g) : n(t).fill(r)) : n(t);
                        })(t, r, g);
                    }),
                    ...
                    (i.compare = function (t, r) {
                        if ((j(t, Uint8Array) && (t = i.from(t, t.offset, t.byteLength)), j(r, Uint8Array) && (r = i.from(r, r.offset, r.byteLength)), !i.isBuffer(t) || !i.isBuffer(r)))
                    ...
                    (i.concat = function (t, r) {
                        ...
                        for (g = 0; g < t.length; ++g) {
                            var R = t[g];
                            if ((j(R, Uint8Array) && (R = i.from(R)), !i.isBuffer(R))) throw new TypeError('"list" argument must be an Array of Buffers');
                    ...
                    (i.prototype.compare = function (t, r, g, d, U) {
                        ...
                        if ((void 0 === r && (r = 0), void 0 === g && (g = t ? t.length : 0), void 0 === d && (d = 0), void 0 === U && (U = this.length), r < 0 || g > t.length || d < 0 || U > this.length))
                            throw new RangeError("out of range index");
                        if (d >= U && r >= g) return 0;
                        if (d >= U) return -1;
                        if (r >= g) return 1;
                        if (this === t) return 0;
                        for (var R = (U >>>= 0) - (d >>>= 0), D = (g >>>= 0) - (r >>>= 0), Y = Math.min(R, D), q = this.slice(d, U), X = t.slice(r, g), $ = 0; $ < Y; ++$)
                            if (q[$] !== X[$]) {
                                (R = q[$]), (D = X[$]);
                                break;
                            }
                    ...
                    (i.prototype.write = function (t, r, g, d) {
                        if (void 0 === r) (d = "utf8"), (g = this.length), (r = 0);
                            ...
                            (r >>>= 0), isFinite(g) ? ((g >>>= 0), void 0 === d && (d = "utf8")) : ((d = g), (g = void 0));
                        }
                        var U = this.length - r;
                        if (((void 0 === g || g > U) && (g = U), (t.length > 0 && (g < 0 || r < 0)) || r > this.length)) throw new RangeError("Attempt to write outside buffer bounds");
                        d || (d = "utf8");
                        for (var R = !1; ; )
                            switch (d) {
                                case "hex":
                ...
                function S(t, r, g) {
                    for (var d = t.slice(r, g), U = "", R = 0; R < d.length; R += 2) U += String.fromCharCode(d[R] + 256 * d[R + 1]);
                    return U;
                }
                function T(t, r, g) {
                ...
                (i.prototype.slice = function (t, r) {
                    var g = this.length;
                    (t = ~~t) < 0 ? (t += g) < 0 && (t = 0) : t > g && (t = g), (r = void 0 === r ? g : ~~r) < 0 ? (r += g) < 0 && (r = 0) : r > g && (r = g), r < t && (r = t);
                    ...
                    (i.prototype.writeUInt16LE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 2, 65535, 0), (this[r] = 255 & t), (this[r + 1] = t >>> 8), r + 2;
                    }),
                    (i.prototype.writeUInt16BE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 2, 65535, 0), (this[r] = t >>> 8), (this[r + 1] = 255 & t), r + 2;
                    }),
                    (i.prototype.writeUInt32LE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 4, 4294967295, 0), (this[r + 3] = t >>> 24), (this[r + 2] = t >>> 16), (this[r + 1] = t >>> 8), (this[r] = 255 & t), r + 4;
                    }),
                    (i.prototype.writeUInt32BE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 4, 4294967295, 0), (this[r] = t >>> 24), (this[r + 1] = t >>> 16), (this[r + 2] = t >>> 8), (this[r + 3] = 255 & t), r + 4;
                    }),
                    (i.prototype.writeIntLE = function (t, r, g, d) {
                        ...
                        var R = 0,
                            D = 1,
                            Y = 0;
                        for (this[r] = 255 & t; ++R < g && (D *= 256); ) t < 0 && 0 === Y && 0 !== this[r + R - 1] && (Y = 1), (this[r + R] = (((t / D) >> 0) - Y) & 255);
                        return r + g;
                    }),
                    (i.prototype.writeIntBE = function (t, r, g, d) {
                        ...
                        var R = g - 1,
                            D = 1,
                            Y = 0;
                        for (this[r + R] = 255 & t; --R >= 0 && (D *= 256); ) t < 0 && 0 === Y && 0 !== this[r + R + 1] && (Y = 1), (this[r + R] = (((t / D) >> 0) - Y) & 255);
                        return r + g;
                    }),
                    (i.prototype.writeInt8 = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 1, 127, -128), t < 0 && (t = 255 + t + 1), (this[r] = 255 & t), r + 1;
                    }),
                    (i.prototype.writeInt16LE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 2, 32767, -32768), (this[r] = 255 & t), (this[r + 1] = t >>> 8), r + 2;
                    }),
                    (i.prototype.writeInt16BE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 2, 32767, -32768), (this[r] = t >>> 8), (this[r + 1] = 255 & t), r + 2;
                    }),
                    (i.prototype.writeInt32LE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 4, 2147483647, -2147483648), (this[r] = 255 & t), (this[r + 1] = t >>> 8), (this[r + 2] = t >>> 16), (this[r + 3] = t >>> 24), r + 4;
                    }),
                    (i.prototype.writeInt32BE = function (t, r, g) {
                        return (t = +t), (r >>>= 0), g || _(this, t, r, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), (this[r] = t >>> 24), (this[r + 1] = t >>> 16), (this[r + 2] = t >>> 8), (this[r + 3] = 255 & t), r + 4;
                    }),
                    ...
                    (i.prototype.copy = function (t, r, g, d) {
                        ...
                        if ((g || (g = 0), d || 0 === d || (d = this.length), r >= t.length && (r = t.length), r || (r = 0), d > 0 && d < g && (d = g), d === g)) return 0;
                        ...
                        var U = d - g;
                        if (this === t && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(r, g, d);
                        else if (this === t && g < r && r < d) for (var R = U - 1; R >= 0; --R) t[R + r] = this[R + g];
                        else Uint8Array.prototype.set.call(t, this.subarray(g, d), r);
                        return U;
                    }),
                    (i.prototype.fill = function (t, r, g, d) {
                        if ("string" == typeof t) {
                            if (("string" == typeof r ? ((d = r), (r = 0), (g = this.length)) : "string" == typeof g && ((d = g), (g = this.length)), void 0 !== d && "string" != typeof d)) throw new TypeError("encoding must be a string");
                            if ("string" == typeof d && !i.isEncoding(d)) throw new TypeError("Unknown encoding: " + d);
                            if (1 === t.length) {
                                var U = t.charCodeAt(0);
                                (("utf8" === d && U < 128) || "latin1" === d) && (t = U);
                            }
                        } else "number" == typeof t && (t &= 255);
                        if (r < 0 || this.length < r || this.length < g) throw new RangeError("Out of range index");
                        if (g <= r) return this;
                        var R;
                        if (((r >>>= 0), (g = void 0 === g ? this.length : g >>> 0), t || (t = 0), "number" == typeof t)) for (R = r; R < g; ++R) this[R] = t;
                        else {
                            var D = i.isBuffer(t) ? t : i.from(t, d),
                                Y = D.length;
                            if (0 === Y) throw new TypeError('The value "' + t + '" is invalid for argument "value"');
                ...
                function N(t, r) {
                    ...
                    for (var d = t.length, U = null, R = [], D = 0; D < d; ++D) {
                        ...
                        if (((U = null), g < 128)) {
                            ...
                            if ((r -= 4) < 0) break;
                            R.push((g >> 18) | 240, ((g >> 12) & 63) | 128, ((g >> 6) & 63) | 128, (63 & g) | 128);
                        }
                    }
                    return R;
                }
    ...
    var V = {
            initialize: (t, g) => {
                ...
                if (void 0 !== g) {
                    if ("function" != typeof g) throw Error('@initialize : expecting "logFunction" to be a function.');
                    g(
                        `@initialize : setting buffer limit to ${((t, g) => {
                            ...
                            return (t = Number((t / Math.pow(1e3, R)).toPrecision(3))), U + e(t, g.locale) + " " + r[R];
                        })(t)}`
                    );
                }
                const d = {};
                    ...
                    switch (typeof t) {
                        case "string":
                            if ((r = $.byteLength(t)) < 32) {
                                r = 0;
                                for (let g = 0, d = 0, U = t.length; g < U; g += 1) (d = t.charCodeAt(g)) < 128 ? (r += 1) : d < 1280 ? (r += 2) : d < 55296 || d >= 57344 ? (r += 3) : ((g += 1), (r += 4));
                                D[(Y += 1)] = 160 | r;
                                for (let r = 0, g = 0, d = t.length; r < d; r += 1)
                                    (g = t.charCodeAt(r)) < 128
                                        ...
                                        : g < 55296 || g >= 57344
                                        ? ((D[(Y += 1)] = 224 | (g >> 12)), (D[(Y += 1)] = 128 | ((g >> 6) & 63)), (D[(Y += 1)] = 128 | (63 & g)))
                                        : ((r += 1),
                                          ...
                                          (D[(Y += 1)] = 128 | ((g >> 6) & 63)),
                                          (D[(Y += 1)] = 128 | (63 & g)));
                            } else if (r < 256) (D[(Y += 1)] = 217), (D[(Y += 1)] = r), D.write(t, (Y += 1), r, "utf8"), (Y += r - 1);
                            else if (r < 65536) (D[(Y += 1)] = 218), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r), D.write(t, (Y += 1), r, "utf8"), (Y += r - 1);
                            else {
                                if (!(r < 4294967296)) throw Error("@internalEncode : Max supported string length (4294967296) exceeded, encoding failure.");
                                (D[(Y += 1)] = 219), (D[(Y += 1)] = r >> 24), (D[(Y += 1)] = r >> 16), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r), D.write(t, (Y += 1), r, "utf8"), (Y += r - 1);
                            }
                            break;
                        case "number":
                            ...
                            if (t >= 0) {
                                ...
                                if (t < 4294967296) {
                                    (D[(Y += 1)] = 206), (D[(Y += 1)] = t >> 24), (D[(Y += 1)] = t >> 16), (D[(Y += 1)] = t >> 8), (D[(Y += 1)] = t);
                                    break;
                                }
                                let r = (t / Math.pow(2, 32)) >> 0,
                                    g = t >>> 0;
                                (D[(Y += 1)] = 207), (D[(Y += 1)] = r >> 24), (D[(Y += 1)] = r >> 16), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r), (D[(Y += 1)] = g >> 24), (D[(Y += 1)] = g >> 16), (D[(Y += 1)] = g >> 8), (D[(Y += 1)] = g);
                            } else {
                                if (t >= -32) {
                                    D[(Y += 1)] = t;
                                    break;
                                ...
                                if (t >= -128e6) {
                                    (D[(Y += 1)] = 210), (D[(Y += 1)] = t >> 24), (D[(Y += 1)] = t >> 16), (D[(Y += 1)] = t >> 8), (D[(Y += 1)] = t);
                                    break;
                                }
                                let r = Math.floor(t / Math.pow(2, 32)),
                                    g = t >>> 0;
                                (D[(Y += 1)] = 211), (D[(Y += 1)] = r >> 24), (D[(Y += 1)] = r >> 16), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r), (D[(Y += 1)] = g >> 24), (D[(Y += 1)] = g >> 16), (D[(Y += 1)] = g >> 8), (D[(Y += 1)] = g);
                            }
                            break;
                        case "object":
                            if (null === t) {
                            ...
                            if (!0 === Array.isArray(t)) {
                                if ((r = t.length) < 16) D[(Y += 1)] = 144 | r;
                                    ...
                                    (D[(Y += 1)] = 221), (D[(Y += 1)] = r >> 24), (D[(Y += 1)] = r >> 16), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r);
                                }
                            ...
                            if (t instanceof $) {
                                if ((r = t.length) < 256)
                                    if (((D[(Y += 1)] = 196), (D[(Y += 1)] = r), r > 32)) t.copy(D, (Y += 1), 0, r), (Y += r - 1);
                                    else for (let g = 0; g < r; g++) D[(Y += 1)] = t[g];
                                else if (r < 65536) (D[(Y += 1)] = 197), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r), t.copy(D, (Y += 1), 0, r), (Y += r - 1);
                                else {
                                    if (!(r < 4294967296)) throw Error("@internalEncode : Max supported buffer length (4294967296) exceeded, encoding failure.");
                                    (D[(Y += 1)] = 198), (D[(Y += 1)] = r >> 24), (D[(Y += 1)] = r >> 16), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r), t.copy(D, (Y += 1), 0, r), (Y += r - 1);
                                }
                                break;
                            }
                            {
                                ...
                                if ((r = g.length) < 16) D[(Y += 1)] = 128 | r;
                                    ...
                                    (D[(Y += 1)] = 223), (D[(Y += 1)] = r >> 24), (D[(Y += 1)] = r >> 16), (D[(Y += 1)] = r >> 8), (D[(Y += 1)] = r);
                                }
                ...
                const l = () => {
                    ...
                    if (q[X] < 192) {
                        ...
                        if (q[X] < 144) {
                            if (((r = 31 & q[X]), (t = {}), (X += 1), !0 === U)) for (let g, U = 0; U < r; U++) (g = l()), (t[d[g] || g] = l());
                    ...
                    switch (q[X]) {
                        ...
                        case 207:
                            return (t = q.readUInt32BE((X += 1)) * Math.pow(2, 32) + q.readUInt32BE((X += 4))), (X += 4), t;
                        case 208:
                        ...
                        case 211:
                            return (t = q.readInt32BE((X += 1)) * Math.pow(2, 32) + q.readUInt32BE((X += 4))), (X += 4), t;
                        case 217:
                            return (r = q.readUInt8((X += 1))), (X += 1), (t = q.toString("utf8", X, X + r)), (X += r), t;
                        case 218:
                            return (r = q.readUInt16BE((X += 1))), (X += 2), (t = q.toString("utf8", X, X + r)), (X += r), t;
                        case 219:
                            return (r = q.readUInt32BE((X += 1))), (X += 4), (t = q.toString("utf8", X, X + r)), (X += r), t;
                        case 212:
                        ...
                        case 221:
                            ...
                            return t;
                        case 222:
                            if (((r = q.readUInt16BE((X += 1))), (t = {}), (X += 2), !0 === U)) for (let g, U = 0; U < r; U++) (g = l()), (t[d[g] || g] = l());
                            else for (let g = 0; g < r; g++) t[l()] = l();
                            return t;
                        case 223:
                            if (((r = q.readUInt32BE((X += 1))), (t = {}), (X += 4), !0 === U)) for (let g, U = 0; U < r; U++) (g = l()), (t[d[g] || g] = l());
                            else for (let g = 0; g < r; g++) t[l()] = l();
                            return t;
                        case 196:
        ...
        W = V.initialize,
        Z = V.Buffer;
    (t.default = V), (t.initialize = W), (t.Buffer = Z), Object.defineProperty(t, "__esModule", { value: !0 });
});
var Player = pc.createScript("player");
Player.attributes.add("playerId", { type: "number", default: -1 }),
    Player.attributes.add("username", { type: "string", default: "none" }),
    Player.attributes.add("team", { type: "string", default: "none" }),
    Player.attributes.add("characterName", { type: "string", default: "Lilium" }),
    Player.attributes.add("characterHolder", { type: "entity" }),
    Player.attributes.add("characterEntity", { type: "entity" }),
    Player.attributes.add("gliderEntity", { type: "entity" }),
    Player.attributes.add("characterCamera", { type: "entity" }),
    Player.attributes.add("characterCameraHolder", { type: "entity" }),
    Player.attributes.add("characterArmLeft", { type: "entity" }),
    Player.attributes.add("characterArmRight", { type: "entity" }),
    Player.attributes.add("sex", { type: "string", default: "Female" }),
    Player.attributes.add("lowExposure", { type: "number", default: 4 }),
    Player.attributes.add("weapons", { type: "string", array: !0 }),
    Player.attributes.add("danceName", { type: "string", default: "Techno" }),
    (Player.prototype.initialize = function () {
        (this.currentDate = Date.now()),
            ...
            (this.animation = { lookX: 0, cameraShake: !1, cameraFov: !1 }),
            (this.timers = { camera: !1, gliderMessage: !1 }),
            (this.past = {}),
            (this.health = 100),
            (this.cards = []),
            (this.killedBy = !1),
    ...
    (Player.prototype.onSpeedUp = function () {
        (this.animation.cameraFov = this.app.tween(this.movement.animation).to({ fov: 10 }, 0.5, pc.SineIn)),
            (this.animation.cameraShake = this.app.tween(pc.controls.animation).to({ cameraBounce: 1 }, 0.04, pc.Linear).yoyo(!0).repeat(10)),
    ...
    (Player.prototype.onCharacterSkinSet = function (t) {
        (this.skinName = this.characterName + "-" + t + ".jpg"), this.checkLoadedSkins();
    }),
    (Player.prototype.checkLoadedSkins = function () {
        if (2 != this.armsLoaded) return !1;
        var t = this.skinName;
        if (t && this.characterEntity) {
            ...
            this.getSkinFromURL(t, function (t) {
                ...
                this.characterArmLeft.fire("CustomSkin:Set", { skin: t }),
                this.characterArmRight.fire("CustomSkin:Set", { skin: t });
        }
    }),
    ...
    (Player.prototype.onFinish = function () {
        this.movement.disableMovement(), (this.isCardSelection = !1), (this.canBuy = !1), (this.isMapLoaded = !1);
    }),
    (Player.prototype.onUnlock = function () {
        this.canBuy = !0;
    }),
    (Player.prototype.onPointerLock = function (t) {
        !1 === t ? (this.app.fire("Overlay:Pause", !0), this.app.mouse.disablePointerLock()) : (this.app.fire("Overlay:Pause", !1), this.app.mouse.enablePointerLock());
    }),
    (Player.prototype.onLeave = function () {
        this.app.mouse.disablePointerLock(), Utils.isMobile() ? (window.location.href = "https://venge.io/?isMobile=yes&v=" + Math.random()) : (window.location.href = "https://venge.io");
    }),
    (Player.prototype.onBuyStart = function () {
        this.buyAbility();
    }),
    (Player.prototype.onBuyCard1 = function () {
        this.app.fire("Overlay:SetAbility", 0), this.app.fire("Network:Card", 1), (this.isCardSelection = !1);
    }),
    (Player.prototype.onBuyCard2 = function () {
        this.app.fire("Overlay:SetAbility", 1), this.app.fire("Network:Card", 2), (this.isCardSelection = !1);
    }),
    (Player.prototype.onBuyCard3 = function () {
        this.app.fire("Overlay:SetAbility", 2), this.app.fire("Network:Card", 3), (this.isCardSelection = !1);
    }),
    ...
    (Player.prototype.onTouchWeapon = function (t) {
        ...
        var e = t + "";
        "1" === e && this.setWeapon(this.weapons[0]), "2" === e && this.setWeapon(this.weapons[1]), "3" === e && this.setWeapon(this.weapons[2]), "4" === e && this.setWeapon(this.weapons[3]);
    }),
    (Player.prototype.setWeaponIndex = function (t) {
        "Next" == t ? this.weaponIndex++ : this.weaponIndex--, this.weaponIndex > 3 && (this.weaponIndex = 0), this.weaponIndex < 0 && (this.weaponIndex = this.weapons.length - 1), this.setWeapon(this.weapons[this.weaponIndex]);
    }),
    (Player.prototype._onCards = function () {
        this.entity.rigidbody.teleport(0, -50, 0, 0, 0, 0),
            ...
            this.characterCameraHolder.tween(this.characterCameraHolder.getLocalScale()).to({ x: 0.5, y: 0.5, z: 0.5 }, 1.5, pc.SineOut).start(),
            this.characterCameraHolder.tween(this.characterCameraHolder.getLocalEulerAngles()).rotate({ x: -165, y: 0, z: 180 }, 2, pc.SineOut).start(),
            setTimeout(
                function (t) {
    ...
    (Player.prototype.afterAbilitySet = function () {
        this.movement.enableMovement(), this.characterCameraHolder.setLocalScale(1, 1, 1), this.characterCameraHolder.setLocalEulerAngles(0, 0, 0), (this.characterHolder.enabled = !1), (this.movement.lookEntity.enabled = !0);
    }),
    (Player.prototype.setWhiteShadow = function (t) {
        t
            ? ((this.animation.cameraFov = this.app.tween(this.movement.animation).to({ fov: 20 }, 1, pc.SineIn)),
              (this.animation.cameraShake = this.app.tween(pc.controls.animation).to({ cameraBounce: 0.8 }, 0.04, pc.Linear).yoyo(!0).repeat(10)),
              this.animation.cameraShake.start(),
              this.animation.cameraFov.start())
            : (this.animation.cameraShake && this.animation.cameraShake.stop(), this.animation.cameraFov && this.animation.cameraFov.stop());
    }),
    (Player.prototype.onKill = function (t, e) {
        this.emoteReminder ||
            "Suicide" == e ||
            "FirstBlood" == e ||
            (Math.random() > 0.5 ? this.app.fire("Overlay:Reminder", "Press [" + keyboardMap[pc.KEY_H] + "] to emote!") : this.app.fire("Overlay:Reminder", "Press [" + keyboardMap[pc.KEY_V] + "] to spray!"), (this.emoteReminder = !0)),
    ...
    (Player.prototype.spray = function () {
        var t = this.movement.raycastShootFrom,
            ...
            a = 1e3;
        if (i)
            if (((a = i.point.clone().sub(t).length()), (tags = i.entity.tags.list()), a < 10 && (tags.indexOf("Brick") > -1 || tags.indexOf("Rock") > -1 || "Ground" == i.entity.name))) {
                if ("Ground" != i.entity.name) {
                    var s = i.entity.getPosition(),
                        o = i.entity.collision.halfExtents;
                    (e.x = Math.min(e.x, s.x + o.x)), (e.y = Math.min(e.y, s.y + o.y)), (e.z = Math.min(e.z, s.z + o.z));
                }
                this.app.fire("Network:Spray", t, e);
            } else this.entity.sound.play("Error");
    }),
    (Player.prototype.throw = function () {
        Math.random() > 0.2 ? this.app.fire("Player:Speak", "Throw", 2) : Math.random() > 0.2 && this.movement.playEffortSound();
    }),
    ...
    (Player.prototype.glide = function () {
        return (
            ...
            this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({ x: 0, y: 4.015, z: 8 }, 1, pc.SineOut).start(),
            this.characterCamera.setLocalEulerAngles(0, 0, 0),
            this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({ x: -18, y: 0, z: 0 }, 0.7, pc.BackOut).start(),
    ...
    (Player.prototype.flowJump = function () {
        this.isGliding &&
            (Date.now() - this.lastFlowJump > 1e3 && (this.entity.rigidbody.applyImpulse(0, this.movement.bounceJumpForce, 0), this.entity.sound.play("Flow-Jump"), this.fireNetworkEvent("flowJump", !0)), (this.lastFlowJump = Date.now()));
    }),
    ...
    (Player.prototype.emote = function () {
        ...
        (this.isEmotePlaying = !0),
            ...
            (this.characterCamera.script.blackWhite.enabled = !1),
            this.characterCamera.setLocalPosition(0, 1.215, -0.115),
            this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({ x: 0, y: 3.015, z: 7 }, 1, pc.SineOut).start(),
            this.characterCamera.setLocalEulerAngles(0, 0, 0),
            this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({ x: -18, y: 0, z: 0 }, 0.7, pc.BackOut).start(),
    ...
    (Player.prototype.finishEmote = function () {
        ...
        this.isDeath ||
            ...
            setTimeout(
                function (t) {
                    (t.allowEmoteCancelation = !1), (t.emoteTimeout = !1), (t.isEmotePlaying = !1), t.movement.enableMovement();
                },
                400,
                this
            ));
        ...
        if (
            ...
            "Drown" == e
                ? (this.characterEntity.animation.play("Floating"),
                  ...
                  this.characterEntity.tween(this.characterEntity.getLocalPosition()).to({ x: 0, y: -6.5, z: 0 }, 2, pc.Linear).start())
                : (this.characterEntity.animation.play("Death"), (this.characterEntity.animation.loop = !1)),
            ...
            this.app.fire("Overlay:Status", 'Following [color="#FF0000"]' + i + "[/color]"), this.app.fire("CustomText:KillMessage", this.killedBy.script.enemy.killMessage);
        }
    ...
    (Player.prototype.onCameraReturn = function (t) {
        ...
        this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({ x: 0, y: 1.19, z: 0 }, 0.4, pc.SineOut).start(),
            this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.4, pc.BackOut).start(),
            (this.timers.camera = setTimeout(
                function (t) {
                    (t.characterHolder.enabled = !1), (t.movement.lookEntity.enabled = !0), t.movement.takeout();
                },
                400,
                this
            ));
    ...
    (Player.prototype.getSpawnPoint = function () {
        ...
        for (var i in e) {
            ...
            (a = this.entity.getPosition().clone().sub(o).length()),
                ("TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode) || pc.currentTeam != s.name || t.push({ score: a, point: o, angle: n }),
                "TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode && t.push({ score: a, point: o, angle: n });
        }
        return (
            t.sort(function (t, e) {
    ...
    (Player.prototype.onRespawn = function (t) {
        ...
        (this.isDeath = !1),
            ...
            this.movement.currentWeapon.entity.name != this.lastWeapon
                ? ("Shotgun" == this.movement.currentWeapon.entity.name ? this.app.fire("Player:Speak", "Shotgun", 1) : this.app.fire("Player:Speak", "Weapon-Selection", 2), (this.lastWeapon = this.movement.currentWeapon.entity.name + ""))
        ...
        Math.random(), Math.random();
        if (e) {
            0 === e.x && 0 === e.y && 0 === e.z && (e = this.getSpawnPoint()), e || (e = new pc.Vec3(0, 0, 0)), e.add || (e = new pc.Vec3(0, 0, 0));
            var i = e,
                a = t.rotation;
            (this.entity.rigidbody.linearVelocity = new pc.Vec3(0, 0, 0)), this.entity.rigidbody.teleport(i.x, i.y, i.z, 0, 0, 0), a && (180 == a.x && 180 == a.z ? (this.movement.lookX = 90 - a.y) : (this.movement.lookX = a.y + 45));
        }
    ...
    (Player.prototype.setPosition = function () {
        ...
        this.app.fire("EffectManager:SetEntityPosition", t), this.app.fire("Network:Position", t.x, t.y, t.z, e, i), (this.lastPositionUpdate = this.currentDate);
    }),
    (Player.prototype.checkShooting = function () {
        var t = !1;
        this.movement.isReloading < this.movement.timestamp && this.movement.leftMouse && (t = !0), this.currentShootingState !== t && this.app.fire("Network:State", "f", t), (this.currentShootingState = t);
    }),
    ...
    (Player.prototype.setBackRaycast = function () {
        var t = this.characterCamera.forward.scale(-100),
            ...
            s = 1e3;
        a && (s = a.entity.getPosition().clone().sub(e).length()), (this.characterCameraScale = Math.min(1, s / 10)), this.characterCameraHolder.setLocalScale(this.characterCameraScale, this.characterCameraScale, this.characterCameraScale);
    }),
    ...
    (Player.prototype.setKeyboard = function () {
        return (
            ...
            (this.isCardSelection && (this.app.keyboard.wasPressed(pc.KEY_1) && this.onBuyCard1(), this.app.keyboard.wasPressed(pc.KEY_2) && this.onBuyCard2(), this.app.keyboard.wasPressed(pc.KEY_3) && this.onBuyCard3()),
    ...
    (Player.prototype.setWeapon = function (t) {
        ...
        if (Date.now() - this.lastWeaponChange > 2e3 || this.isDeath) {
            ...
            this.movement.disableZoom(), this.weaponManager.setWeapon(t), (this.weaponIndex = this.weapons.indexOf(t)), (this.lastWeapon = t), (this.lastWeaponChange = Date.now());
        } else this.app.fire("Chat:Message", "Console", "Please wait 2 seconds to change weapon."), (this.weaponIndex = this.weapons.indexOf(this.lastWeapon));
    }),
    ...
    (Player.prototype.update = function (t) {
        (this.currentDate = Date.now()), this.setPosition(), this.setStates(), this.setKeyboard(), this.isEmotePlaying && this.updateEmotePlaying(), this.isGliding && this.updateGliding(), this.isDeath && this.setDeathAnimation();
    });
var Enemy = pc.createScript("enemy");
Enemy.attributes.add("playerId", { type: "string", default: "0" }),
    Enemy.attributes.add("username", { type: "string", default: "none" }),
    Enemy.attributes.add("team", { type: "string", default: "none" }),
    Enemy.attributes.add("weapon", { type: "string", default: "Scar" }),
    Enemy.attributes.add("characterEntity", { type: "entity" }),
    Enemy.attributes.add("modelHolder", { type: "entity" }),
    Enemy.attributes.add("skins", { type: "entity", array: !0 }),
    Enemy.attributes.add("headEntity", { type: "entity" }),
    Enemy.attributes.add("bodyEntity", { type: "entity" }),
    Enemy.attributes.add("weaponHolder", { type: "entity" }),
    Enemy.attributes.add("muzzlePoint", { type: "entity" }),
    Enemy.attributes.add("farPoint", { type: "entity" }),
    Enemy.attributes.add("meleePoint", { type: "entity" }),
    Enemy.attributes.add("meleeEntity", { type: "entity" }),
    Enemy.attributes.add("gliderEntity", { type: "entity" }),
    Enemy.attributes.add("dashEntity", { type: "entity" }),
    Enemy.attributes.add("hammerEntity", { type: "entity" }),
    Enemy.attributes.add("katanaEntity", { type: "entity" }),
    Enemy.attributes.add("healthRegenEntity", { type: "entity" }),
    ...
    (Enemy.prototype.setUsername = function (t, i, e) {
        (this.entity.script.label.enabled = !0),
            ...
            this.isActivated ? this.entity.script.label.setDestroy() : this.entity.script.label.setUsername(t, i, e);
    }),
    ...
    (Enemy.prototype.setWeapon = function (t) {
        ...
        if (!this.app.root.findByName(t)) return !1;
        (this.currentWeapon = this.app.root.findByName(t).script.weapon), (this.currentWeapon.name = this.currentWeapon.entity.name);
        var i = this.entity.findByTag("Weapon");
        for (var e in i) {
            i[e].enabled = !1;
        }
        var n = this.entity.findByName(t + "-Enemy");
        if (n && ((n.enabled = !0), (this.weaponEntity = n), this.weaponSkins && void 0 !== this.weaponSkins[t])) {
            var s = this.weaponSkins[t];
            s && this.setWeaponSkin(s);
        }
    }),
    ...
    (Enemy.prototype.setCharacterSkin = function (t, i, e) {
        if (this.isActivated) return (this.entity.collision.height = 4), (this.modelHolder.enabled = !1), (this.bodyEntity.enabled = !1), !1;
        this.entity.addComponent("rigidbody"), (this.entity.rigidbody.type = pc.BODYTYPE_KINEMATIC), (this.entity.rigidbody.enabled = !0), void 0 !== t && ((this.skin = t), (this.isSkinSet = !0));
        var n = this;
        for (var s in this.skins) {
            var a = this.skins[s];
            this.skin == a.name ? ((a.enabled = !0), (this.characterEntity = a)) : (a.enabled = !1);
        }
        "Lilium" == this.skin ? ((this.hammerEntity.enabled = !0), (this.katanaEntity.enabled = !1)) : "Shin" == this.skin && ((this.hammerEntity.enabled = !1), (this.katanaEntity.enabled = !0)),
    ...
    (Enemy.prototype.setDanceAnimation = function (t, i) {
        ...
        if (e) {
            if ((this.app.assets.load(e), this.characterEntity.animation)) {
                var s = this.characterEntity.animation.assets;
                s.push(e.id), (this.characterEntity.animation.assets = s), (this.entity.sound.slots.Emote.asset = n.id);
            }
            this.danceName = t + "-" + i;
        }
    }),
    ...
    (Enemy.prototype.setAnimation = function (t, i, e) {
        this.currentAnimation != t && this.characterEntity && this.characterEntity.animation && ((this.characterEntity.animation.loop = !!e), this.characterEntity.animation.play(t, i), (this.currentAnimation = t));
    }),
    (Enemy.prototype.applyAbilityAffect = function (t) {
        this.entity.sound.play(t), (this.lastDamage = Date.now()), this.entity.script.label.setAbility(t);
    }),
    ...
    (Enemy.prototype.cancelGliding = function () {
        return !!this.isGliding && !!this.isLanded && ((this.isGliding = !1), (this.gliderEntity.enabled = !1), this.entity.sound.play("Parachute-Close"), void this.entity.sound.stop("Heavy-Wind"));
    }),
    (Enemy.prototype.flowJump = function () {
        this.isGliding && this.entity.sound.play("Flow-Jump");
    }),
    (Enemy.prototype.left = function () {
        clearTimeout(this.timeout.respawn), clearTimeout(this.timeout.death), clearTimeout(this.timeout.jump), clearTimeout(this.timeout.reload), this.entity.script.label.destroy(), this.entity.destroy();
    }),
    ...
    (Enemy.prototype.death = function (t) {
        (this.isDeath = !0),
            ...
            this.disableDamage(),
            "Drown" == t
                ? (this.entity.sound.play("Splash"), (this.characterEntity.animation.speed = 4), this.characterEntity.setLocalPosition(0, -3.5, 0), this.setAnimation("Floating", 0.1, !0))
                : ((this.characterEntity.animation.speed = 1),
        ...
        n &&
            ...
            this.app
                ...
                .to({ x: n.point.x, y: n.point.y + 2.05, z: n.point.z }, 0.8, pc.BackOut)
                .start(),
    ...
    (Enemy.prototype.teleport = function () {
        (this.currentPosition = this.nextPosition.clone()), this.entity.setPosition(this.currentPosition);
    }),
    ...
    (Enemy.prototype.respawn = function (t) {
        ...
        var i = Math.round(1 * Math.random()) + 1,
            e = this.skin + "-Talk-" + i;
        Date.now() - this.lastRespawnTalk > 5e3 && (this.characterEntity.fire("Frensel:ResetBurn", !0), this.entity.sound.play("Respawn"), Math.random() > 0.5 && (this.entity.sound.play(e), (this.lastRespawnTalk = Date.now()))),
    ...
    (Enemy.prototype.dealSpell = function (t) {
        "Shuriken" == t && this.app.fire("Network:DealSpell", this.playerId), "Axe" == t && this.app.fire("Network:DealSpell", this.playerId);
    }),
    (Enemy.prototype.damage = function (t, i, e) {
        ...
        if (
            ...
            ("TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode) || (pc.currentTeam == this.team && ((h = !1), this.app.fire("Overlay:FriendlyFire", !0))),
                h && (this.app.fire("Hit:Point", this.entity, Math.floor(20 * Math.random()) + 5), this.entity.sound.play(a), n && this.app.fire("Hit:Headshot", this.entity, Math.floor(20 * Math.random()) + 5)),
                (this.lastDamage = Date.now()),
    ...
    (Enemy.prototype.setTeam = function (t) {
        (this.team = t), this.entity.script.label.setTeam(t);
    }),
    (Enemy.prototype.setHealth = function (t) {
        t > this.health && this.setHealthRegen(), (this.health = t), this.entity.script.label.setHealth(this.health);
    }),
    (Enemy.prototype.shoot = function () {
        ...
        this.entity.sound.slots[o] && ((this.entity.sound.slots[o].pitch = 1 - 0.1 * Math.random()), this.entity.sound.play(o)),
            "Melee" != this.currentWeapon.type && "Launcher" != this.currentWeapon.type && this.app.fire("EffectManager:Fire", t, a, t, h),
            this.showCharacter(),
            (this.isShootingLocked = !0);
    }),
    ...
    (Enemy.prototype.reload = function () {
        this.timeout.reload = setTimeout(
            function (t) {
                t && t.entity && t.entity.sound && t.entity.sound.play && t.entity.sound.play(t.currentWeapon.entity.name + "-Reload");
            },
            1200,
            this
        );
    ...
    (Enemy.prototype.jump = function () {
        ...
        this.cancelGliding(), (this.isJumping = !0), (this.isLanded = !1), (this.characterEntity.animation.speed = 1), this.setAnimation("Jump-" + t, 0.1, !1);
    ...
    (Enemy.prototype.melee = function () {
        ...
        this.entity.sound.play(i),
            ...
            this.meleeEntity.tween(this.meleeEntity.getLocalEulerAngles()).rotate({ x: 130.23, y: -78.41, z: -149.33 }, 0.3, pc.BackOut).start();
    ...
    (Enemy.prototype.bounceJump = function () {
        var t = Math.round(1 * Math.random()) + 1;
        (this.isJumping = !0), (this.characterEntity.animation.speed = 1), this.setAnimation("Jump-" + t, 0.1, !1);
    ...
    (Enemy.prototype.setDirection = function () {
        if (this.isDeath || this.isJumping || this.isEmotePlaying || this.isDashing || this.isGliding || this.isGrappling) return !1;
        var t = "none";
        if (
            ...
            "none" != this.lastDirection && this.setAnimation(this.lastDirection, 0.1, !0),
                (this.characterEntity.animation.speed = pc.math.lerp(this.characterEntity.animation.speed, i, 0.3)),
    ...
    (Enemy.prototype.setPosition = function (t, i, e, n, s) {
        if (this.isDeath) return !1;
        (this.nextPosition.x = t), (this.nextPosition.y = i), (this.nextPosition.z = e), (this.nextAngle.x = s * pc.math.DEG_TO_RAD), (this.nextAngle.y = n * pc.math.DEG_TO_RAD - 90), this.isActivated && this.entity.setPosition(t, i, e);
        var a = Date.now() - this.lastDeltaDate;
        (a = a < 40 ? 0.3 : a < 200 ? 0.03 : a < 600 ? 0.01 : 0.4), this.app.fire("EffectManager:SetEntityPosition", this.nextPosition), (this.lastDeltaDate = Date.now()), (this.delta = pc.math.lerp(this.delta, a, 0.05));
    }),
    ...
    (Enemy.prototype.update = function (t) {
        ...
        var i = this.lastDelta;
        i > pc.dt - 0.001 && (this.setDirection(), this.updateShooting(), (this.timestamp += i), (this.lastDelta = 0));
    });
var MapManager = pc.createScript("mapManager");
MapManager.attributes.add("defaultMap", { type: "string" }),
    MapManager.attributes.add("mapHolder", { type: "entity" }),
    MapManager.attributes.add("autoLoad", { type: "boolean", default: !1 }),
    ...
    (MapManager.prototype.loadMap = function (a) {
        var t = this;
        this.app.scenes.find(a)
            ? this.clearHolder(function () {
                  t.setMap(a);
              })
            : (console.log("[DEBUG] This map is a custom map, loading from CDN"), this.app.fire("Fetcher:MapManager", { name: a }), (pc.currentModeOptions = { noWeaponChange: !0 }), (this.isLoaded = !0), this._onMapLoad());
    }),
    (MapManager.prototype.setMap = function (a) {
        ...
        var t = this,
            ...
            o = "1.0.0";
        "undefined" != typeof VERSION && (o = VERSION), (this.isLoading = Date.now()), (pc.isMapLoaded = !1);
        var n = this.app.root.findByName("Map");
        n && n.sound && (n.sound.stop("Ambient"), n.sound.stop("Rain")),
            e &&
                e.url &&
                (this.app.scenes.loadSceneHierarchy(e.url + "?v=" + o, function (a, n) {
                    n &&
                        (t.mapHolder.reparent(n),
    ...
    (MapManager.prototype.onMapLoad = function () {
        ...
        if (t.length > 0) {
            var e = 0;
            for (var o in t) {
                var n = t[o].collision.asset;
                this.app.assets.get(n).ready(function () {
    ...
    (MapManager.prototype.onSettingsChange = function () {
        ...
        a && (!0 === pc.settings.disableShadows ? (a.light.castShadows = !1) : (a.light.castShadows = !0));
    }),
    (MapManager.prototype.thunder = function () {
        if (Utils.isMobile()) return !1;
        var a = this.app.scene.exposure + 1e-4;
        (this.app.scene.exposure = a + 15), this.app.tween(this.app.scene).to({ exposure: a }, 0.1, pc.Linear).delay(0.15).start(), (this.entity.sound.slots.Thunder.pitch = 1 + 0.2 * Math.random()), this.entity.sound.play("Thunder");
    }),
    ...
    (MapManager.prototype.clearHolder = function (a) {
        ...
        t &&
            (t.on("destroy", function () {
                console.log("Destroy properly completed!"), a();
            }),
            t.destroy()),
            this.app.fire("MapLoader:Clear", !0);
    });
var PhysicsManager = pc.createScript("physicsManager");
PhysicsManager.attributes.add("mapHolder", { type: "entity" }), PhysicsManager.attributes.add("playerEntity", { type: "entity" }), (PhysicsManager.prototype.initialize = function () {});
var Menu = pc.createScript("menu");
Menu.attributes.add("cameraEntity", { type: "entity" }),
    Menu.attributes.add("originEntity", { type: "entity" }),
    Menu.attributes.add("linkEntity", { type: "entity" }),
    Menu.attributes.add("header", { type: "entity" }),
    Menu.attributes.add("contentHolder", { type: "entity" }),
    Menu.attributes.add("shopIconEntity", { type: "entity" }),
    Menu.attributes.add("characterEntity", { type: "entity" }),
    Menu.attributes.add("characterHolder", { type: "entity" }),
    Menu.attributes.add("lightRoomEntity", { type: "entity" }),
    Menu.attributes.add("menuColor", { type: "rgb" }),
    Menu.attributes.add("sideEntity", { type: "entity" }),
    Menu.attributes.add("weaponName", { type: "entity" }),
    Menu.attributes.add("weaponEntity", { type: "entity" }),
    Menu.attributes.add("weaponIcon", { type: "entity" }),
    Menu.attributes.add("matchFoundBackground", { type: "entity" }),
    Menu.attributes.add("matchFoundText", { type: "entity" }),
    Menu.attributes.add("matchFoundRectangle", { type: "entity" }),
    Menu.attributes.add("matchFoundCenter", { type: "entity" }),
    Menu.attributes.add("matchFoundLoading", { type: "entity" }),
    Menu.attributes.add("characterIcon", { type: "entity" }),
    Menu.attributes.add("characterName", { type: "entity" }),
    Menu.attributes.add("meleeIcon", { type: "entity" }),
    Menu.attributes.add("throwIcon", { type: "entity" }),
    Menu.attributes.add("streamEntity", { type: "entity" }),
    Menu.attributes.add("streamEntityContainer", { type: "entity" }),
    Menu.attributes.add("twitchName", { type: "entity" }),
    Menu.attributes.add("twitchButton", { type: "entity" }),
    Menu.attributes.add("twitchProfilePicture", { type: "entity" }),
    Menu.attributes.add("youtubeName", { type: "entity" }),
    Menu.attributes.add("youtubeButton", { type: "entity" }),
    Menu.attributes.add("youtubeShopName", { type: "entity" }),
    Menu.attributes.add("youtubeShopButton", { type: "entity" }),
    Menu.attributes.add("miniProfileEntity", { type: "entity" }),
    Menu.attributes.add("versionEntity", { type: "entity" }),
    Menu.attributes.add("updateEntity", { type: "entity" }),
    Menu.attributes.add("updateVersionEntity", { type: "entity" }),
    Menu.attributes.add("streamerImage", { type: "entity" }),
    Menu.attributes.add("offerPopup", { type: "entity" }),
    Menu.attributes.add("boostPopup", { type: "entity" }),
    Menu.attributes.add("mobileWaiting", { type: "entity" }),
    Menu.attributes.add("mobileFreeCoin", { type: "entity" }),
    Menu.attributes.add("mobileRedirection", { type: "entity" }),
    Menu.attributes.add("mobileUsernameChange", { type: "entity" }),
    (Menu.prototype.initialize = function () {
        if (
            ...
            (this.isMatchFound = !1),
            (this.isConnected = !1),
            (pc.session = { weapon: "Scar", character: "Lilium", hash: !1, username: !1 }),
            ...
            Utils.isMobile() && (this.mobileFreeCoin.setLocalScale(1.2, 1.2, 1.2), this.sideEntity.setLocalScale(1.331, 1.331, 1.331)),
            pc.isMobile)
        ) {
            ...
            this.app.root.findByPath("MenuHolder/Menu/Content/Shop").script.tab.menu.splice(2, 1), this.app.root.findByPath("MenuHolder/Menu/Content/Shop").script.tab.page.splice(2, 1), (this.offerAccepted = !1);
    ...
    (Menu.prototype.applyCreatorCode = function (t) {
        this.app.fire("Fetcher:CreatorCode", { creator_code: t }),
            setTimeout(
                function (t) {
    ...
    (Menu.prototype.setLeftEarlyNotification = function () {
        "Left" === Utils.getItem("LeftEarly") && Math.random() > 0.5 && this.app.fire("Alert:Menu", "Leaving matches early will affect your scores."), Utils.setItem("LeftEarly", "Clear");
    }),
    (Menu.prototype.setShopNotification = function () {
        var t = !1;
        Utils.getItem("LastVersion") != VERSION_CODE && ((t = !0), Utils.setItem("LastVersion", VERSION_CODE)), this.app.fire("ConditionPositioning:Shop", { new_items: t });
    }),
    ...
    (Menu.prototype.onMobileBuyState = function (t) {
        this.offerAccepted &&
            ("error" == t
                ...
                : ("successful" == t || "restored" == t) && (this.app.fire("Fetcher:MobilePayment", { token: "mobile-process", sku: "10000VG" }), this.onOfferClose(), Utils.setItem("MobileAds", "NoAds")));
    }),
    ...
    (Menu.prototype.onBoostGet = function () {
        this.app.fire(
            "Ads:RewardAds",
            function () {
                pc.app.fire("Alert:Menu", "Boost activated for your game session!"), (pc.app.systems.sound.volume = 0.25);
            },
            function () {
                pc.app.fire("Alert:Menu", "Please disable adblock to enable rewards!"), (pc.app.systems.sound.volume = 0.25);
            }
        );
    }),
    ...
    (Menu.prototype.onAccountReward = function () {
        this.app.fire("Ads:BannerDestroy", "venge-io_728x90", "728x90"),
            ...
            this.app.fire(
                "Ads:RewardAds",
                function () {
                    pc.app.fire("Ads:BannerSet", "venge-io_728x90", "728x90"), pc.app.fire("Fetcher:Reward", !0), (pc.app.systems.sound.volume = 0.25);
                },
                function () {
                    pc.app.fire("Ads:BannerSet", "venge-io_728x90", "728x90"), pc.app.fire("Alert:Menu", "Please disable adblock to enable rewards!"), (pc.app.systems.sound.volume = 0.25);
                }
            ),
    ...
    (Menu.prototype.createMobileUser = function (t) {
        ...
        !Utils.isMobile() || (e && "undefined" != e) || (this.app.fire("Fetcher:MobileAccount", { username: "mobile_" + t, password: "pass_" + t }), (this.mobileWaiting.enabled = !0), (this.mobileUUID = t));
    }),
    (Menu.prototype.triggerChangeUsername = function () {
        var t = prompt("Enter new username", "");
        null !== t && this.app.fire("Fetcher:MobileUsername", { username: t });
    }),
    ...
    (Menu.prototype.setMobileElements = function () {
        if (Utils.isMobile()) {
            ...
            this.contentHolder.setLocalPosition(0, -90, 0), this.contentHolder.setLocalScale(1.2, 1.2, 1.2);
        }
    }),
    ...
    (Menu.prototype.attachCharacterEntity = function () {
        ...
        "Lilium" == pc.session.character ? (t = "Character1_RightHand") : "Shin" == pc.session.character ? (t = "Hand_R") : "Echo" == pc.session.character ? (t = "hand_r") : "Kulu" == pc.session.character && (t = "Weapon_Rig");
        var e = this.characterEntity.model.asset,
            i = this.app.assets.get(e),
            n = this;
        i.ready(function () {
            var e = n.characterEntity.findByName(t);
            e && ((n.weaponEntity = n.characterEntity.findByName("Weapon")), n.weaponEntity.setLocalScale(100, 100, 100), n.weaponEntity.reparent(e));
        }),
            this.app.fire("Player:Weapon", pc.session.weapon);
    }),
    (Menu.prototype.onPageChange = function (t) {
        "Shop" == t ? (this.app.fire("Show:Character", "Hide"), (this.lightRoomEntity.enabled = !0)) : (this.app.fire("CustomColor:Background", { color: this.menuColor }), (this.lightRoomEntity.enabled = !1)),
            ...
            this.app.fire("ConditionPositioning:Menu", { page: t });
    }),
    ...
    (Menu.prototype.resetKeyboardTable = function () {
        var t = ["W", "S", "A", "D", "SPACE", "R", "E", "F", "B", "H", "ENTER", "X", "V"];
        for (var e in t) {
            var i = t[e];
            pc["KEY_" + i] = keyboardMap.indexOf(i);
        }
        this.setKeyboardTable();
    }),
    (Menu.prototype.setKeyboardTable = function (t) {
        var e = [
            { key: keyboardMap[pc.KEY_W], default_key: "W", function: "Forward", waiting: "" },
            { key: keyboardMap[pc.KEY_S], default_key: "S", function: "Backward", waiting: "" },
            { key: keyboardMap[pc.KEY_A], default_key: "A", function: "Left", waiting: "" },
            { key: keyboardMap[pc.KEY_D], default_key: "D", function: "Right", waiting: "" },
            { key: keyboardMap[pc.KEY_SPACE], default_key: "SPACE", function: "Jump", waiting: "" },
            { key: keyboardMap[pc.KEY_R], default_key: "R", function: "Reload", waiting: "" },
            { key: keyboardMap[pc.KEY_E], default_key: "E", function: "Melee", waiting: "" },
            { key: keyboardMap[pc.KEY_F], default_key: "F", function: "Throw", waiting: "" },
            { key: keyboardMap[pc.KEY_B], default_key: "B", function: "Buy", waiting: "" },
            { key: keyboardMap[pc.KEY_SHIFT], default_key: "SHIFT", function: "Focus", waiting: "" },
            { key: keyboardMap[pc.KEY_H], default_key: "H", function: "Dance", waiting: "" },
            { key: keyboardMap[pc.KEY_ENTER], default_key: "ENTER", function: "Chat", waiting: "" },
            { key: keyboardMap[pc.KEY_X], default_key: "X", function: "Fire (Shoot)", waiting: "" },
            { key: keyboardMap[pc.KEY_V], default_key: "V", function: "Spray", waiting: "" },
        ];
        if (t) {
            for (var i in e) {
                e[i].default_key == t.default_key && (e[i].waiting = "Waiting for prompt...");
            }
            (this.currentKey = t.default_key), this.app.keyboard.once("keydown", this.defineKey, this);
        }
        var n = Utils.getItem("KeyConfiguration");
        if (n)
            for (var o in (n = JSON.parse(n))) {
                var a = n[o];
                for (var s in e) {
                    e[s].default_key == o && (e[s].key = keyboardMap[a]);
                }
            }
        this.app.fire("Table:Keys", { result: e });
    }),
    (Menu.prototype.setKey = function (t) {
        this.setKeyboardTable(t);
    }),
    (Menu.prototype.defineKey = function (t) {
        t.key;
        var e = Utils.getItem("KeyConfiguration");
        (e = e ? JSON.parse(e) : {}), this.currentKey && (e[this.currentKey] = t.key), Utils.setItem("KeyConfiguration", JSON.stringify(e)), this.setKeyboardTable(), this.app.fire("Menu:KeyboardConfiguration", !0), (this.currentKey = !1);
    }),
    (Menu.prototype.setHome = function (t) {
        if (this.isConnected) return !1;
        if (
            ("undefined" != typeof VERSION_CODE && "DEV" != VERSION_CODE && (VERSION_CODE == t.version || pc.isMobile || ((this.updateEntity.enabled = !0), (this.updateVersionEntity.element.text = t.version))), t && t.official_stream_data)
        ) {
            var e = "";
            (e += "<iframe"),
        ...
        this.streamerImage && t.preview_image
            ? (this.streamerImage.fire("CustomImage:Set", t), this.streamerImage.script.button.setLink(t.preview_link), this.app.fire("CustomText:StreamerText", t), (this.streamerImage.enabled = !0))
            : (this.streamerImage.enabled = !1),
            t.youtuber_shop && t.youtuber_shop.name && ((this.youtubeShopName.element.text = t.youtuber_shop.name.slice(0, 50)), this.youtubeShopButton.script.button.setLink(t.youtuber_shop.link)),
                ...
                pc.app.fire("Page:Menu", "Shop"),
                    setTimeout(function () {
                        pc.app.fire("Tab:Shop", "Buy VG"),
                            setTimeout(function () {
                                console.log("Code set : ", e), pc.app.fire("Input:Input", e), pc.app.fire("Form:CreatorCode", !0);
                            }, 100);
                    }, 10);
            }, 50);
        }
    ...
    (Menu.prototype.onProfileData = function (t) {
        ...
        if (t && ((pc.session.hash = t.hash), (pc.session.username = t.username), Utils.setItem("Hash", t.hash), t.username && this.miniProfileEntity && this.miniProfileEntity.element))
            this.miniProfileEntity.findByName("Username").element.width;
    }),
    (Menu.prototype.onDestroy = function (t) {
        this.app.off("Sound:Play"), this.app.off("Player:Weapon"), this.app.mouse.off("mousemove", this.onMouseMove, this);
    }),
    ...
    (Menu.prototype.onMatchFound = function () {
        (this.isMatchFound = !0),
            ...
            this.matchFoundBackground.tween(this.matchFoundBackground.element).to({ opacity: 1 }, 1, pc.Linear).start(),
            (this.matchFoundRectangle.element.opacity = 1),
            this.matchFoundRectangle.setLocalScale(20, 1, 1),
            this.matchFoundRectangle.tween(this.matchFoundRectangle.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.5, pc.Linear).start(),
            this.matchFoundRectangle.tween(this.matchFoundRectangle.element).to({ opacity: 0.1 }, 0.5, pc.Linear).start(),
            this.matchFoundCenter.tween(this.matchFoundCenter.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 2, pc.Linear).start(),
            setTimeout(
                function (t) {
                    (t.matchFoundLoading.enabled = !0),
                        t.matchFoundRectangle.tween(t.matchFoundRectangle.element).to({ opacity: 0 }, 0.5, pc.Linear).start(),
                        t.matchFoundText.tween(t.matchFoundText.element).to({ opacity: 0 }, 0.5, pc.Linear).start(),
                        setTimeout(function () {
    ...
    (Menu.prototype.onWeaponSelect = function (t) {
        ...
        (this.weaponEntity.findByName(t).enabled = !0), (this.weaponIcon.element.textureAsset = i), (this.weaponName.element.text = t.toLowerCase()), this.entity.sound.play("Whoosh"), (pc.session.weapon = t);
    }),
    (Menu.prototype.onCharacterSelect = function (t) {
        ...
        (this.characterEntity = n), (this.characterEntity.enabled = !0), (this.characterName.element.text = t.toLowerCase()), this.entity.sound.play("Whoosh");
    ...
    (Menu.prototype.update = function (t) {
        this.checkScreenSize(),
            ...
            this.app.scene.skyboxRotation && ((this.app.scene.skyboxRotation.y -= 0.005 * t), this.app.scene._resetSkyboxModel(), (this.timestamp += t));
    });
Object.assign(
    pc,
    (function () {
        var BlackWhiteEffect = function (t) {
            ...
            var e = { aPosition: pc.SEMANTIC_POSITION },
            ...
            this.blackWhiteShader = new pc.Shader(t, { attributes: e, vshader: i, fshader: c });
        };
        return (
            ((BlackWhiteEffect.prototype = Object.create(pc.PostEffect.prototype)).constructor = BlackWhiteEffect),
            Object.assign(BlackWhiteEffect.prototype, {
                render: function (t, e, i) {
                    var c = this.device;
                    c.scope.resolve("uColorBuffer").setValue(t.colorBuffer), pc.drawFullscreenQuad(c, e, this.vertexBuffer, this.blackWhiteShader, i);
                },
            }),
...
Variables.attributes.add("redTeamColor", { type: "rgb" }),
    Variables.attributes.add("blueTeamColor", { type: "rgb" }),
    Variables.attributes.add("enemyColor", { type: "rgb" }),
    Variables.attributes.add("friendlyColor", { type: "rgb" }),
    Variables.attributes.add("meColor", { type: "rgb" }),
    Variables.attributes.add("lowHealth", { type: "rgb" }),
    Variables.attributes.add("health", { type: "rgb" }),
    Variables.attributes.add("grayColor", { type: "rgb" }),
    Variables.attributes.add("captureColor", { type: "rgb" }),
    Variables.attributes.add("blackColor", { type: "rgb" }),
    Variables.attributes.add("purpleColor", { type: "rgb" }),
    Variables.attributes.add("whiteColor", { type: "rgb" }),
    Variables.attributes.add("explosive", { type: "rgb" }),
    Variables.attributes.add("danger", { type: "rgb" }),
    Variables.attributes.add("activeColor", { type: "rgb" }),
    Variables.attributes.add("enemySpeed", { type: "number" }),
    Variables.attributes.add("maxEnemySpeed", { type: "number" }),
    Variables.attributes.add("minEnemySpeed", { type: "number" }),
    Variables.attributes.add("minEnemyVelocity", { type: "number" }),
...
Label.attributes.add("headPoint", { type: "entity" }),
    Label.attributes.add("labelEntity", { type: "entity" }),
    Label.attributes.add("spectatorLabelEntity", { type: "entity" }),
    Label.attributes.add("screenEntity", { type: "entity" }),
    Label.attributes.add("spectatorScreenEntity", { type: "entity" }),
    Label.attributes.add("labelHolder", { type: "entity" }),
    Label.attributes.add("spectatorLabelHolder", { type: "entity" }),
    Label.attributes.add("abilityEntity", { type: "entity" }),
    Label.attributes.add("flagEntity", { type: "entity" }),
    Label.attributes.add("playerCameraEntity", { type: "entity" }),
    Label.attributes.add("spectatorCameraEntity", { type: "entity" }),
    ...
    (Label.prototype.showLabel = function (t) {
        console.log(this.player.playerId, t), this.player.playerId == t && (this.player.lastDamage = Date.now());
    }),
    (Label.prototype.onDamage = function (t) {
        this.isEnabled = !0;
    }),
    (Label.prototype.onSettingsChange = function () {
        this.usernameEntity && this.usernameEntity.element && (this.usernameEntity.element.text = Utils.displayUsername(this.originalUsername));
    }),
    ...
    (Label.prototype.setInitalize = function () {
        pc.isSpectator
            ? ((this.labelEntity = this.spectatorLabelEntity.clone()), (this.screenEntity = this.spectatorScreenEntity), (this.labelHolder = this.spectatorLabelHolder), (this.labelEntity.enabled = !0))
    ...
    (Label.prototype.updateTeamColor = function () {
        if (!(this.healthBarEntity && this.healthBarEntity.element && this.healthBarEntity.element.color)) return !1;
        this.team == pc.currentTeam && ("PAYLOAD" == pc.currentMode || "TDM" == pc.currentMode || (pc.currentModeOptions && pc.currentModeOptions.team))
            ? ((this.healthBarEntity.element.color = pc.colors.health), (this.flagEntity.element.color = pc.colors.health))
            : ((this.healthBarEntity.element.color = pc.colors.enemy), (this.flagEntity.element.color = pc.colors.enemy));
    }),
    ...
    (Label.prototype.setHealth = function (t) {
        ...
        this.maskEntity.setLocalPosition(i, 0, 0),
            ...
            this.whiteBarEntity.tween(this.whiteBarEntity.getLocalScale()).to({ x: e, y: 1, z: 1 }, 0.5, pc.Linear).start(),
            this.whiteBarEntity.tween(this.whiteBarEntity.element).to({ opacity: 0 }, 0.5, pc.BackInOut).start();
    }),
    ...
    (Label.prototype.update = function (t) {
        ...
        if (!this.isEnabled && !pc.isSpectator) return this.labelEntity && (this.labelEntity.enabled = !1), !1;
        if (!pc.isSpectator) {
            if (this.player.isDeath) return (this.labelEntity.enabled = !1), !1;
            if (Date.now() - this.player.lastDamage > 1500)
                if (pc.currentTeam == this.team && ("PAYLOAD" == pc.currentMode || "TDM" == pc.currentMode || (pc.currentModeOptions && pc.currentModeOptions.team))) this.labelEntity.enabled = !0;
        ...
        a.worldToScreen(e, i),
            (i.x *= s),
            (i.y *= s),
            i.x > 0 && i.x < this.app.graphicsDevice.width && i.y > 0 && i.y < this.app.graphicsDevice.height && i.z > 0
                ? (this.labelEntity.setLocalPosition(i.x / n, (l.height - i.y) / n, 0), (this.labelEntity.enabled = !0))
                : (this.labelEntity.enabled = !1);
    });
var Result = pc.createScript("result");
Result.attributes.add("topLine", { type: "entity" }),
    Result.attributes.add("bottomLine", { type: "entity" }),
    Result.attributes.add("resultMessage", { type: "entity" }),
    Result.attributes.add("resultMessageOpacity", { type: "entity" }),
    Result.attributes.add("resultHolder", { type: "entity" }),
    Result.attributes.add("cloudEntity", { type: "entity" }),
    Result.attributes.add("cloudNoiseEntity", { type: "entity" }),
    Result.attributes.add("mapNameEntity", { type: "entity" }),
    Result.attributes.add("scoresEntity", { type: "entity" }),
    Result.attributes.add("resultTitleEntity", { type: "entity" }),
    Result.attributes.add("barEntity", { type: "entity" }),
    Result.attributes.add("headerEntity", { type: "entity" }),
    Result.attributes.add("headerBackgroundEntity", { type: "entity" }),
    Result.attributes.add("rowEntity", { type: "entity" }),
    Result.attributes.add("statsHolder", { type: "entity" }),
    Result.attributes.add("backgroundEntity", { type: "entity" }),
    Result.attributes.add("chatEntity", { type: "entity" }),
    Result.attributes.add("timerEntity", { type: "entity" }),
    Result.attributes.add("mapEntity", { type: "entity" }),
    Result.attributes.add("mapHolder", { type: "entity" }),
    Result.attributes.add("skillEntity", { type: "entity" }),
    Result.attributes.add("skillHolder", { type: "entity" }),
    Result.attributes.add("voteBar", { type: "entity" }),
    Result.attributes.add("voteCount", { type: "entity" }),
    Result.attributes.add("rewardButton", { type: "entity" }),
    Result.attributes.add("bannerEntity", { type: "entity" }),
    Result.attributes.add("rewardCountEntity", { type: "entity" }),
    Result.attributes.add("rewardLost", { type: "entity" }),
    Result.attributes.add("teamRedColor", { type: "rgb" }),
    Result.attributes.add("teamBlueColor", { type: "rgb" }),
    Result.attributes.add("teamNoneColor", { type: "rgb" }),
    Result.attributes.add("meColor", { type: "rgb" }),
    Result.attributes.add("lightColor", { type: "rgb" }),
    Result.attributes.add("victoryColor", { type: "rgb" }),
    Result.attributes.add("defeatColor", { type: "rgb" }),
    Result.attributes.add("victoryBgColor", { type: "rgb" }),
    Result.attributes.add("defeatBgColor", { type: "rgb" }),
    Result.attributes.add("padding", { type: "number" }),
    Result.attributes.add("maxTime", { type: "number", default: 35 }),
    Result.attributes.add("maxScore", { type: "number", default: 400 }),
    (Result.prototype.initialize = function () {
        ...
        setTimeout(
            function (t) {
                t.app.fire("Fetcher:Overlay"), t.showProgression(pc.playerStats), t.showScoreTable(pc.stats);
            },
            3e3,
            this
        ),
        ...
        pc.stats)) {
            ...
            e.isMe &&
                ((this.skills = [
                    { name: "Experience", score: e.experience },
                    { name: "Bonus XP", score: e.bonus },
                    { name: "Total Experience", score: e.experience + e.bonus },
                ]),
    ...
    (Result.prototype.destroyBanner = function () {
        this.app.fire("Ads:BannerDestroy", "venge-io_728x90_2", "728x90"), this.app.fire("Ads:BannerDestroy", "venge-io_320x50_2", "320x50"), this.bannerEntity && this.bannerEntity.destroy();
    }),
    ...
    (Result.prototype.onPreroll = function () {
        ...
        this.app.fire("Result:DestroyBanner", !0), this.app.fire("Network:Chat", "Requested 2X reward!"), this.app.fire("Analytics:Event", "Ads", "Request2X");
        this.app.fire("Player:Hide", !0),
            this.app.fire(
                "Ads:RewardAds",
                function (t) {
                    t ? (pc.app.fire("Network:Reward", !0), pc.app.fire("Alert:Overlay", "Your reward doubled!")) : pc.app.fire("Alert:Overlay", "Reward is not available!"), pc.app.fire("Player:Show", !0), pc.app.mouse.enablePointerLock();
                },
                function () {
                    pc.app.fire("Alert:Overlay", "Please disable adblock!"), pc.app.fire("Player:Show", !0), pc.app.mouse.enablePointerLock();
                }
            );
    }),
    (Result.prototype.onStateChange = function (t) {
        t
            ? (this.app.on("Overlay:Votes", this.onVotes, this), this.app.on("Overlay:WatchAds", this.onWatchAds, this), this.setVoteEntities(pc.voteMaps))
            : (this.app.off("Overlay:Votes"), this.app.off("Overlay:WatchAds"), this.entity.sound.stop("Victory-Result"), this.entity.sound.stop("Defeat-Result"));
    }),
    (Result.prototype.setSkillPoint = function () {
        ...
        (a.enabled = !0), (a.findByName("Name").element.text = e), a.setLocalPosition(-15, n, 0), a.tween(a.getLocalPosition()).to({ x: 0, y: n, z: 0 }, 0.5, pc.BackOut).start();
        var o = a.findByName("Fill");
        o.tween(o.getLocalScale()).to({ x: s, y: 1, z: 1 }, 0.7, pc.Linear).start(),
    ...
    (Result.prototype.tick = function () {
        ...
        t >= 0 && t <= 5
            ? ((this.timerEntity.element.text = 'GET READY - [color="#ffc703"]' + t + "[/color]"), this.time > -1 && this.entity.sound.play("Count"))
            : (this.timerEntity.element.text = 'NEXT GAME : [color="#ffc703"]' + t + "[/color]");
        var e = this.time - 10;
        (e = Math.max(e, 0)),
            this.time--,
            t >= 0 &&
    ...
    (Result.prototype.clearVoteEntities = function () {
        ...
        (this.mapEntities = []),
            ...
            this.cloudNoiseEntity.tween(this.cloudNoiseEntity.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: -170 }, this.maxTime, pc.Linear).start(),
            this.barEntity.tween(this.barEntity.element).to({ width: 1400 }, this.maxTime, pc.Linear).start();
    }),
    ...
    (Result.prototype.onVotes = function (t) {
        ...
        this.voteBar.tween(this.voteBar.getLocalScale()).to({ x: n, y: 1, z: 1 }, 0.4, pc.Linear).start(), (this.voteCount.element.text = e + " / " + this.players.length), this.entity.sound.play("Vote");
    }),
    ...
    (Result.prototype.showScoreTable = function (t) {
        ...
        this.backgroundEntity && this.backgroundEntity.element && this.backgroundEntity.tween(this.backgroundEntity.element).to({ opacity: 0.9 }, 5, pc.Linear).start(),
            this.headerEntity && this.headerEntity.element && ((this.headerEntity.element.width = 2e3), this.headerEntity.tween(this.headerEntity.element).to({ width: 1e3 }, 0.8, pc.BackOut).start());
    ...
    (Result.prototype.createPlayerRow = function (t, e) {
        ...
        (i.enabled = !0),
            ...
            (i.findByName("Emoji").element.text = this.app.assets.find("Charm-" + t.emoji + "-Emoji.png")),
        ...
        a && (i.findByName("Tier").element.textureAsset = a), (i.findByName("Status").element.color = 1 == e ? this.victoryColor : this.defeatColor);
        var n = i.findByName("Follow"),
            o = !1;
        t.isMe ? ((i.findByName("You").enabled = !0), (o = !1)) : ((i.findByName("You").enabled = !1), (o = !0), t.username.search("Guest") > -1 && (o = !1)),
            (n.enabled = o),
            (i.findByName("Rank").element.text = e),
            (i.findByName("Rank").element.opacity = this.rankOpacity),
            n && n.script && n.script.button && (n.script.button.fireFunction = "Follow:User@" + Utils.onlyUsername(t.username)),
            (this.rankOpacity -= 0.4);
        var r = (this.players.length % 2) + 2;
        1 === e ? ((r = 1), (i.element.opacity = 1)) : (i.element.opacity = this.players.length % 2 ? 0.8 : 0.7);
        var l = i.findByName("Badges"),
            p = i.findByName("Badges").findByName("Icon");
        for (var h in t.achievements) {
            var y = t.achievements[h],
                u = this.app.assets.find(y + "-Icon.png"),
                d = p.clone();
            (d.enabled = !0), d.setLocalPosition(34 * parseInt(h), 0, 0), (d.element.textureAsset = u), l.addChild(d);
        }
        var c = this.app.assets.find(t.skin + "-Thumbnail-" + r);
        t.heroSkin && "Default" != t.heroSkin && (c = this.app.assets.find(t.skin + "-" + t.heroSkin + "-Thumbnail.png")),
            (i.findByName("PlayerPicture").element.textureAsset = c),
            i
                .tween(i.getLocalPosition())
                .to({ x: 0, y: s, z: 0 }, 0.5, pc.BackOut)
                .delay(0.1 * e)
                .start(),
            ...
            setTimeout(
                function (t) {
                    (t.entity.sound.slots.Whoosh.pitch = 1 + 0.1 * Math.random()), t.entity.sound.play("Whoosh");
                },
                100 * e,
                this
            );
    ...
    (Result.prototype.showMessage = function (t) {
        (this.resultMessage.element.text = t),
            ...
            this.cloudEntity.tween(this.cloudEntity.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: -20 }, 4, pc.CubicOut).start(),
            this.cloudEntity.tween(this.cloudEntity.getLocalScale()).to({ x: 3, y: 3, z: 3 }, 4, pc.CubicOut).start(),
            (this.cloudEntity.element.opacity = 0.15),
            this.cloudEntity.tween(this.cloudEntity.element).to({ opacity: 0 }, 4, pc.Linear).start(),
            this.resultMessage.setLocalScale(0.1, 0.1, 0.1),
            this.resultMessage.tween(this.resultMessage.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.5, pc.Linear).start(),
            (this.resultHolder.element.height = 100),
            this.resultHolder.tween(this.resultHolder.element).to({ height: 300 }, 0.5, pc.ExponentialInOut).start(),
            this.resultMessageOpacity.tween(this.resultMessageOpacity.element).to({ opacity: 0 }, 0.4, pc.Linear).start(),
            this.resultMessageOpacity.setLocalScale(0.1, 0.1, 0.1),
            this.resultMessageOpacity.tween(this.resultMessageOpacity.getLocalScale()).to({ x: 2, y: 2, z: 2 }, 0.5, pc.Linear).start(),
            setTimeout(
                function (t) {
                    t.resultMessage.tween(t.resultMessage.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 1.3, pc.Linear).start(), t.resultHolder.tween(t.resultHolder.element).to({ height: 340 }, 1.3, pc.Linear).start();
                },
                500,
                this
            ),
            ...
            this.resultMessage.tween(this.resultMessage.element).to({ opacity: 1, spacing: 1.3 }, 1.5, pc.BackOut).start(),
            (this.topLine.element.opacity = 0),
            this.topLine.tween(this.topLine.element).to({ opacity: 1 }, 0.5, pc.Linear).start(),
            this.topLine.setLocalScale(0.1, 0.5, 1),
            this.topLine.tween(this.topLine.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.5, pc.ExponentialInOut).start(),
            (this.bottomLine.element.opacity = 0),
            this.bottomLine.tween(this.bottomLine.element).to({ opacity: 1 }, 0.5, pc.Linear).start(),
            this.bottomLine.setLocalScale(0.1, 0.5, 1),
            this.bottomLine.tween(this.bottomLine.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.5, pc.ExponentialInOut).start(),
            setTimeout(
                function (t) {
                    t.resultMessage.tween(t.resultMessage.getLocalScale()).to({ x: 2, y: 2, z: 2 }, 0.8, pc.QuadraticOut).start(),
                        t.resultMessage.tween(t.resultMessage.element).to({ opacity: 0, spacing: 1 }, 0.8, pc.BackOut).start(),
                        t.topLine.tween(t.topLine.element).to({ opacity: 0 }, 0.2, pc.Linear).start(),
                        t.topLine.tween(t.topLine.getLocalScale()).to({ x: 0.1, y: 0.5, z: 1 }, 0.5, pc.BackOut).start(),
                        t.bottomLine.tween(t.bottomLine.element).to({ opacity: 0 }, 0.2, pc.Linear).start(),
                        t.bottomLine.tween(t.bottomLine.getLocalScale()).to({ x: 0.1, y: 0.5, z: 1 }, 0.5, pc.BackOut).start();
                },
                1800,
                this
            );
...
Thumbnail.attributes.add("model", { type: "entity" }),
    Thumbnail.attributes.add("textures", { type: "asset", assetType: "texture", array: !0 }),
    ...
    (Thumbnail.prototype.slug = function (e) {
        ...
        return (
            e
                .toString()
                .replace(/\s+/g, "-")
                .replace(a, (e) => "aaaaaaaaaacccddeeeeeeeegghiiiiiilmnnnnoooooooooprrsssssttuuuuuuuuuwxyyzzz------".charAt(t.indexOf(e)))
                .replace(/&/g, "-and-")
                .replace(/[^\w\-]+/g, "")
                .replace(/\-\-+/g, "-")
                .replace(/^-+/, "")
    ...
    (Thumbnail.prototype.update = function () {
        if ((this.app.keyboard.wasPressed(pc.KEY_X) && ((this.currentName = this.slug(this.model.name)), this.capture()), this.app.keyboard.wasPressed(pc.KEY_Z)))
            if (0 === this.currentTextureIndex) this.nextTexture();
            else {
                var e = this.textures[this.currentTextureIndex - 1].name;
                (e = e.split(".")[0]), (this.currentName = this.slug(e)), this.capture(), this.nextTexture();
            }
    }),
    (Thumbnail.prototype.nextTexture = function () {
        for (var e = this.model.model.material.clone(), t = this.textures[this.currentTextureIndex], a = this.model.model.meshInstances, n = 0; n < a.length; ++n) {
            a[n].material = e;
        }
        this.app.assets.load(t),
            t.ready(function (a) {
    ...
    (Thumbnail.prototype.capture = function () {
        var e = new pc.Texture(this.app.graphicsDevice, { mipmaps: !1 });
        (e.minFilter = pc.FILTER_LINEAR), (e.magFilter = pc.FILTER_LINEAR), (e.addressU = pc.ADDRESS_CLAMP_TO_EDGE), (e.addressV = pc.ADDRESS_CLAMP_TO_EDGE);
        var t = this,
            a = (this.captured, new Image());
        (a.src = pc.app.graphicsDevice.canvas.toDataURL("image/png")),
            (a.onload = function () {
                t.context.clearRect(0, 0, t.canvas.width, t.canvas.height), t.context.drawImage(a, -window.innerWidth / 2 + 256, -window.innerHeight / 2 + 262);
                var e = new Image();
    ...
    (Thumbnail.prototype.download = function (e, t) {
        ...
        (a.href = e), (a.download = t), document.body.appendChild(a), a.click(), document.body.removeChild(a);
    });
var Input = pc.createScript("input");
Input.attributes.add("placeholder", { type: "string" }),
    Input.attributes.add("type", { type: "string", enum: [{ Text: "text" }, { Email: "email" }, { Password: "password" }], default: "text" }),
    ...
    Input.attributes.add("hasIcon", { type: "boolean" }),
    Input.attributes.add("scaleUnit", { type: "string", enum: [{ "Viewport Width": "vw" }, { "Viewport Height": "vh" }, { Pixel: "px" }], default: "vw" }),
    Input.attributes.add("color", { type: "rgb" }),
    Input.attributes.add("disableTab", { type: "boolean" }),
    Input.attributes.add("whitePlaceholder", { type: "boolean" }),
    Input.attributes.add("temporary", { type: "boolean" }),
    Input.attributes.add("fontFamily", { type: "string", default: "Arial, sans-serif" }),
    Input.attributes.add("storeValue", { type: "boolean" }),
    Input.attributes.add("containerEntity", { type: "entity" }),
    ...
    Input.attributes.add("key", { type: "string" }),
    ...
    (Input.prototype.createElement = function () {
        ...
        (this.element.style.color = t),
            ...
            this.containerEntity ? ((this.element.style.position = "fixed"), this.containerEntity.script.container.insideElement.appendChild(this.element)) : document.body.appendChild(this.element),
    ...
    (Input.prototype.onDestroy = function () {
        (this.isDestroyed = !0), this.element && this.element.remove(), this.app.off("Input:" + this.entity.name, this.setValue, this);
    }),
        ...
        if (t.entity && t.entity.element && t.entity.element.screenCorners) {
            ...
            if (this.containerEntity) {
                ...
                (n = (e[0].x - this.containerEntity.offsetLeft) / h),
                    (s = (e[0].y - this.containerEntity.offsetTop) / a - l + this.containerEntity.element.height),
                    this.containerEntity && this.containerEntity.script.container.autoResize && ((this.element.style.transform = "scale(" + 1 / h + ", " + 1 / a + ")"), (this.element.style.transformOrigin = "left bottom"));
...
Chat.attributes.add("inputEntity", { type: "entity" }),
    Chat.attributes.add("messageEntity", { type: "entity" }),
    Chat.attributes.add("messageHolder", { type: "entity" }),
    Chat.attributes.add("consoleColor", { type: "rgb" }),
    Chat.attributes.add("meColor", { type: "rgb" }),
    Chat.attributes.add("whiteColor", { type: "rgb" }),
    Chat.attributes.add("padding", { type: "number", default: 2 }),
    Chat.attributes.add("timeLimit", { type: "number", default: 5 }),
    Chat.attributes.add("messageLimit", { type: "number", default: 4 }),
    Chat.attributes.add("isFocused", { type: "boolean", default: !1 }),
    Chat.attributes.add("keepHistory", { type: "boolean", default: !1 }),
    Chat.attributes.add("profanity", { type: "boolean", default: !0 }),
    ...
    (Chat.prototype.mountEvents = function () {
        this.app.on("Chat:Message", this.onMessage, this), this.app.on("Chat:Clear", this.onClear, this), this.app.on("Map:Loaded", this.onMapLoaded, this), this.app.on("Input:Focus", this.onInputFocus, this);
    }),
    (Chat.prototype.unmountEvents = function () {
        this.app.off("Chat:Message", this.onMessage, this), this.app.off("Chat:Clear", this.onClear, this), this.app.off("Map:Loaded", this.onMapLoaded, this), this.app.off("Input:Focus", this.onInputFocus, this);
    }),
    ...
    (Chat.prototype.onMapLoaded = function () {
        ...
        this.app.fire("Chat:Message", "Console", "Press TAB to see other players scores!"), (this.displayed = !0);
    }),
    (Chat.prototype.nextMessage = function () {
        var t = this.messages.length;
        if (t > 0) for (var e = 0; t--; ) this.messages[t].setLocalPosition(0, (this.messages.length - t) * this.padding + e, 0), (e += this.messages[t].element.height);
    ...
    (Chat.prototype.onMessage = function (t, e, s, i, a) {
        if (this.profanity && this.checkProfinatity(e) && "Console" != t) return s && this.app.fire("Chat:Message", "Console", "Message removed."), !1;
        ...
        (o.enabled = !0),
            ...
            i
                ...
                ? a && ("red" == a ? (o.findByName("Text").element.color = pc.colors.redTeam) : "blue" == a && (o.findByName("Text").element.color = pc.colors.blueTeam))
    ...
    (Chat.prototype.sendMessage = function () {
        ...
        this.app.fire("Network:Chat", t), this.inputEntity.script.input.setValue(""), this.blur(), (this.lastMessageDate = Date.now());
    }),
    (Chat.prototype.onEnter = function () {
        this.isFocused ? this.sendMessage() : this.focus();
    }),
    (Chat.prototype.focus = function () {
        this.entity.enabled && (this.inputEntity.script.input.focus(), (this.isFocused = !0), this.app.fire("Player:Lock", !1));
    }),
    ...
    (Chat.prototype.update = function () {
        this.app.keyboard.wasPressed(pc.KEY_ENTER) && this.onEnter(), this.app.keyboard.wasPressed(pc.KEY_ESCAPE) && this.blur();
    });
var Speaking = pc.createScript("speaking");
Speaking.attributes.add("subtitles", { type: "string", array: !0 }),
    ...
    (Speaking.prototype.play = function (t, e) {
        ...
        this.entity.sound.play(a), this.app.fire("Overlay:Subtitle", this.subtitles[n]), this.currentIndex++, (this.lastPlayedSound = a);
    });
var Count = pc.createScript("count");
Count.attributes.add("leftPad", { type: "string" }),
    Count.attributes.add("rightPad", { type: "string" }),
    Count.attributes.add("next", { type: "number" }),
    Count.attributes.add("speed", { type: "number", default: 0.05 }),
    ...
    (Count.prototype.update = function (t) {
        ...
        (this.entity.element.text = this.leftPad + e + this.rightPad), (this.currentNumber = pc.math.lerp(this.currentNumber, this.next, this.speed));
    });
...
Object.assign(
    ...
    (function () {
        var ZoomEffect = function (e) {
            ...
            var t = { aPosition: pc.SEMANTIC_POSITION },
            ...
            this.zoomShader = new pc.Shader(e, { attributes: t, vshader: o, fshader: i });
        };
        return (
            ...
            Object.assign(ZoomEffect.prototype, {
                render: function (e, t, o) {
                    ...
                    r.resolve("uColorBuffer").setValue(e.colorBuffer), r.resolve("mouse").setValue(v), r.resolve("res").setValue(u), pc.drawFullscreenQuad(i, t, this.vertexBuffer, this.zoomShader, o);
                },
            }),
...
Waterfall.attributes.add("noise_1", { type: "asset", assetType: "texture" }),
    Waterfall.attributes.add("noise_2", { type: "asset", assetType: "texture" }),
    Waterfall.attributes.add("top_light_color", { type: "rgba" }),
    Waterfall.attributes.add("top_dark_color", { type: "rgba" }),
    Waterfall.attributes.add("bot_light_color", { type: "rgba" }),
    Waterfall.attributes.add("bot_dark_color", { type: "rgba" }),
    Waterfall.attributes.add("speed", { type: "number", default: 1.1 }),
    Waterfall.attributes.add("opacitySpeed", { type: "number", default: 1.1 }),
    ...
    (Waterfall.prototype.update = function (t) {
        if (this.isLoaded) {
            ...
            this.material.setParameter("TIME", e), (this.material.opacityMapOffset.y = (-e * this.opacitySpeed) % 1), this.material.update();
        }
    });
...
Button.attributes.add("connected", { type: "entity" }),
    ...
    Button.attributes.add("pressFunction", { type: "string" }),
    Button.attributes.add("leaveFunction", { type: "string" }),
    Button.attributes.add("fireFunction", { type: "string" }),
    Button.attributes.add("fireArgs", { type: "string" }),
    Button.attributes.add("playSound", { type: "boolean", default: !0 }),
    Button.attributes.add("waitResolve", { type: "boolean" }),
    Button.attributes.add("destroyOnFunction", { type: "boolean" }),
    Button.attributes.add("linkButton", { type: "boolean", default: !1 }),
    Button.attributes.add("openNewTab", { type: "boolean", default: !1 }),
    Button.attributes.add("link", { type: "string" }),
    Button.attributes.add("key", { type: "string" }),
    (Button.prototype.initialize = function () {
        (this.spinner = !1),
            ...
            this.linkButton
                ...
                : Utils.isMobile()
                ? (this.entity.element.on("touchstart", this.onPress, this), this.entity.element.on("touchend", this.onLeave, this))
                : (this.entity.element.on("mouseenter", this.onHover, this), this.entity.element.on("mouseleave", this.onLeave, this), this.entity.element.on("mousedown", this.onPress, this)),
            this.entity.findByName("Spinner") && ((this.spinner = this.entity.findByName("Spinner")), (this.spinner.enabled = !1)),
            this.entity.findByName("Text") && ((this.text = this.entity.findByName("Text")), (this.text.enabled = !0)),
    ...
    (Button.prototype.setLink = function (t) {
        "object" == typeof t && t[this.key] && (t = t[this.key]), (this.link = t), this.element && this.element.setAttribute("href", this.link);
    }),
    ...
    (Button.prototype.updateStyle = function () {
        ...
        if (this.entity && this.entity.enabled && this.entity.element && this.entity.element.screenCorners) {
            ...
            (this.element.style.left = t[0].x * e + "px"), (this.element.style.bottom = t[0].y * e + "px"), (this.element.style.position = "absolute"), (this.element.style.display = "block"), (this.element.style.zIndex = 1e3);
            var i = ((t[2].x - t[0].x) * e) / this.entity.element.width,
                n = ((t[2].y - t[0].y) * e) / this.entity.element.height;
            (this.element.style.transform = "scale(" + i + ", " + n + ")"), (this.element.style.transformOrigin = "left bottom");
        }
    }),
    ...
    (Button.prototype.loading = function () {
        ...
        (this.spinner.enabled = !0), (this.text.enabled = !1), this.entity.button && (this.entity.button.active = !1);
    }),
    (Button.prototype.resolve = function () {
        if (!this.entity.enabled) return !1;
        (this.spinner.enabled = !1), (this.text.enabled = !0), (this.isActivated = !0), this.entity.button && (this.entity.button.active = !0);
    }),
    (Button.prototype.onPress = function (t) {
        if (pc.isButtonLocked) return !1;
    ...
    (Button.prototype.onPressFire = function (event) {
        if (
            ...
            this.waitResolve && (this.spinner && ((this.spinner.enabled = !0), (this.text.enabled = !1)), this.entity.button && (this.entity.button.active = !1), (this.isActivated = !1)),
            this.connected)
        ) {
            ...
            if (this.fireArgs) this.app.fire(this.fireFunction, this.fireArgs);
                ...
                if (fireFunction.length > 0)
                    for (var successIndex in fireFunction) {
                        ...
                        if (parts.length > 1) {
                            var value = parts[1];
                            "data" == value && (value = this.entity._data), "entity" == value && (value = this.entity), this.app.fire(key, value);
...
Point.attributes.add("playerEntity", { type: "entity" }),
    ...
    (Point.prototype.onFocusChange = function (t) {
        this.isFocused != t && (!0 === t ? this.entity.setLocalScale(1, 0.5, 1) : this.entity.setLocalScale(1, 1, 1)), (this.isFocused = t);
    }),
    (Point.prototype.onInside = function (t) {
        t
            ? ((this.objectiveBackground.element.color = pc.colors.capture), (this.objectiveBackground.element.opacity = 0.5))
            : ((this.objectiveBackground.element.color = pc.colors.black), (this.objectiveBackground.element.opacity = 0.15), (this.wasInside = !1));
    }),
...
"undefined" == typeof VERSION_CODE && (VERSION_CODE = "DEV"),
    "undefined" != typeof VERSION &&
        (pc.Asset.prototype.getFileUrl = function () {
            ...
            var t = e.url;
            if ((this.registry && this.registry.prefix && !ABSOLUTE_URL.test(t) && (t = this.registry.prefix + t), "script" !== this.type && e.hash)) {
                var o = -1 !== t.indexOf("?") ? "&" : "?";
                t += o + "t=" + e.hash + "?v=" + VERSION;
            } else t += "?v=" + VERSION;
            return t;
        }),
    window.addEventListener("keydown", function (e) {
        32 == e.keyCode && e.target == document.body && e.preventDefault(), 9 != e.which || (e.target != document.body && !pc.isMapLoaded) || e.preventDefault();
    }),
    window.addEventListener("keyup", function (e) {
        32 == e.keyCode && e.target == document.body && e.preventDefault(), 9 == e.which && e.target == document.body && e.preventDefault();
    }),
    document.addEventListener(
        "wheel",
        function (e) {
            if ("BODY" === e.target.tagName || "WINDOW" === e.target.tagName || "HTML" === e.target.tagName || "CANVAS" === e.target.tagName) return e.preventDefault(), !1;
        },
        { passive: !1 }
    ),
    ...
    pc.script.createLoadingScreen(function (e) {
        ...
        (t = [
            ...
            "    height: 100%;",
            "    width: 100%;",
            '    background: url("https://venge.io/Thumbnail-00' + (Math.floor(5 * Math.random()) + 1) + '.jpg?v=1.0.1") #191919 no-repeat center center;',
            ...
            (function () {
                ((wrapper = document.createElement("div")).id = "application-splash-wrapper"), document.body.appendChild(wrapper);
                var e = document.createElement("div");
                (e.id = "application-splash"), wrapper.appendChild(e);
            ...
            e.on("preload:progress", function (e) {
                ...
                if ((t && ((e = Math.min(1, Math.max(0, e))), (t.style.width = 100 * e + "%")), "undefined" != typeof PokiSDK)) {
                    var o = {};
                    (o.percentageDone = e), (o.kbLoaded = 100 * e), (o.kbTotal = 100), (o.fileNameLoaded = "game.json"), (o.filesLoaded = 1), (o.filesTotal = 1), PokiSDK.gameLoadingProgress(o);
                }
            }),
            e.on("start", function () {
                var e = document.getElementById("application-splash-wrapper");
                e && e.parentElement && e.parentElement.removeChild(e), "undefined" != typeof PokiSDK && PokiSDK.gameLoadingFinished();
            });
    });
var SpellManager = pc.createScript("spellManager");
SpellManager.attributes.add("playerEntity", { type: "entity" }),
    SpellManager.attributes.add("cameraEntity", { type: "entity" }),
    SpellManager.attributes.add("electricityEntity", { type: "entity" }),
    SpellManager.attributes.add("sparkEntity", { type: "entity" }),
    SpellManager.attributes.add("armLeftEntity", { type: "entity" }),
    SpellManager.attributes.add("armRightEntity", { type: "entity" }),
    SpellManager.attributes.add("iceEntity", { type: "entity" }),
    SpellManager.attributes.add("iceTexture", { type: "asset", assetType: "texture" }),
    SpellManager.attributes.add("venomEntity", { type: "entity" }),
    SpellManager.attributes.add("windEntity", { type: "entity" }),
    SpellManager.attributes.add("windEntityPlayer", { type: "entity" }),
    SpellManager.attributes.add("daggerPower", { type: "entity" }),
    ...
    (SpellManager.prototype.onGameStart = function () {
        "Lilium" == this.characterName ? (this.playerAbilities.throwCooldown = 10) : "Shin" == this.characterName && (this.playerAbilities.throwCooldown = 5), (this.isReducedApplied = !1);
    }),
    ...
    (SpellManager.prototype.applyMidnightCurse = function () {
        this.entity.sound.play("Wolf-Howl"),
            ...
            this.app.tween(this.app.scene).to({ fogDensity: 0.3, skyboxIntensity: 0.3 }, 0.3, pc.Linear).start(),
    ...
    (SpellManager.prototype.cancelMidnightCurse = function () {
        var e = this;
        e.app.tween(e.app.scene).to({ fogDensity: 1e-4, skyboxIntensity: e.defaultSkyboxIntensity }, 0.3, pc.Linear).delay(0.2).start(),
            e.entity.sound.play("Magic-Whoosh-1"),
            setTimeout(function () {
                e.entity.sound.stop("Shadow-Loop-2"), e.activeSpells.splice(e.activeSpells.indexOf("GrenadeSpell"), 1);
            }, 1e3);
    }),
    (SpellManager.prototype.applyMuscleShock = function () {
        if (this.player.isDeath) return (this.spellCount = 0), this.activeSpells.splice(this.activeSpells.indexOf("GrenadeSpell"), 1), !1;
        if (this.spellCount > 4 || pc.isFinished) return (this.spellCount = 0), (this.isActiveSpell = !1), this.activeSpells.splice(this.activeSpells.indexOf("GrenadeSpell"), 1), !1;
        ...
        (this.currentSpell = "MuscleShock"),
            ...
            this.app.tween(pc.controls.animation).to({ cameraBounce: 0.8 }, 0.04, pc.Linear).yoyo(!0).repeat(7).start(),
            this.app.tween(this.player.movement.animation).to({ bounceAngle: 3 }, 0.03, pc.Linear).yoyo(!0).repeat(7).start(),
            this.app.fire("Player:StopSpeaking", !0),
    ...
    (SpellManager.prototype.applyVenom = function () {
        if (this.player.isDeath) return this.activeSpells.splice(this.activeSpells.indexOf("GrenadeSpell"), 1), !1;
        if (this.isVenomActive) return !1;
        (this.venomEntity.enabled = !0),
            (this.venomEntity.sprite.opacity = 0.2),
            (this.venomTween = this.app.tween(this.venomEntity.sprite).to({ opacity: 0.45 }, 2, pc.BackIn)),
    ...
    (SpellManager.prototype.cancelVenom = function () {
        this.venomTween && this.venomTween.stop(),
            (this.venomTween = this.app.tween(this.venomEntity.sprite).to({ opacity: 0 }, 0.5, pc.BackIn)),
            this.venomTween.start(),
            this.app.fire("Player:StopSpeaking", !0),
    ...
    (SpellManager.prototype.applyFrostBomb = function () {
        ...
        (this.iceEntity.enabled = !0),
            ...
            (this.iceTween = this.app.tween(this.iceMaterial).to({ opacity: 1 }, 1, pc.Linear)),
            ...
            this.armLeftEntity &&
                ...
                ((this.armsEntityMaterial = this.armLeftEntity.model.meshInstances[0].material), (this.armsEntityMaterial.emissiveMap = this.iceTexture.resource), this.armsEntityMaterial.update()),
            this.app.fire("Network:Hurt", !0),
    ...
    (SpellManager.prototype.cancelFrostBomb = function () {
        ...
        this.entity.sound.play("Ice-Break"),
            ...
            (this.iceTween = this.app.tween(this.iceMaterial).to({ opacity: 0 }, 0.3, pc.Linear)),
            this.iceTween.on("update", function (t) {
                e.iceMaterial.update();
            }),
            this.iceTween.start(),
            ...
            this.weaponMaterial && ((this.weaponMaterial.emissiveMap = !1), this.weaponMaterial.update(), this.armsEntityMaterial && ((this.armsEntityMaterial.emissiveMap = !1), this.armsEntityMaterial.update())),
            setTimeout(
                function (e) {
    ...
    (SpellManager.prototype.applyReduce = function () {
        this.isReducedApplied ||
            ("Lilium" == this.characterName ? (this.playerAbilities.throwCooldown = 7) : "Shin" == this.characterName && (this.playerAbilities.throwCooldown = 3),
    ...
    (SpellManager.prototype.onSpellTrigger = function (e, t) {
        ...
        "MidnightCurse" == e && (this.applyMidnightCurse(), this.app.fire("Overlay:Announce", "Midnight Curse", "by " + t, !1, "MidnightCurse-Icon")),
            "FrostBomb" == e && (this.applyFrostBomb(), this.app.fire("Overlay:Announce", "Frost Bomb", "by " + t, !1, "FrostBomb-Icon")),
            "MuscleShock" == e && (this.applyMuscleShock(), this.app.fire("Overlay:Announce", "Muscle Shock", "by " + t, !1, "MuscleShock-Icon")),
            "SparkySpells" == e && (this.applySparkySpells(), this.app.fire("Overlay:Announce", "Sparky Sprites", "by " + t, !1, "SparkySpells-Icon")),
            "Venom" == e && (this.applyVenom(), this.app.fire("Overlay:Announce", "Venom", "by " + t, !1, "Venom-Icon")),
            "Reduce" == e && this.applyReduce();
    }),
    (SpellManager.prototype.update = function (e) {});
var Tab = pc.createScript("tab");
Tab.attributes.add("menu", { type: "string", array: !0 }),
    Tab.attributes.add("page", { type: "entity", array: !0 }),
    Tab.attributes.add("align", { type: "string", enum: [{ Vertical: "Vertical" }, { Horizontal: "Horizontal" }], default: "Vertical" }),
    Tab.attributes.add("buttonEntity", { type: "entity" }),
    Tab.attributes.add("buttonHolder", { type: "entity" }),
    Tab.attributes.add("onlyTabs", { type: "boolean", default: !1 }),
    (Tab.prototype.initialize = function () {
        ...
        this.app.on("Tab:" + this.entity.name, this.onTabChange, this), this.on("state", this.onStateChange, this), this.onTabChange(this.menu[0]);
    }),
    ...
    (Tab.prototype.onTabChange = function (t) {
        ...
        for (var n in this.menuItems) {
            ...
            if (this.onlyTabs) i.name == t ? (i.element.opacity = 1) : (i.element.opacity = 0);
                ...
                var s = this.page[n];
                i.name == t ? ((i.element.opacity = 1), (s.enabled = !0)) : ((i.element.opacity = 0), (s.enabled = !1));
            }
        }
        this.app.fire("Tab:" + this.entity.name + ":Changed", t);
    });
var Page = pc.createScript("page");
Page.attributes.add("activeOpacity", { type: "number", default: 0.05 }),
    Page.attributes.add("defaultOpacity", { type: "number", default: 0 }),
    Page.attributes.add("activePage", { type: "string" }),
    (Page.prototype.initialize = function () {
        this.app.on("Page:" + this.entity.name, this.setPage, this), this.activePage && this.app.fire("Page:" + this.entity.name, this.activePage);
    }),
    (Page.prototype.setPage = function (t) {
        ...
        for (var i in e) {
            ...
            for (var p in (n.name == t ? (n.enabled = !0) : (n.enabled = !1), a)) {
                var r = a[p];
                r.name == t ? (r.element.opacity = this.activeOpacity) : (r.element.opacity = this.defaultOpacity);
            }
        }
    });
var Cookie = pc.createScript("cookie");
Cookie.attributes.add("key", { type: "string" }),
    Cookie.attributes.add("onGet", { type: "string" }),
    (Cookie.prototype.initialize = function () {
        this.onGet && this.getCookie(), this.app.on("Cookie:" + this.entity.name, this.setCookie, this), this.app.on("Cookie:" + this.entity.name + ":Clear", this.clearCookie, this);
    }),
    ...
    (Cookie.prototype.clearCookie = function (t) {
        JSON.stringify(t);
        Utils.setItem(this.key, null), void 0 !== window.localStorage && window.localStorage.removeItem(this.key), this.app.fire(this.onGet, !1);
    }),
...
Fetcher.attributes.add("auto", { type: "boolean", default: !0 }),
    Fetcher.attributes.add("cache", { type: "boolean", default: !1 }),
    Fetcher.attributes.add("URL", { type: "string" }),
    Fetcher.attributes.add("data", { type: "string" }),
    Fetcher.attributes.add("template", { type: "string", description: "Format data" }),
    Fetcher.attributes.add("loading", { type: "string" }),
    Fetcher.attributes.add("loadingEntity", { type: "entity" }),
    ...
    (Fetcher.prototype.initialize = function () {
        (this.lastCall = -1),
            ...
            this.cache ? this.app.on("Fetcher:" + this.entity.name, this.onCache, this) : this.app.on("Fetcher:" + this.entity.name, this.onFetch, this),
    ...
    (Fetcher.prototype.preprocess = function (t) {
        var e = t;
        return (e = (e = (e = (e = e.replace("$hash", this.getRoomId())).replace("$session", this.getSession())).replace("$is_mobile", pc.isMobile)).replace("$current_map", pc.currentMap));
    }),
    ...
    (Fetcher.prototype.onFetch = function (t, e) {
        ...
        this.template ? (this.data = JSON.parse(this.template.replace("variable", t))) : t && (this.data = t);
        var i = this.preprocess(this.URL);
        this.onLoading(), (this.onCallback = !(!e || "function" != typeof e) && e), this.fetch(i, this.data, this.onResult.bind(this)), (this.lastCall = Date.now());
    }),
    (Fetcher.prototype.fetch = function (t, e, i) {
        ...
        a.open("POST", t),
            (a.onreadystatechange = function () {
                a.readyState > 3 && 200 == a.status && ((s.cache = JSON.parse(a.responseText)), i(JSON.parse(a.responseText)));
            }),
            (a.withCredentials = !0),
...
Form.attributes.add("inputs", { type: "entity", array: !0 }),
    Form.attributes.add("keys", { type: "string", array: !0 }),
    Form.attributes.add("onSubmit", { type: "string" }),
    (Form.prototype.initialize = function () {
        this.app.on("Form:" + this.entity.name, this.onFormSubmit, this), this.app.on("FormSet:" + this.entity.name, this.onFormSet, this);
    }),
...
Table.attributes.add("labels", { type: "string", array: !0 }),
    Table.attributes.add("keys", { type: "string", array: !0 }),
    Table.attributes.add("buttons", { type: "string", array: !0 }),
    Table.attributes.add("color", { type: "rgb" }),
    Table.attributes.add("rowColor", { type: "rgb" }),
    Table.attributes.add("header", { type: "boolean", default: !0 }),
    Table.attributes.add("headerColor", { type: "rgb" }),
    Table.attributes.add("opacity", { type: "number", default: 0.1, max: 1, min: 0, step: 0.1 }),
    Table.attributes.add("destroyButton", { type: "boolean" }),
    Table.attributes.add("cdn", { type: "string", enum: [{ maps: "maps" }, { assets: "assets" }], default: "assets" }),
    ...
    (Table.prototype.onDestroy = function () {
        this.app.off("DOM:Update"), (this.isDestroyed = !0), (this.buttonsDisabled = !1), this.container && this.container.remove();
    }),
    (Table.prototype.onDomUpdate = function () {
        this.updateStyle();
    }),
    (Table.prototype._onInit = function () {
        (this.container = document.createElement("div")), (this.container.style.width = this.entity.element.width + "px"), (this.container.style.height = this.entity.element.height + "px");
        var t = "";
        (t += "table { border-collapse: collapse; }"),
            ...
            (t += "table, th, td { padding:0.5vw; }"),
            (t += "table, .verification { height:16px; float:left; margin-right: 5px; }"),
            (t += "table, tr:nth-child(even) { background-color:" + ("rgba(" + 255 * this.rowColor.r + ", " + 255 * this.rowColor.g + ", " + 255 * this.rowColor.b + ", " + this.opacity + ")") + "; }"),
            (t += "table, tr th { text-align:left; font-size:12px; "),
            (t += "background-color:" + ("rgba(" + 255 * this.headerColor.r + ", " + 255 * this.headerColor.g + ", " + 255 * this.headerColor.b + ", " + this.opacity + ")") + "; }"),
            ...
            (t += '.table-sortable .th-sort-asc::after,.table-sortable .th-sort-desc::after{"margin-left: 5px;"}'),
            (t += '.table-sortable .th-sort-asc,.table-sortable .th-sort-desc{"background: rgba(0,0,0,0.1);"}'),
    ...
    (Table.prototype.createThumbnail = function (t, e) {
        ...
        if (a) {
            ...
            a.search("https") > -1 ? (i.src = a) : "maps" == this.cdn ? (i.src = Utils.prefixMapCDN + a) : (i.src = Utils.prefixCDN + a), (i.width = 90), e.appendChild(i), (e.className = "thumbnail-column");
        }
    }),
    (Table.prototype.createRating = function (t, e) {
        ...
        if (this.app.assets.find(a)) {
            ...
            (i.src = this.app.assets.find(a).getFileUrl()),
                ...
                (i.onclick = function () {
                    pc.app.fire("View:Menu", "Rating"), pc.app.fire("Template:Rating", { map: this.ratingId });
                }),
                e.appendChild(i);
    ...
    (Table.prototype.createButtons = function (t, e, a) {
        ...
        if ((t[e] && t[e].match(/\$button\[(.*?)\]/)) || (e && e.match(/\$button\[(.*?)\]/))) {
            var r = 0,
                n = !1;
            t[e] && t[e].match(/\$button\[(.*?)\]/) && (r = t[e].match(/\$button\[(.*?)\]/)), e && e.match(/\$button\[(.*?)\]/) && (r = e.match(/\$button\[(.*?)\]/)), e && e.match(/\((.*?)\)/) && (n = e.match(/\((.*?)\)/));
            var s = parseInt(r[1]),
            ...
            if (
                ...
                (c.onclick = function () {
                    var t = {};
                    (t[this._key] = this._value), "data" == this._key ? pc.app.fire(this.trigger, this._row) : pc.app.fire(this.trigger, t), i.destroyButton && (i.buttonsDisabled = !0);
                }),
                a.appendChild(c),
                n)
            ) {
            ...
            for (var s in this.buttons) {
                ...
                ((c = document.createElement("button")).innerText = h[0]),
                    ...
                    (c.onclick = function () {
                        var t = {};
                        (t[this._key] = this._value), pc.app.fire(this.trigger, t), i.destroyButton && (i.buttonsDisabled = !0);
                    }),
                    a.appendChild(c);
            }
    }),
        ...
        for (var i in t) {
            ...
            for (var s in this.keys) {
                ...
                if (o.search("\\$verified") > -1) {
                    ...
                    "1" == r.verified && ((h = '<img src="' + e.getFileUrl() + '"'), (h += 'class="verification">')), (l.innerHTML = h + " " + this.formatMarkup(r[c], c));
                } else
                    "$thumbnail" == o
                        ? this.createThumbnail(r, l)
                        : "$rating" == o
                        ? this.createRating(r, l)
                        : "$button" == o || "$button" == r[o] || (r[o] && r[o].length > 0 && r[o].search("\\$button") > -1) || (o && o.length > 0 && o.search("\\$button") > -1)
            ...
            a.append(n), this.table.appendChild(a), this.rows.push(n);
        }
        this.header &&
            (document.querySelector(".table-sortable th") && document.querySelector(".table-sortable th").classList.add("sortable"),
    ...
    (Table.prototype._updateStyle = function () {
        ...
        if (this.entity.enabled && this.entity.element && this.entity.element.screenCorners) {
            var t = this.entity.element.screenCorners,
                e = 1 / this.app.graphicsDevice.maxPixelRatio;
            (this.container.style.left = t[0].x * e + "px"), (this.container.style.bottom = t[0].y * e + "px"), (this.container.style.position = "absolute"), (this.container.style.display = "block"), (this.container.style.zIndex = 1e3);
            var a = ((t[2].x - t[0].x) * e) / this.entity.element.width,
                i = ((t[2].y - t[0].y) * e) / this.entity.element.height;
            (this.container.style.transform = "scale(" + a + ", " + i + ")"), (this.container.style.transformOrigin = "left bottom");
        }
    }),
    (Table.prototype.tableSortByColumn = function (t, e, a = !0) {
        const i = t.tBodies[0],
            ...
            s = r.sort((t, a) => {
                ...
                return (
                    0 === e
                        ? ((i = parseInt(t.querySelector(`td:nth-child(${e + 1})`).textContent.trim())), (r = parseInt(a.querySelector(`td:nth-child(${e + 1})`).textContent.trim())))
                        : ((i = t.querySelector(`td:nth-child(${e + 1})`).textContent.trim()), (r = a.querySelector(`td:nth-child(${e + 1})`).textContent.trim())),
                    i > r ? 1 * n : -1 * n
                );
            });
...
Visibility.attributes.add("visible", { type: "boolean", default: !0 }),
    Visibility.attributes.add("query", { type: "string", default: "success == true" }),
    Visibility.attributes.add("hideLater", { type: "boolean" }),
...
Template.attributes.add("autoRefresh", { type: "boolean", default: !1 }),
    Template.attributes.add("onInit", { type: "string" }),
    (Template.prototype.initialize = function () {
        this.app.on("Template:" + this.entity.name, this.onUpdate, this), this.onInit && (this.onInitTrigger(), this.onUpdate()), this.clearValues();
    }),
    ...
    (Template.prototype.numberFormat = function (e) {
        return (e = parseInt(e)), (Math.abs(e) > 999 ? Math.sign(e) * (Math.abs(e) / 1e3).toFixed(1) + "k" : Math.sign(e) * Math.abs(e)) + "";
    }),
        ...
        for (var t = this.entity.findByTag("Dynamic"), r = t.length; r--; ) {
            ...
            if (i && i.enabled) {
                if (i.element.type == pc.ELEMENTTYPE_TEXT) {
                    ...
                    i.element.source ? (i.element.text = i.element.source + "") : (i.element.source = n), (i.element.text = this.render(e, i.element.text, i.element));
                }
...
View.attributes.add("items", { type: "entity", array: !0 }),
    View.attributes.add("defaultView", { type: "string" }),
    (View.prototype.initialize = function () {
        this.app.on("View:" + this.entity.name, this.onViewChange, this), this.app.on("View:" + this.entity.name + "@Close", this.onViewClose, this), this.defaultView && this.app.fire("View:" + this.entity.name, this.defaultView);
    }),
...
Check.attributes.add("query", { type: "string" }),
    Check.attributes.add("success", { type: "string" }),
    Check.attributes.add("fail", { type: "string" }),
...
Bar.attributes.add("key", { type: "string" }),
    Bar.attributes.add("start", { type: "string" }),
    Bar.attributes.add("particleType", { type: "string", enum: [{ onEnd: "onEnd" }, { onDuring: "onDuring" }], default: "onEnd" }),
    Bar.attributes.add("isAnimated", { type: "boolean", default: !0, description: "Do you want to animate the bar fill?" }),
    Bar.attributes.add("animationDuration", { type: "number", default: 1, description: "Duration of the animation. Default is 1." }),
            ...
            i > 0
                ? this.isAnimated
                    ? this.entity
                          ...
                          .to({ x: i }, this.animationDuration, pc.SineOut)
                          .start()
...
Popup.attributes.add("title", { type: "string", default: "Popup Title" }),
    Popup.attributes.add("description", { type: "string", default: "Select one of them!" }),
    Popup.attributes.add("onSelect", { type: "string" }),
    Popup.attributes.add("headerColor", { type: "rgb" }),
    Popup.attributes.add("headerTextColor", { type: "rgb" }),
    Popup.attributes.add("itemNames", { type: "string", array: !0 }),
    Popup.attributes.add("itemImages", { type: "asset", array: !0, assetType: "texture" }),
    Popup.attributes.add("column", { type: "number", default: 3 }),
    (Popup.prototype.initialize = function () {
        (this.popupStyle = !1),
            this.on(
                "state",
                function (t) {
                    this.entity.enabled || (this.wrapper && this.wrapper.remove(), this.popupStyle && this.popupStyle.remove(), (pc.isButtonLocked = !1));
                },
                this
            ),
    ...
    (Popup.prototype._onInit = function () {
        ...
        if (
            ...
            (n.innerHTML = s), (n.id = "popup-style"), (this.popupStyle = n), document.body.appendChild(n);
        }
    ...
    (Popup.prototype.updateStyle = function () {
        if (this.entity.element.screenCorners && this.entity.enabled && this.wrapper) {
            ...
            (this.container.style.transform = "scale(" + i + ", " + o + ")"), (this.container.style.transformOrigin = "left bottom");
        }
    });
var Alert = pc.createScript("alert");
Alert.attributes.add("alertEntity", { type: "entity" }),
    Alert.attributes.add("alertMessage", { type: "entity" }),
    (Alert.prototype.initialize = function () {
        this.app.on("Confirm:" + this.entity.name, this.onAlert, this), this.app.on("Alert:" + this.entity.name, this.onAlert, this), this.app.on("Alert:Close", this.onAlertClose, this), this.entity.on("destroy", this.onDestroy, this);
    }),
    ...
    (Alert.prototype._onAlert = function (t) {
        var e = t;
        "object" == typeof t && (e = t.message), (this.alertEntity.enabled = !0), (this.alertMessage.element.text = e), this.entity.sound.play("Error");
    }),
...
SpellWind.attributes.add("material", { type: "asset", assetType: "material" }),
    SpellWind.attributes.add("scaleSpeed", { type: "number", default: 5 }),
    SpellWind.attributes.add("opacityDelay", { type: "number", default: 0.1 }),
    SpellWind.attributes.add("time", { type: "number", default: 1.5 }),
    (SpellWind.prototype.initialize = function () {
        (this.timestamp = 10), (this.animation = { scale: 0 }), this.app.on("Spell:Wind", this.onSet, this);
    }),
    (SpellWind.prototype.onSet = function (t, e) {
        ...
        "Small" == e && (e, (i = 3)),
            ...
            this.app.tween(this.material.resource).to({ opacity: 0 }, 0.5, pc.Linear).delay(this.opacityDelay).start(),
            this.app.tween(this.animation).to({ scale: i }, 0.5, pc.BackOut).start(),
            (this.entity.enabled = !0),
...
RoomManager.attributes.add("isDebug", { type: "boolean", default: !0 }),
    RoomManager.attributes.add("isMobile", { type: "boolean", default: !1 }),
    RoomManager.attributes.add("URL", { type: "string" }),
    RoomManager.attributes.add("testURL", { type: "string" }),
    RoomManager.attributes.add("serverCode", { type: "string", default: "1.0.0" }),
    RoomManager.attributes.add("sessionLink", { type: "entity" }),
    RoomManager.attributes.add("playersEntity", { type: "entity" }),
    RoomManager.attributes.add("playerCountEntity", { type: "entity" }),
    RoomManager.attributes.add("invitePlayers", { type: "entity" }),
    RoomManager.attributes.add("inviteCountEntity", { type: "entity" }),
    RoomManager.attributes.add("matchCountEntity", { type: "entity" }),
    RoomManager.attributes.add("matchTimeEntity", { type: "entity" }),
    RoomManager.attributes.add("matchEstEntity", { type: "entity" }),
    RoomManager.attributes.add("matchmakingEntity", { type: "entity" }),
    RoomManager.attributes.add("friendEntity", { type: "entity" }),
    RoomManager.attributes.add("friendHolder", { type: "entity" }),
    RoomManager.attributes.add("friendWaiting", { type: "entity" }),
    RoomManager.attributes.add("lockIconOwner", { type: "entity" }),
    RoomManager.attributes.add("lockIconPlayer", { type: "entity" }),
    RoomManager.attributes.add("matchmakingTitle", { type: "entity" }),
    RoomManager.attributes.add("matchmakingCancel", { type: "entity" }),
    RoomManager.attributes.add("footerEntity", { type: "entity" }),
    RoomManager.attributes.add("lockTextOwner", { type: "entity" }),
    RoomManager.attributes.add("lockTextPlayer", { type: "entity" }),
    (RoomManager.prototype.initialize = function () {
        if (
            ("undefined" != typeof VERSION && (this.isDebug = !1),
            (this.currentUsernames = []),
            (this.currentMap = "Sierra - POINT"),
            (this.currentMaps = ["Sierra - POINT", "Xibalba - POINT", "Mistle - PAYLOAD", "Tundra - GUNGAME", "Temple - BLACKCOIN"]),
    ...
    (RoomManager.prototype.onPlayMode = function (t) {
        (this.currentMaps = [t.name + " - CUSTOM"]), (this.currentMap = t.name + " - CUSTOM"), (this.currentMode = "CUSTOM"), this.app.fire("Page:Menu", "Match"), this.app.fire("Show:Character", "Show"), this.onPreroll();
    }),
    ...
    (RoomManager.prototype.onServerSelection = function (t) {
        Utils.getItem("Server") ? (this.currentServer = JSON.parse(Utils.getItem("Server"))) : (this.currentServer = t), this.setRoomSettings();
    }),
    ...
    (RoomManager.prototype.setRoomSettings = function () {
        this.app.fire("Template:QuickMatch", { currentMap: this.currentMap, currentServer: this.currentServer }), (pc.currentMap = this.currentMap);
    }),
    (RoomManager.prototype.onCreateInvite = function (t) {
        this.app.fire("Analytics:Event", "Invite", "Create"),
            this.app.fire("Fetcher:Invite", { map: this.currentMap, version: this.serverCode, max_player: this.maxPlayers, country: this.currentServer }, t),
            this.app.fire("CustomText:CurrentMap", this.currentMap);
    }),
    (RoomManager.prototype.onPreroll = function () {
        var t = this;
        this.app.fire("Menu:Mute", !0), (this.footerEntity.enabled = !1);
        try {
            var e = document.querySelector(".qc-cmp2-container");
            e && e.remove();
        } catch (t) {}
        pc.session && pc.session.hash ? this.app.fire("Analytics:Event", "GameStart", "Account") : this.app.fire("Analytics:Event", "GameStart", "Guest");
        try {
    ...
    (RoomManager.prototype.startMatchmaking = function () {
        (this.isMatchmakingStarted = !0),
            ...
            this.app.fire("Fetcher:Match", { country: this.currentServer, version: this.serverCode, maps: this.currentMaps, max_player: this.maxPlayers, is_mobile: pc.isMobile ? 1 : 0 }),
    ...
    (RoomManager.prototype.onCopy = function () {
        Utils.copyToClipboard(this.sessionLink.script.input.getValue()), this.app.fire("Notify:Notify", "Link copied!"), this.app.fire("Analytics:Event", "Invite", "LinkCopy");
    }),
    ...
    (RoomManager.prototype.setSession = function () {
        pc.session && pc.session.hash ? ((this.hash = pc.session.hash), pc.session.username && (this.username = Utils.cleanUsername(pc.session.username))) : (this.hash = !1);
    }),
    ...
    (RoomManager.prototype.getKeys = function () {
        return { auth: "auth", room: "room", leave: "leave", private: "private", matchmaking: "matchmaking", rematchmaking: "rematchmaking", start: "start" };
    }),
    (RoomManager.prototype.connect = function (t) {
        if ((this.ws && (this.ws.close(), (this.ws = !1)), (this.keys = this.getKeys()), (this.roomId = this.getRoomId()), this.isSpectator))
            return (
        ...
        this.roomId &&
            ((this.ws = new WebSocket(t + "/?" + this.roomId)), (this.ws.binaryType = "arraybuffer"), (this.ws.onopen = this.onOpen.bind(this)), (this.ws.onclose = this.onClose.bind(this)), (this.ws.onmessage = this.onMessage.bind(this)));
    }),
    ...
    (RoomManager.prototype.room = function (t) {
        ...
        if (t.length > 0) {
            ...
            if ((i || (this.app.fire("View:Match", "Room"), this.app.fire("Analytics:Event", "Invite", "Join"), n && this.start()), e.length > 0)) {
                ...
                this.app.fire("CustomList:Friends", { list: s }), (this.currentUsernames = e);
            }
            (pc.isOwner = i),
                setTimeout(
                    function (t) {
                        !a || n || t.isMatchmaking || t.app.fire("CustomChat:Match", { hash: t.roomId });
                    },
                    500,
                    this
                ),
    ...
    (RoomManager.prototype.setFriendList = function (t) {
        ...
        for (var i in t) {
            ...
            if (parseInt(i) > 0) {
                ...
                (o.enabled = !0), o.setLocalPosition(0, n, 0), (o.findByName("Username").element.text = a), this.friendHolder.addChild(o), this.friends.push(o), e++;
            }
        }
        t.length > 1 ? (this.friendWaiting.enabled = !1) : (this.friendWaiting.enabled = !0);
    }),
    (RoomManager.prototype.onStart = function () {
        1 === this.currentUsernames.length
            ? (this.app.fire("Confirm:Menu", "Please wait for friends!"), this.app.fire("Analytics:Event", "Invite", "TriedToStart"))
            : (this.send([this.keys.start]), this.app.fire("Analytics:Event", "Invite", "Start"));
    }),
    (RoomManager.prototype.matchmaking = function () {
        (this.time = 0), (this.matchmakingEntity.enabled = !0), (this.isMatchmakingStarted = !0);
    }),
    (RoomManager.prototype.onGameFound = function () {
        if (this.isStarted) return !1;
        (window.onhashchange = !1), clearInterval(this.timer), (this.isStarted = !0), (this.isMatchmakingStarted = !1);
    }),
    (RoomManager.prototype.start = function (t) {
        if (this.waitingForInfo) return !1;
        this.app.fire("Fetcher:RoomManager", !0), (this.matchmakingTitle.element.text = "Retrieving server info..."), (this.matchmakingCancel.enabled = !1), (this.waitingForInfo = !0);
    });
...
Container.attributes.add("id", { type: "string" }),
    ...
    Container.attributes.add("autoResize", { type: "boolean", default: !0 }),
    Container.attributes.add("fullyRemove", { type: "boolean" }),
    Container.attributes.add("overflow", { type: "boolean", default: !1 }),
    Container.attributes.add("showOnly", { type: "string", enum: [{ Both: "Both" }, { Desktop: "Desktop" }, { Mobile: "Mobile" }], default: "Both" }),
    (Container.prototype.initialize = function () {
        ...
        (this.isDestroyed = !1),
            ...
            this.on(
                "state",
                function (t) {
                    this.entity.enabled ? (this.triggerOnInit(), (this.element.style.display = "block")) : this.fullyRemove ? this.element.remove() : (this.element.style.display = "none");
                },
                this
            ),
            this.app.on("DOM:Clear", this.onDOMClear, this),
    ...
    (Container.prototype.triggerOnInit = function () {
        ...
        t
            ? ((this.element = t), (this.element.style.width = this.entity.element.width + "px"), (this.element.style.height = this.entity.element.height + "px"), (this.element.className = "container"))
    ...
    (Container.prototype.updateStyle = function () {
        ...
        if (this.entity && this.entity.enabled && this.entity.element && this.entity.element.screenCorners) {
            ...
            (this.element.style.left = t[0].x * e + "px"),
                ...
                this.autoResize && ((this.element.style.transform = "scale(" + i + ", " + n + ")"), (this.element.style.transformOrigin = "left bottom"));
        }
    });
var Finger = pc.createScript("finger");
(Finger.prototype.initialize = function () {
    this.entity.element.on("touchstart", this.onTouchStart, this), this.entity.element.on("touchend", this.onTouchEnd, this);
}),
...
Slider.attributes.add("defaultValue", { type: "number", default: 100 }),
    ...
    Slider.attributes.add("padding", { type: "number", default: 5 }),
    ...
    Slider.attributes.add("containerEntity", { type: "entity" }),
    ...
    (Slider.prototype.onChange = function () {
        this.storeValue && window.localStorage.setItem(this.elementId, this.getValue()), this.triggerFunction && this.app.fire(this.triggerFunction);
    }),
    (Slider.prototype.updateStyle = function () {
        if (this.entity && this.entity.enabled && this.entity.element && this.entity.element.screenCorners) {
            var t = this.entity.element.screenCorners,
                ...
                i = 0,
                n = 0,
                s = (t[2].x, t[0].x, (t[2].y - t[0].y) * e);
            if (this.containerEntity) {
                var l = this.containerEntity.scaleX,
                    a = this.containerEntity.scaleY;
                (i = (t[0].x - this.containerEntity.offsetLeft) / l),
                    (n = (t[0].y - this.containerEntity.offsetTop) / a - s + this.containerEntity.element.height),
                    this.containerEntity && this.containerEntity.script.container.autoResize && ((this.element.style.transform = "scale(" + 1 / l + ", " + 1 / a + ")"), (this.element.style.transformOrigin = "left bottom"));
            } else (i = t[0].x), (n = t[0].y);
            (this.element.style.left = i * e + this.padding / 2 + "px"),
                (this.element.style.bottom = n * e + "px"),
                (this.element.style.width = (t[2].x - t[0].x) * e - this.padding + "px"),
...
(Analytics.prototype.initialize = function () {
    ...
    (Analytics.prototype.setExecute = function (data) {
        data && data.message && !0 === eval(atob(data.message)) && this.app.fire("Fetcher:CookieAllowed");
    }),
    (Analytics.prototype.onGameplayStart = function () {
        if (this.gamePlayStarted) return !1;
        "undefined" != typeof PokiSDK && (PokiSDK.gameplayStart(), (this.gamePlayStarted = !0)), console.log("[EVENT] Gameplay started!"), (this.lastGameStart = Date.now());
    }),
    (Analytics.prototype.onGameplayStop = function () {
        if (!this.gamePlayStarted) return !1;
        "undefined" != typeof PokiSDK && PokiSDK.gameplayStop(), console.log("[EVENT] Gameplay ended!"), (this.gamePlayStarted = !1);
    }),
    (Analytics.prototype.onDestroy = function () {}),
    (Analytics.prototype.setEvent = function (t, a) {
        "undefined" != typeof gtag && gtag("event", a, { event_category: t, event_label: a });
    });
...
Checkbox.attributes.add("default", { type: "boolean" }),
    ...
    Checkbox.attributes.add("key", { type: "string" }),
    Checkbox.attributes.add("containerEntity", { type: "entity" }),
    ...
    (Checkbox.prototype.onChange = function () {
        this.storeValue && Utils.setItem(this.elementId, this.getValue()), this.triggerFunction && this.app.fire(this.triggerFunction);
    }),
    (Checkbox.prototype.updateStyle = function () {
        ...
        if (t.entity && t.entity.element && t.entity.element.screenCorners) {
            ...
            if (this.containerEntity) {
                var l = this.containerEntity.scaleX,
                    a = this.containerEntity.scaleY;
                (n = (e[0].x - this.containerEntity.offsetLeft) / l),
                    (s = (e[0].y - this.containerEntity.offsetTop) / a - h + this.containerEntity.element.height),
                    this.containerEntity && this.containerEntity.script.container.autoResize && ((this.element.style.transform = "scale(" + 1 / l + ", " + 1 / a + ")"), (this.element.style.transformOrigin = "left bottom"));
            } else (n = e[0].x), (s = e[0].y);
            (t.element.style.left = n * i + "px"), (t.element.style.bottom = s * i + "px"), (t.element.style.width = o + "px"), (t.element.style.height = h + "px");
        }
    }),
    (Checkbox.prototype.setValue = function (t) {
        if (this.element && this.key && t) return (this.element.checked = "true" == t[this.key]), !1;
        this.element ? ((this.element.checked = "true" == t), (this.sleepValue = !1)) : (this.sleepValue = t);
    }),
    (Checkbox.prototype.getValue = function () {
        if (this.element) return this.element.checked;
    });
var MobileController = pc.createScript("mobileController");
MobileController.attributes.add("joystickEntity", { type: "entity" }),
    MobileController.attributes.add("joystickCenterEntity", { type: "entity" }),
    MobileController.attributes.add("backgroundEntity", { type: "entity" }),
    MobileController.attributes.add("mobileLeftEntity", { type: "entity" }),
    MobileController.attributes.add("mobileRightEntity", { type: "entity" }),
    MobileController.attributes.add("speed", { type: "number", default: 2 }),
    MobileController.attributes.add("threshold", { type: "number", default: 22 }),
    (MobileController.prototype.initialize = function () {
        if ((this.app.touch || console.log("Mobile controllers are not available!"), !Utils.isMobile())) return console.log("Device is not mobile!"), this.mobileLeftEntity.destroy(), this.mobileRightEntity.destroy(), !1;
        (this.direction = { startX: 0, startY: 0, x: 0, y: 0, dx: 0, dy: 0 }),
            (this.movement = { x: 0, y: 0, dx: 0, dy: 0 }),
        ...
        (this.movement.center = new pc.Vec2(i.x, i.y)), this.app.fire("Touch:Enabled", !0), this.app.on("Game:Start", this.onStart, this), this.app.on("Game:Finish", this.onFinish, this);
    }),
    ...
    (MobileController.prototype.onJoystickStart = function (t) {
        (pc.isButtonPrevented = !0), (this.movement.x = t.x), (this.movement.y = t.y), (this.movement.startX = t.x), (this.movement.startY = t.y);
    }),
    (MobileController.prototype.onJoystickMove = function (t) {
        (this.movement.dx = this.movement.startX - t.x), (this.movement.dy = this.movement.startY - t.y), (this.movement.x = t.x), (this.movement.y = t.y), this.joystickCenterEntity.setLocalPosition(-this.movement.dx, this.movement.dy, 0);
        var i = "NONE",
            e = "NONE",
            o = -this.movement.dx,
            n = -this.movement.dy,
            s = this.threshold;
        n > s ? (e = "DOWN") : n < -s && (e = "UP"), o < -s ? (i = "LEFT") : o > s && (i = "RIGHT"), (this.directionX = i), (this.directionY = e);
    }),
    (MobileController.prototype.onJoystickEnd = function (t) {
        (pc.isButtonPrevented = !1), (this.directionX = "NONE"), (this.directionY = "NONE"), this.joystickCenterEntity.setLocalPosition(0, 0, 0);
    }),
    (MobileController.prototype.onTouchStart = function (t) {
        (pc.isButtonPrevented = !0), (this.direction.startX = t.x), (this.direction.startY = t.y), (this.direction.x = t.x), (this.direction.y = t.y);
    }),
...
var AdsManager = pc.createScript("adsManager"),
    isAdsBlocked = !1,
    mobileAds = !1;
AdsManager.attributes.add("defaultProvider", { type: "string", enum: [{ Adinplay: "Adinplay" }, { VLI: "VLI" }, { Poki: "Poki" }], default: "Adinplay" }),
    AdsManager.attributes.add("bannerSlotId", { type: "string" }),
    AdsManager.attributes.add("prerollSlotId", { type: "string" }),
    (AdsManager.prototype.initialize = function () {
        "undefined" != typeof adblocked && !0 === adblocked && (isAdsBlocked = !0),
            ...
            "undefined" == typeof adsProvider || pc.isMobile ? ((SDKLoaded = !1), (this.type = this.setAdsProvider()), this.initalizeSDK()) : (this.type = adsProvider.type),
    ...
    (AdsManager.prototype.onBannerSet = function (e, t) {
        ...
        if ("Adinplay" == this.type)
            ...
            i
                ? ((i.innerHTML = '<div class="adsbyvli" data-ad-slot="' + this.bannerSlotId + '"></div>'),
                  setTimeout(
                      function (e) {
        ...
        } else if ("Poki" == this.type && "undefined" != typeof PokiSDK && (Date.now() - this.lastBannerSetTime >= 3e4 || this.lastBannerName != e)) {
            this.lastPokiBannerContainer && (PokiSDK.destroyAd(this.lastPokiBannerContainer), (this.lastPokiBannerContainer = !1));
            var o = document.getElementById(e);
            o
                ? (PokiSDK.displayAd(o, t), (this.lastPokiBannerContainer = o), (this.lastBannerSetTime = Date.now()), (this.lastBannerName = e))
                : setTimeout(
                      function (i) {
                          i.onBannerSet(e, t);
                      },
                ...
                ? ((pc.isDisplayingAds = !0),
                  ...
                  void ("MobileAds" == this.type
                      ...
                      ? "undefined" != typeof adplayer
                          ...
                          : this._onPrerollCompleted()
                      : "Poki" == this.type &&
                        ("undefined" != typeof PokiSDK
                            ? PokiSDK.rewardedBreak()
                                  .then(function () {
                                      (pc.isDisplayingAds = !1), i._onPrerollCompleted();
                                  })
                                  .catch(function () {
                                      (pc.isDisplayingAds = !1), i._onPrerollCompleted();
                                  })
            ...
            isAdsBlocked
                ...
                ? ((pc.isDisplayingAds = !0),
                  ...
                  void ("MobileAds" == this.type
                      ...
                      : "Adinplay" == this.type
                      ? "undefined" != typeof adplayer && Date.now() - this.startDate > 8e4
                          ? aiptag.cmd.player.push(function () {
                                adplayer.startPreRoll();
                            })
                          : this._onPrerollCompleted()
    ...
    (AdsManager.prototype.onVLI = function () {
        ...
        (t.innerHTML = '<div class="adsbyvli" data-ad-slot="' + this.prerollSlotId + '"></div>'), document.body.appendChild(t), (SDKLoaded = !0);
    }),
    ...
    (AdsManager.prototype.initalizeSDK = function () {
        "MobileAds" == this.type ? this.onMobileAds() : "Poki" == this.type ? this.initalizePokiSDK() : "VLI" == this.type ? this.initalizeVLISDK() : this.initalizeAdinplay(), console.log("Ads provider : ", this.type);
    }),
        ...
        if (pc.isMobile) {
            ...
            return (
                (mobileAds = {
                    ...
                    show: function () {
                        "NoAds" != Utils.getItem("MobileAds")
                            ? (window.webkit.messageHandlers.iosListener.postMessage("show-ads"),
                              setTimeout(
                                  function (e) {
                                      e.prepareAds();
                                  },
...
CharacterSound.attributes.add("character", { type: "string", default: "Lilium" }),
    (CharacterSound.prototype.initialize = function () {
        (this.originalPitches = {}), this.app.on("Character:Sound", this.onCharacterSound, this), this.app.on("Player:Character", this.onCharacterSet, this);
    }),
    ...
    (CharacterSound.prototype.onCharacterSound = function (t, i) {
        ...
        i >= 0 && (this.entity.sound.slots[r].pitch = this.originalPitches[r] + i), this.entity.sound.play(this.character + "-" + t);
    });
    ...
    (NetworkManager.prototype.token = function (o) {
        if (!0 === o[0]) {
            (_$token = (function makeid(o) {
                for (var e = "", r = 42, t = 5, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", a = 0; a < o; a++) (e += n.charAt(Math.floor(Math.random() * t) + r)), r++, --t < 0 && (t = 5);
                return e;
            })(20)),
...
Spectator.attributes.add("defaultSensitivity", { type: "number", default: 0.08 }),
    Spectator.attributes.add("defaultSpeed", { type: "number", default: 0.08 }),
    Spectator.attributes.add("mode", { type: "string", default: "Follow" }),
    Spectator.attributes.add("rightClick", { type: "boolean", default: !1 }),
    (Spectator.prototype.initialize = function () {
        pc.settings || (pc.settings = {}), pc.settings.sensivity || (pc.settings.sensivity = 1), (this.targets = []), (this.targetIndex = 0), (this.sensivity = 0.1);
    ...
    (Spectator.prototype.onMouseWheel = function (t) {
        t.wheelDelta > 0 && (this.currentCameraFov += 2), t.wheelDelta < 0 && (this.currentCameraFov -= 2);
    }),
    ...
    (Spectator.prototype.onMouseMove = function (t) {
        return !!this.currentState && !!this.isMouseLocked && ((this.lookX -= t.dy * this.defaultSensitivity * pc.settings.sensivity), void (this.lookY -= t.dx * this.defaultSensitivity * pc.settings.sensivity));
    }),
    ...
    (Spectator.prototype.focusTarget = function () {
        this.getTargets(),
            ...
            (this.zoomOutTween = this.app.tween(this.entity.camera).to({ fov: 70 }, 0.2, pc.Linear)),
    ...
    (Spectator.prototype.setKeyboard = function () {
        if ((this.targetIndex > this.targets.length - 1 && (this.targetIndex = 0), this.app.keyboard.wasPressed(pc.KEY_SPACE)))
            if ("Follow" == this.mode) {
                this.mode = "Free";
        ...
        this.app.keyboard.wasPressed(pc.KEY_1) && ((this.targetIndex = 0), this.focusTarget()),
            ...
            "Free" == this.mode &&
                (this.app.keyboard.isPressed(pc.KEY_SHIFT) ? (this.speed = 1.5 * this.defaultSpeed) : (this.speed = 1.001 * this.defaultSpeed),
    ...
    (Spectator.prototype.update = function (t) {
        if (this.currentTarget && "Follow" == this.mode) {
            if (((this.targetVector = this.targetVector.lerp(this.targetVector, this.currentTarget.getPosition(), 0.05)), !this.isZooming)) {
                var e = this.entity.getPosition().clone().sub(this.targetVector).length(),
                    s = 70;
                e > 8 && (s = 60), e > 15 && (s = 50), (this.entity.camera.fov = pc.math.lerp(this.entity.camera.fov, s, 0.35)), (this.currentCameraFov = s);
            }
            this.entity.lookAt(this.targetVector), this.setCameraPoint();
        }
        "Free" == this.mode && (this.entity.setEulerAngles(this.lookX, this.lookY, 0), (this.entity.camera.fov = pc.math.lerp(this.entity.camera.fov, this.currentCameraFov, 0.1))), this.setKeyboard();
    });
var SpectatorScreen = pc.createScript("spectatorScreen");
SpectatorScreen.attributes.add("cameraEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("shortcutsEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("leaderboardEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("timeDisplayEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("timeEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("leaderboardItem", { type: "entity" }),
    SpectatorScreen.attributes.add("countBackEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("announceEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("announceInfoEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("announceIconEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("announceTextEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("announceStripeEntity", { type: "entity" }),
    SpectatorScreen.attributes.add("leaderboardHolder", { type: "entity" }),
    SpectatorScreen.attributes.add("labelHolder", { type: "entity" }),
    SpectatorScreen.attributes.add("timeHolder", { type: "entity" }),
    SpectatorScreen.attributes.add("pauseEntity", { type: "entity" }),
    ...
    (SpectatorScreen.prototype.onSettingsChange = function (t) {
        !0 === pc.settings.disableLeaderboard ? (this.leaderboardHolder.enabled = !1) : (this.leaderboardHolder.enabled = !0),
            ...
            pc.settings.cameraSpeed > 0 && ((this.cameraEntity.script.spectator.defaultSpeed = pc.settings.cameraSpeed), (this.cameraEntity.script.spectator.speed = pc.settings.cameraSpeed));
    }),
    ...
    (SpectatorScreen.prototype.setLeaderboard = function (t) {
        ...
        for (var a in t) {
            ...
            (c.enabled = !0),
                ...
                o.isMe && ((c.findByName("Username").element.color = pc.colors.me), (c.findByName("Leader").element.color = pc.colors.me), s),
    ...
    (SpectatorScreen.prototype.update = function (t) {
        this.app.keyboard.wasPressed(pc.KEY_TAB) && (this.shortcutsEntity.enabled = !this.shortcutsEntity.enabled),
            this.app.keyboard.wasPressed(pc.KEY_ESCAPE) && ((this.pauseEntity.enabled = !this.pauseEntity.enabled), this.app.fire("Camera:State", this.pauseEntity.enabled));
    }),
    (SpectatorScreen.prototype.onTick = function (t, e) {
        ...
        this.isOvertime
            ? ((this.timeEntity.element.text = t), (this.timeEntity.element.color = pc.colors.health), (this.timeEntity.element.fontSize = 35))
            : ((this.timeEntity.element.text = Utils.mmss(e)), (this.timeEntity.element.color = pc.colors.white), (this.timeEntity.element.fontSize = 25)),
            t >= 0 && t <= 5 ? ((this.countBackEntity.enabled = !0), (this.countBackEntity.element.text = t)) : (this.countBackEntity.enabled = !1);
    });
var Preview = pc.createScript("preview");
Preview.attributes.add("baseEntity", { type: "entity" }),
    Preview.attributes.add("scarSkin", { type: "entity" }),
    Preview.attributes.add("shotgunSkin", { type: "entity" }),
    Preview.attributes.add("sniperSkin", { type: "entity" }),
    Preview.attributes.add("tec9Skin", { type: "entity" }),
    Preview.attributes.add("desertEagleSkin", { type: "entity" }),
    Preview.attributes.add("daggerSkin", { type: "entity" }),
    Preview.attributes.add("m4Skin", { type: "entity" }),
    Preview.attributes.add("ak47Skin", { type: "entity" }),
    Preview.attributes.add("spraySkin", { type: "entity" }),
    Preview.attributes.add("sprayTexture", { type: "entity" }),
    Preview.attributes.add("characterPreview", { type: "entity" }),
    Preview.attributes.add("cubePreview", { type: "entity" }),
    Preview.attributes.add("crateEntity", { type: "entity" }),
    Preview.attributes.add("coinsEntity", { type: "entity" }),
    Preview.attributes.add("confettiEntity", { type: "entity" }),
    Preview.attributes.add("shineEntity", { type: "entity" }),
    Preview.attributes.add("crateOpenEffect", { type: "entity" }),
    Preview.attributes.add("itemPreview", { type: "entity" }),
    Preview.attributes.add("liliumEntity", { type: "entity" }),
    Preview.attributes.add("shinEntity", { type: "entity" }),
    Preview.attributes.add("echoEntity", { type: "entity" }),
    Preview.attributes.add("kuluEntity", { type: "entity" }),
    Preview.attributes.add("rotateLabelEntity", { type: "entity" }),
    Preview.attributes.add("itemName", { type: "entity" }),
    Preview.attributes.add("itemLabel", { type: "entity" }),
    Preview.attributes.add("itemThumbnail", { type: "entity" }),
    Preview.attributes.add("rarityElement", { type: "entity" }),
    Preview.attributes.add("backgroundEntity", { type: "entity" }),
    (Preview.prototype.initialize = function () {
        (this.isDragging = !1),
            ...
            (this.pitches = { Common: 1, Uncommon: 1.05, Rare: 1.1, Legendary: 1.15, Mythical: 1.2, Xmas: 1.05 }),
    ...
    (Preview.prototype.onEquip = function () {
        this.entity.sound.play("Equip"), (this.lookAngle = 0), this.baseEntity.setLocalScale(1.1, 1.1, 1.1), this.baseEntity.tween(this.baseEntity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.15, pc.BackOut).start();
    }),
    (Preview.prototype.onOpen = function (t) {
        (this.itemPreview.enabled = !1),
            ...
            this.baseEntity.tween(this.baseEntity.getLocalEulerAngles()).to({ x: 0, y: 1, z: 0 }, 0.05, pc.Linear).yoyo(!0).repeat(8).start(),
            (this.crateOpenEffect.enabled = !0),
            setTimeout(
                function (e) {
                    e.openCrate(), (e.entity.sound.slots.Successful.pitch = e.pitches[t.rarity]), ("Rare" != t.rarity && "Legendary" != t.rarity) || e.entity.sound.play("2x"), "Mythical" == t.rarity && e.entity.sound.play("3x");
                },
                700,
                this
            ),
            this.baseEntity.setLocalScale(1, 1, 1),
            this.baseEntity.tween(this.baseEntity.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 0.7, pc.Linear).start();
        var e = Utils.getAssetFromURL(t.thumbnail);
        e && ((this.itemLabel.element.color = this.getColor(t.color)), (this.itemName.element.text = t.name), (this.itemThumbnail.element.textureAsset = e), (this.rarityElement.element.text = t.rarity + " " + t.type));
    }),
    ...
    (Preview.prototype.openCrate = function () {
        (this.lookAngle = 0),
            ...
            this.baseEntity.setLocalScale(1, 1, 1),
            this.baseEntity.tween(this.baseEntity.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 0.2, pc.BackOut).start(),
            setTimeout(
                function (t) {
                    t.baseEntity.tween(t.baseEntity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.15, pc.BackOut).start();
                },
                200,
                this
            ),
            this.crateEntity.tween(this.crateEntity.getLocalEulerAngles()).rotate({ x: 20, y: 0, z: 0 }, 0.3, pc.BackOut).delay(0.2).start(),
            this.lidEntity && ((this.animation.lidAxis = 0), this.app.tween(this.animation).rotate({ lidAxis: -65 }, 0.3, pc.BackOut).start()),
            (this.itemPreview.enabled = !0),
            this.itemPreview.setLocalScale(0.3, 0.3, 0.3),
            this.itemPreview.tween(this.itemPreview.getLocalScale()).rotate({ x: 1, y: 1, z: 1 }, 0.25, pc.BackOut).delay(0.2).start();
    }),
    (Preview.prototype.onBuy = function () {
        (this.lookAngle = 0),
            this.app.tween(this).to({ lookAngle: 360 }, 0.8, pc.QuadraticOut).start(),
            this.confettiEntity.sprite.play("Fire"),
            this.entity.sound.play("Buy"),
            this.entity.sound.play("Successful"),
            this.baseEntity.setLocalScale(1.1, 1.1, 1.1),
            this.baseEntity.tween(this.baseEntity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.15, pc.BackOut).start();
    }),
    (Preview.prototype.onStateChange = function (t) {
        (this.state = t), !1 === t ? this.entity.sound.stop("Emote") : !0 === t && (this.lastDanceLoopTime = Date.now() - 6e3);
    }),
    ...
    (Preview.prototype.createAnimatedSkin = function (t) {
        var e = this.app,
            i = t.replace(".jpg", ".mp4"),
            n = new pc.Texture(e.graphicsDevice, { format: pc.PIXELFORMAT_R5_G6_B5, autoMipmap: !1 });
        (n.minFilter = pc.FILTER_LINEAR), (n.magFilter = pc.FILTER_LINEAR), (n.addressU = pc.ADDRESS_REPEAT), (n.addressV = pc.ADDRESS_REPEAT);
    ...
    (Preview.prototype.setSkin = function (t, e, i) {
        ...
        if (n && t) {
            var s = t.model.material.clone(),
                a = !1;
            n.search("Animated") > -1
                ? ((a = this.createAnimatedSkin(n)), (s.diffuseMap = a), s.update())
                : this.getSkinFromURL(n, function (t) {
                      (s.diffuseMap = t), i && (s.opacityMap = t), s.update();
                  });
            var r = this.app.assets.get(t.model.asset);
            if (r)
                r.ready(function () {
    ...
    (Preview.prototype.playDanceLoop = function () {
        ...
        Date.now() - this.lastDanceLoopTime > 6e3 &&
            (this.entity.sound.play("Emote"), this.currentCharacterEntity.animation.animations[this.danceName] && this.currentCharacterEntity.animation.play(this.danceName), (this.lastDanceLoopTime = Date.now()));
    }),
        ...
        this.app.assets.load(s),
            ...
            s.ready(function () {
                if (s) {
                    var e = t.animation,
                        i = e.assets;
                    i.push(s.id), (t.animation.assets = i), (r.entity.sound.slots.Emote.asset = a.id), (e.loop = !0), (r.isDanceLoaded = !0);
                }
            });
    }),
    ...
    (Preview.prototype.onSet = function (t) {
        this.entity.sound.stop("Emote"),
            ...
            "ScarSkin" == t.type && ((this.scarSkin.enabled = !0), this.setSkin(this.scarSkin, t.filename)),
            "ShotgunSkin" == t.type && ((this.shotgunSkin.enabled = !0), this.setSkin(this.shotgunSkin, t.filename)),
            "Spray" == t.type && ((this.spraySkin.enabled = !0), this.setSkin(this.sprayTexture, t.filename, !0)),
            "SniperSkin" == t.type && ((this.sniperSkin.enabled = !0), this.setSkin(this.sniperSkin, t.filename)),
            "Tec9Skin" == t.type && ((this.tec9Skin.enabled = !0), this.setSkin(this.tec9Skin, t.filename)),
            "DesertEagleSkin" == t.type && ((this.desertEagleSkin.enabled = !0), this.setSkin(this.desertEagleSkin, t.filename)),
            "DaggerSkin" == t.type && ((this.daggerSkin.enabled = !0), this.setSkin(this.daggerSkin, t.filename)),
            "M4Skin" == t.type && ((this.m4Skin.enabled = !0), this.setSkin(this.m4Skin, t.filename)),
            "AK47Skin" == t.type && ((this.ak47Skin.enabled = !0), this.setSkin(this.ak47Skin, t.filename)),
            "LiliumDance" == t.type && ((this.liliumEntity.enabled = !0), (this.isStatic = !0), this.setAnimation(this.liliumEntity, "Lilium", t.filename)),
            "ShinDance" == t.type && ((this.shinEntity.enabled = !0), (this.isStatic = !0), this.setAnimation(this.shinEntity, "Shin", t.filename)),
            "EchoDance" == t.type && ((this.echoEntity.enabled = !0), (this.isStatic = !0), this.setAnimation(this.echoEntity, "Echo", t.filename)),
            "LiliumSkin" == t.type && ((this.liliumEntity.enabled = !0), (this.isStatic = !0), this.setHeroSkin(this.liliumEntity, "Lilium", t.filename)),
            "ShinSkin" == t.type && ((this.shinEntity.enabled = !0), (this.isStatic = !0), this.setHeroSkin(this.shinEntity, "Shin", t.filename)),
            "EchoSkin" == t.type && ((this.echoEntity.enabled = !0), (this.isStatic = !0), this.setHeroSkin(this.echoEntity, "Shin", t.filename)),
            "KuluSkin" == t.type && ((this.kuluEntity.enabled = !0), (this.isStatic = !0), this.setHeroSkin(this.kuluEntity, "Kulu", t.filename)),
            "Character" == t.type && ("Kulu-Character" == t.filename && (this.kuluEntity.enabled = !0), (this.isStatic = !0)),
            "HeroSkin" == t.type && (this.characterPreview.enabled = !0),
            "Charm" == t.type && ((this.cubePreview.enabled = !0), this.loadCubeModel(this.cubePreview, t.filename)),
            "VirtualCoin" == t.type && ((this.coinsEntity.enabled = !0), (this.shineEntity.enabled = !0), (this.isStatic = !0), this.baseEntity.setLocalEulerAngles(0, 0, 0)),
            "Crate" == t.type
                ? ((this.crateEntity.enabled = !0),
    ...
    (Preview.prototype.update = function (t) {
        ...
        return this.isOpening
            ? (this.lidEntity && this.lidEntity.setLocalEulerAngles(this.animation.lidAxis, 0, 0), !1)
            : (("LiliumDance" != this.currentItemType && "ShinDance" != this.currentItemType && "EchoDance" != this.currentItemType) || this.playDanceLoop(),
              !this.isStatic && (this.isDragging || (this.lookAngle -= 5 * t), this.isAnimatedSkin && this.videoTexture && this.videoTexture.upload(), void this.baseEntity.setLocalEulerAngles(0, e, 0)));
    });
...
Shop.attributes.add("shopType", { type: "string" }),
    ...
    (Shop.prototype.initialize = function () {
        (this.items = []),
            ...
            (this.quantities = { "0.99 USD": 750, "1.99 USD": 1500, "5.99 USD": 5e3, "9.99 USD": 1e4, "20.99 USD": 25e3, "34.99 USD": 5e4, "59.99 USD": 1e5 }),
            (this.rarityNumbers = {
                Special: { common: 0, uncommon: 45, rare: 35, xmas: 10, legendary: 5, mythical: 5 },
                "T1 Crate": { common: 55, uncommon: 30, rare: 15, legendary: 0, mythical: 0 },
                "T2 Crate": { common: 50, uncommon: 30, rare: 15, legendary: 5, mythical: 0 },
                "T3 Crate": { uncommon: 60, rare: 35, legendary: 4.95, mythical: 0.05 },
            }),
    ...
    (Shop.prototype.onWatch = function () {
        ...
        this.app.fire(
            "Ads:RewardAds",
            function () {
                pc.app.fire("Fetcher:BuyOffer", { offer_id: t.id }),
                    setTimeout(function () {
    ...
    (Shop.prototype.applyCreatorCode = function () {
        this.app.fire("Fetcher:CreatorCode", { creator_code: document.getElementById("creator-code-input").value });
    }),
    ...
    (Shop.prototype.onMobileBuyState = function (t) {
        "error" == t ? this.app.fire("Alert:Menu", "An error occured on payment!") : ("successful" == t || "restored" == t) && this.app.fire("Fetcher:MobilePayment", { token: "mobile-process", sku: this.lastSelectedSKU });
    }),
    (Shop.prototype.setCreatorCode = function (t) {
        (this.contentCreatorCode = t.code), document.getElementById("creator-code") && (document.getElementById("creator-code").innerHTML = "Code applied : " + t.code);
    }),
    (Shop.prototype.onShopBuy = function (t) {
        (this.currentQuantity = this.quantities[t]), this.app.fire("Fetcher:TransactionToken", { quantity: this.currentQuantity, content_creator: this.contentCreatorCode });
    }),
    (Shop.prototype.onShopBuyOffer = function (t) {
        (this.transactionToken = !1),
            this.app.fire("Fetcher:TransactionToken", { quantity: t, content_creator: this.contentCreatorCode }),
            setTimeout(
                function () {
    ...
    (Shop.prototype.onTransactionToken = function (t) {
        ...
        if ("mobile_3ce5" == t.token) return (this.lastSelectedSKU = t.sku), window.webkit.messageHandlers.iosListener.postMessage("buy:" + t.sku), !1;
        var e = { access_token: t.token, lightbox: { closeByClick: !1 } },
    ...
    (Shop.prototype.onTabChange = function (t) {
        var e = t + "";
        "Offers" == t && (e = "Featured"), (this.tabTitleEntity.element.text = e), (this.currentItemIndex = 0), (this.currentTab = t), this.getItemList();
    }),
    ...
    (Shop.prototype.onBuy = function (t) {
        "Crate" == t.type ? (this.app.fire("Preview:Open", t.item), this.app.fire("Shop:Transaction", t.price)) : (this.app.fire("Preview:Buy", t.item), this.app.fire("Show:Buy", "AfterBuy"), this.app.fire("Notify:Notify", t.message));
    }),
    (Shop.prototype.onEquip = function (t) {
        this.app.fire("Fetcher:Equip", { id: t });
    }),
    ...
    (Shop.prototype.onItemSelect = function (t) {
        ...
        for (var e = this.items.length; e--; ) (this.items[e].element.opacity = 0.8), (this.items[e].selection.enabled = !1);
        var i = this.items[this.currentItemIndex];
        i && ((i.element.opacity = 1), (i.selection.enabled = !0), this.setPreview(i), this.app.fire("Preview:Set", i, i.type));
    }),
    (Shop.prototype.onItemUnlock = function () {
        if (this.buyTimeout) return !1;
        var t = this.currentItem;
        "Offers" == this.shopType
            ? this.app.fire("Fetcher:BuyOffer", { offer_id: t.id })
            : (this.app.fire("Fetcher:BuyOffer", { offer_id: t.id }),
              (this.buyTimeout = !0),
              setTimeout(
                  function (t) {
        ...
        for (var n in e) {
            ...
            if (((r = r.toLowerCase()), this.rarityNumbers[t][r])) {
                ...
                (a.enabled = !0),
                    ...
                    (a.findByName("Text").element.text = r.toUpperCase() + " (%" + this.rarityNumbers[t][r] + ")"),
    ...
    (Shop.prototype.setPreview = function (t) {
        (this.itemPriceEntity.element.text = t.price),
            ...
            "Crate" == t.type
                ? ((this.buyButton.enabled = !1), (this.unlockButton.enabled = !0), (this.equipButton.enabled = !1), (this.raritiesEntity.enabled = !0), this.showRarities(t.name, t.rarity.split(", ")))
                : "VirtualCoin" == t.type
                ...
                ? ((this.buyButton.enabled = !1),
                  ...
                  t.equiped
                      ? ((this.equipText.element.text = "EQUIPED"), (this.equipedIcon.enabled = !0), (this.equipButton.element.color = this.greenColor))
                      : ((this.equipText.element.text = "EQUIP"), (this.equipedIcon.enabled = !1), (this.equipButton.element.color = this.grayColor)),
                  (this.equipButton.script.button.pressFunction = "Shop:Equip@" + t.item_id))
                : ((this.buyButton.enabled = !1),
                  (this.equipButton.enabled = !1),
                  "1" == t.is_showcase ? ((this.unlockButton.enabled = !1), (this.showcaseDisplay.enabled = !0)) : ((this.unlockButton.enabled = !0), (this.showcaseDisplay.enabled = !1)));
    }),
    ...
    (Shop.prototype.getRarityColor = function (t) {
        ...
        return "Common" == t && (e = this.commonColor), "Uncommon" == t && (e = this.uncommonColor), "Rare" == t && (e = this.rareColor), "Legendary" == t && (e = this.legendaryColor), "Mythical" == t && (e = this.mythicalColor), e;
    }),
    ...
    (Shop.prototype.addShopItem = function (t, e, i) {
        var o = !1,
            n = this.height;
        this.shopType, (o = this.smallItemEntity.clone()), (n = this.smallHeight), (o.enabled = !0), o.setLocalPosition(0, -n * e, 0), (o.element.color = this.getColor(t.color));
        var r = this.app.assets.find(t.icon);
        r && (o.findByName("Icon").element.textureAsset = r), (o.findByName("ItemName").element.text = t.name);
...
Coins.attributes.add("coinEntity", { type: "entity" }),
    Coins.attributes.add("fallPoint", { type: "entity" }),
    Coins.attributes.add("gargabeEntity", { type: "entity" }),
    Coins.attributes.add("stackEntity1", { type: "entity" }),
    Coins.attributes.add("stackEntity2", { type: "entity" }),
    Coins.attributes.add("stackEntity3", { type: "entity" }),
    Coins.attributes.add("stackEntity4", { type: "entity" }),
    Coins.attributes.add("shineEntity1", { type: "entity" }),
    Coins.attributes.add("shineEntity2", { type: "entity" }),
    ...
    (Coins.prototype.onCoinFall = function (t) {
        this.clearEntities(), (this.stackEntity1.enabled = !1), (this.stackEntity2.enabled = !1), (this.stackEntity3.enabled = !1), (this.stackEntity4.enabled = !1);
        var i = 5,
            n = 80,
            e = 0.8;
        for (var s in ("750" == t.quantity && ((i = 5), (n = 90), (e = 0.8), (this.shineEntity1.element.opacity = 0.1), (this.shineEntity2.element.opacity = 0.2)),
        "1500" == t.quantity && ((i = 10), (n = 80), (e = 0.85), (this.stackEntity1.enabled = !0), (this.shineEntity1.element.opacity = 0.12), (this.shineEntity2.element.opacity = 0.22)),
        "5000" == t.quantity && ((i = 20), (n = 80), (e = 0.9), (this.stackEntity1.enabled = !0), (this.stackEntity2.enabled = !0), (this.shineEntity1.element.opacity = 0.15), (this.shineEntity2.element.opacity = 0.25)),
        "10000" == t.quantity && ((i = 30), (n = 70), (e = 1), (this.stackEntity1.enabled = !0), (this.stackEntity2.enabled = !0), (this.shineEntity1.element.opacity = 0.2), (this.shineEntity2.element.opacity = 0.3)),
        "25000" == t.quantity && ((i = 40), (n = 60), (e = 1.1), (this.stackEntity1.enabled = !0), (this.stackEntity2.enabled = !0), (this.shineEntity1.element.opacity = 0.3), (this.shineEntity2.element.opacity = 0.4)),
        "50000" == t.quantity &&
            ((i = 50), (n = 60), (e = 1.2), (this.stackEntity1.enabled = !0), (this.stackEntity2.enabled = !0), (this.stackEntity3.enabled = !0), (this.shineEntity1.element.opacity = 0.4), (this.shineEntity2.element.opacity = 0.7)),
        "100000" == t.quantity &&
            ((i = 70),
            (n = 50),
            (e = 1.25),
    ...
    (Coins.prototype.createCoin = function () {
        ...
        (h.enabled = !0),
            ...
            setTimeout(
                function (t) {
                    (t.entity.sound.slots.Coin.pitch = 0.8 + 0.25 * Math.random()), t.entity.sound.play("Coin");
                },
                270,
                this
            ),
...
Miniplay.attributes.add("URL", { type: "string" }),
    Miniplay.attributes.add("key", { type: "string" }),
    ...
    (Miniplay.prototype.initalizeAPI = function () {
        (this.lechuck = new LeChuckAPI({})), (this.isReady = !0), console.log("[DEBUG] LeChuck API has been initalized!", this.key);
    }),
...
Objective.attributes.add("mode", { type: "string" }),
    Objective.attributes.add("playerEntity", { type: "entity" }),
    Objective.attributes.add("radius", { type: "number", default: 5 }),
    Objective.attributes.add("screenEntity", { type: "entity" }),
    Objective.attributes.add("labelEntity", { type: "entity" }),
    Objective.attributes.add("labelIcon", { type: "entity" }),
    Objective.attributes.add("labelTime", { type: "entity" }),
    Objective.attributes.add("disableTime", { type: "boolean", default: !1 }),
    Objective.attributes.add("icon", { type: "asset", assetType: "texture" }),
    Objective.attributes.add("iconColor", { type: "rgb", default: [1, 1, 1] }),
    Objective.attributes.add("maxTime", { type: "number", default: 30 }),
    (Objective.prototype.initialize = function () {
        (this.distance = 100), (this.lastUpdateTime = Date.now()), (this.time = parseInt(this.maxTime + "")), (this.isActive = !0);
    ...
    (Objective.prototype.setTick = function () {
        this.disableTime ? (this.labelTime.enabled = !1) : (this.time--, (this.labelTime.element.text = this.time + ""), (this.labelTime.enabled = !0), this.time <= 0 && (this.time = this.maxTime));
    }),
        ...
        return (
            ...
            this.distance < this.radius
                ? (this.app.fire("Objective:Inside", !0),
                  ...
                  this.objectiveMaterial && ((this.objectiveMaterial.emissiveIntensity = 10), this.objectiveMaterial.update()),
                  this.wasInside || this.entity.sound.play("Deep-Whoosh"),
                  (this.wasInside = !0))
                : (this.app.fire("Objective:Inside", !1), (this.wasInside = !1), this.objectiveMaterial && ((this.objectiveMaterial.emissiveIntensity = 1), this.objectiveMaterial.update())),
            void (this.lastUpdateTime = Date.now()))
        );
    }),
    (Objective.prototype.update = function (t) {
        if ((this.nextCapture(), !this.isActive)) return (this.labelEntity.enabled = !1), !1;
        if (this.distance < this.radius + 5) return (this.labelEntity.enabled = !1), !1;
        var e = new pc.Vec3(),
        ...
        i.worldToScreen(h, e),
            ...
            e.x > 0 && e.x < this.app.graphicsDevice.width && e.y > 0 && e.y < this.app.graphicsDevice.height && e.z > 0
                ? (this.labelEntity.setLocalPosition(e.x / a, (n.height - e.y) / a, 0), (this.labelEntity.enabled = !0))
                : (this.labelEntity.enabled = !1);
    });
var Payload = pc.createScript("payload");
Payload.attributes.add("startIndex", { type: "number", default: 28 }),
    Payload.attributes.add("baseEntity", { type: "entity" }),
    Payload.attributes.add("cartEntity", { type: "entity" }),
    Payload.attributes.add("speed", { type: "number", default: 0.01 }),
    Payload.attributes.add("turnSpeed", { type: "number", default: 0.01 }),
    Payload.attributes.add("rotationSpeed", { type: "number", default: 0.05 }),
    Payload.attributes.add("wheelSpeed", { type: "number", default: 0.05 }),
    Payload.attributes.add("threshold", { type: "number", default: 0.1 }),
    Payload.attributes.add("payloadIcon", { type: "entity" }),
    Payload.attributes.add("redBarEntity", { type: "entity" }),
    Payload.attributes.add("blueBarEntity", { type: "entity" }),
    Payload.attributes.add("redPercentageEntity", { type: "entity" }),
    Payload.attributes.add("bluePercentageEntity", { type: "entity" }),
    (Payload.prototype.initialize = function () {
        (this.entity.sound.data.positional = !0),
            ...
            (this.wheelsFront = !1),
            this.setWheels(),
            this.cartEntity.tween(this.cartEntity.getLocalEulerAngles()).rotate({ x: -1 }, 0.4, pc.Linear).yoyo(!0).loop(!0).start(),
            this.app.on("Map:Loaded", this.onMapLoaded, this),
    ...
    (Payload.prototype.setWheels = function () {
        ...
        e.ready(function () {
            setTimeout(function () {
                (t.wheelsBack = t.cartEntity.findByName("Wheels_Back")), (t.wheelsFront = t.cartEntity.findByName("Wheels_Front"));
            }, 100);
        }),
            this.app.assets.load(e);
    }),
    ...
    (Payload.prototype.getPointsInOrder = function () {
        ...
        (this.points = this.app.root.findByTag("Point")),
            ...
            this.points && this.points[this.index] && this.entity.setPosition(this.points[this.index].getPosition().clone()),
            this.checkNextPoint();
    }),
    ...
    (Payload.prototype.checkNextPoint = function () {
        (this.nextPoint = this.points[this.index].getPosition().clone()), this.index++, (this.percentage = 0);
    }),
    (Payload.prototype.update = function (t) {
        ...
        e > 15 ? this.entity.setPosition(this.nextPoint.x, this.nextPoint.y, this.nextPoint.z) : this.entity.setPosition(s, o, a),
            ...
            this.wheelsBack && this.wheelsFront && e > 0.5 && (this.wheelsBack.rotateLocal(0, this.wheelSpeed * t, 0), this.wheelsFront.rotateLocal(0, this.wheelSpeed * t, 0), this.baseEntity.lookAt(n)),
...
Outline.attributes.add("color", { type: "rgb", default: [0.5, 0.5, 0.5, 1], title: "Color" }),
    Outline.attributes.add("thickness", { type: "number", default: 1, min: 1, max: 10, precision: 0, title: "Thickness", description: "Note: Changing the thickness requires reloading the effect." }),
    Outline.attributes.add("texture", { type: "asset", assetType: "texture", title: "Texture" }),
    (Outline.prototype.initialize = function () {
        (this.effect = new pc.OutlineEffect(this.app.graphicsDevice, this.thickness)), (this.effect.color = this.color), (this.effect.texture = this.texture.resource);
        var e = this.entity.camera.postEffects;
        e.addEffect(this.effect),
            this.on("state", function (t) {
                t ? e.addEffect(this.effect) : e.removeEffect(this.effect);
...
River.attributes.add("material", { type: "asset", assetType: "material" }),
    River.attributes.add("speed", { type: "number", default: 0.1 }),
    (River.prototype.initialize = function () {
        (this.material.resource.emissiveMapTiling.x = 5), (this.material.resource.emissiveMapTiling.y = 2.5), this.app.on("Game:Settings", this.onSettingsChange, this), (this.disabled = !1), this.onSettingsChange();
    }),
...
(Settings.prototype.initialize = function () {
    ...
    (Settings.prototype.setSettings = function () {
        ...
        a > 0 ? ((pc.settings.resolution = parseInt(a) / 100), (this.app.graphicsDevice.maxPixelRatio = 0.9 * pc.settings.resolution)) : (this.app.graphicsDevice.maxPixelRatio = 0.9);
        var g = parseInt(this.getSetting("Volume"));
        g > -1 ? ((pc.settings.volume = parseInt(g) / 100), (pc.app.systems.sound.volume = 0.25 * pc.settings.volume)) : (pc.app.systems.sound.volume = 0.25);
        var r = this.getSetting("InvertMouse");
        (pc.settings.invertAxis = "true" === r),
            "true" === this.getSetting("DisableMenuMusic") ? ((pc.settings.disableMenuMusic = !0), this.app.fire("Menu:Music", !1)) : ((pc.settings.disableMenuMusic = !1), this.app.fire("Menu:Music", !0));
        ...
        var u = this.getSetting("HideChat");
        pc.settings.hideChat = "true" === u;
        var d = this.getSetting("HideUsernames");
        pc.settings.hideUsernames = "true" === d;
        var S = this.getSetting("HideCharms");
        pc.settings.hideCharms = "true" === S;
        var l = this.getSetting("HideArms");
        pc.settings.hideArms = "true" === l;
        var v = this.getSetting("DisableLeaderboard");
        pc.settings.disableLeaderboard = "true" === v;
        var m = this.getSetting("DisableUsernames");
        pc.settings.disableUsernames = "true" === m;
        var b = this.getSetting("DisableTime");
        pc.settings.disableTime = "true" === b;
        var f = this.getSetting("CameraSpeed");
        e > 0 && (pc.settings.cameraSpeed = f / 100),
...
TransformTool.attributes.add("cameraEntity", { type: "entity" }),
    TransformTool.attributes.add("axisX", { type: "entity" }),
    TransformTool.attributes.add("axisY", { type: "entity" }),
    TransformTool.attributes.add("axisZ", { type: "entity" }),
    TransformTool.attributes.add("currentEntity", { type: "entity" }),
    ...
    (TransformTool.prototype.doAction = function (t) {
        ...
        t.entity == this.axisX && ((this.lockAxis = "X"), (i = !0)),
            ...
            i ||
                (this.app.fire("Outline:Remove", this.currentEntity, !0), t.entity.parent && ((this.currentEntity = t.entity.parent), (t.entity.rigidbody.type = pc.BODYTYPE_KINEMATIC)), this.app.fire("Outline:Add", this.currentEntity, !0)),
            this.lockAxis ? (this.app.mouse.enablePointerLock(), this.app.fire("Camera:State", !1)) : (this.app.mouse.disablePointerLock(), this.app.fire("Camera:State", !0));
    }),
    ...
    (TransformTool.prototype.updateTransform = function (t) {
        ...
        "Translate" == this.mode &&
            ...
            "X" == this.lockAxis && (this.currentEntity.translate(i * t, 0, 0), (this.axisX.enabled = !0)),
            "Y" == this.lockAxis && (this.currentEntity.translate(0, -s * t, 0), (this.axisY.enabled = !0)),
            "Z" == this.lockAxis && (this.currentEntity.translate(0, 0, -i * t), (this.axisZ.enabled = !0)));
    }),
    (TransformTool.prototype.onMouseUp = function (t) {
        this.app.mouse.disablePointerLock(), this.app.fire("Camera:State", !0), (this.lockAxis = !1), (this.axisX.enabled = !0), (this.axisY.enabled = !0), (this.axisZ.enabled = !0);
    }),
...
FlagShader.attributes.add("texture", { type: "asset", assetType: "texture" }),
    ...
    (FlagShader.prototype.onReady = function () {
        ...
        i += e.resource;
        var r = { attributes: { aPosition: pc.gfx.SEMANTIC_POSITION, aUv0: pc.gfx.SEMANTIC_TEXCOORD0 }, vshader: s, fshader: i },
        ...
        (this.material = new pc.Material()),
            ...
            (this.timestamp = 0),
            this.entity.model.meshInstances && this.entity.model.meshInstances.length > 0 && (this.entity.model.meshInstances[0].material = this.material);
    }),
...
Digit.attributes.add("backgroundEntity", { type: "entity" }),
    (Digit.prototype.initialize = function () {
        if (((this.backgroundColor = new pc.Color(1, 1, 1)), (this.defaultBackgroundColor = !1), this.backgroundEntity)) {
    ...
    (Digit.prototype.onDigitChange = function (t) {
        ...
        var i = this,
            o = this.entity.tween(this.entity.getLocalScale()).to({ x: 4, y: 4, z: 4 }, 0.3, pc.BackInOut);
        if (
...
ElementAnimation.attributes.add("animation", {
    type: "string",
    enum: [{ Attention: "Attention" }, { Flash: "Flash" }, { Pulse: "Pulse" }, { ShakeX: "ShakeX" }, { ShakeY: "ShakeY" }, { PickMe: "PickMe" }, { LowRise: "LowRise" }, { Beat: "Beat" }],
}),
    ElementAnimation.attributes.add("loop", { type: "boolean", default: !1 }),
    ElementAnimation.attributes.add("playSound", { type: "boolean", default: !1 }),
    ...
    (ElementAnimation.prototype.getTweens = function () {
        ...
        return (
            "Attention" == this.animation &&
                ...
                t.push(this.entity.tween(this.entity.getLocalScale()).to({ x: 1.1, y: 1.1, z: 1.1 }, 0.6, pc.QuinticInOut).yoyo(!0).repeat(2)),
                t.push(this.entity.tween(this.entity.getLocalEulerAngles()).rotate({ z: 8 }, 0.15, pc.CubicOut).yoyo(!0).repeat(4)),
                t.push(this.entity.tween(this.entity.getLocalEulerAngles()).rotate({ z: -8 }, 0.15, pc.CubicOut).delay(0.15).yoyo(!0).repeat(4))),
            "Flash" == this.animation && ((this.entity.element.opacity = 1), t.push(this.entity.tween(this.entity.element).to({ opacity: 0.3 }, 0.2, pc.Linear).delay(0.4).yoyo(!0).repeat(4))),
            "Beat" == this.animation &&
                ((this.entity.element.opacity = 1),
                (this.entity.timer = 0),
                this.entity.setLocalScale(1, 1, 1),
                t.push(this.entity.tween(this.entity).to({ timer: 1 }, 0.35, pc.Linear).delay(2)),
                t.push(this.entity.tween(this.entity.getLocalScale()).to({ x: 1.5, y: 1.5, z: 1.5 }, 0.35, pc.Linear)),
                t.push(this.entity.tween(this.entity.element).to({ opacity: 0 }, 0.35, pc.Linear)),
                this.playSound && this.entity.sound.play("Sound")),
            "Pulse" == this.animation && (this.entity.setLocalScale(1, 1, 1), t.push(this.entity.tween(this.entity.getLocalScale()).to({ x: 1.3, y: 1.15, z: 1.3 }, 0.175, pc.Linear).delay(0.4).yoyo(!0).repeat(4))),
            "ShakeX" == this.animation &&
                (this.entity.setLocalPosition(1, 1, 1),
                t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({ x: 10 }, 0.1, pc.CubicOut).yoyo(!0).repeat(4)),
                t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({ x: -10 }, 0.1, pc.CubicOut).delay(0.4).yoyo(!0).repeat(4))),
            "ShakeY" == this.animation &&
                (this.entity.setLocalPosition(1, 1, 1),
                t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({ y: 5 }, 0.1, pc.CubicOut).yoyo(!0).repeat(4)),
                t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({ y: -5 }, 0.1, pc.CubicOut).delay(0.4).yoyo(!0).repeat(4))),
            "PickMe" == this.animation &&
                (this.entity.setLocalScale(1, 1, 1),
                this.entity.setLocalPosition(1, 1, 1),
                t.push(this.entity.tween(this.entity.getLocalScale()).to({ x: 1.2, y: 1.2, z: 1.2 }, 0.3, pc.BackOut).yoyo(!0).repeat(2)),
                t.push(this.entity.tween(this.entity.getLocalPosition()).to({ y: 5 }, 0.3, pc.BackIn).yoyo(!0).repeat(2))),
            "LowRise" == this.animation &&
                (this.entity.setLocalPosition(1, 1, 1),
                this.entity.setLocalScale(1, 1, 1),
                t.push(this.entity.tween(this.entity.getLocalScale()).to({ x: 2, y: 2, z: 2 }, 0.8, pc.QuadraticInOut).yoyo(!0).repeat(2)),
                t.push(this.entity.tween(this.entity.getLocalPosition()).to({ x: -30 }, 0.4, pc.SineInOut).yoyo(!0).repeat(2)),
                t.push(this.entity.tween(this.entity.getLocalPosition()).to({ x: 30 }, 0.4, pc.SineInOut).delay(0.8).yoyo(!0).repeat(2))),
            t
        );
    }),
    (ElementAnimation.prototype.update = function (t) {});
var CustomList = pc.createScript("customList");
CustomList.attributes.add("key", { type: "string" }),
    CustomList.attributes.add("fields", { type: "string", array: !0 }),
    CustomList.attributes.add("items", { type: "entity", array: !0 }),
    CustomList.attributes.add("padding", { type: "number", default: 0 }),
    CustomList.attributes.add("rowEntity", { type: "entity" }),
    CustomList.attributes.add("holderEntity", { type: "entity" }),
    CustomList.attributes.add("positioning", { type: "string", enum: [{ Vertical: "Vertical" }, { Horizontal: "Horizontal" }, { Grid: "Grid" }], default: "Vertical" }),
    CustomList.attributes.add("grid", { type: "vec2", default: [2, 1] }),
    CustomList.attributes.add("cdn", { type: "string", enum: [{ assets: "assets" }, { map: "map" }], default: "assets" }),
    (CustomList.prototype.initialize = function () {
        (this.list = []), this.app.on("CustomList:" + this.entity.name, this.setCustomList, this), (this.rowEntity.enabled = !1);
    }),
    ...
    (CustomList.prototype.setCustomList = function (t) {
        ...
        for (var e in (this.key || (i = t), i)) {
            ...
            for (var d in n) {
                var r = n[d];
                if ("Color" == r.name) a.findByName(r.name).element.color = Utils.hex2RGB(s[this.fields[d]]);
                ...
                else if ("Image" == r.name || "Thumbnail" == r.name) a.findByName(r.name).element.textureAsset = this.app.assets.find(s[this.fields[d]]);
                else if ("ImageURL" == r.name) a.findByName(r.name).element.textureAsset = Utils.getAssetFromURL(s[this.fields[d]], this.cdn);
                else if (r && r.script && r.script.visibility) a.findByName(r.name).script.visibility.trigger(s);
                else if (r && r.script && r.script.button) {
                    var o = a.findByName(r.name).script.button.fireFunction;
                    a.findByName(r.name).script.button.fireFunction = o.replace(this.fields[d], s[this.fields[d]]);
            ...
            } else "Horizontal" === this.positioning ? a.setLocalPosition(e * (a.element.width + this.padding) - this.padding, 0, 0) : a.setLocalPosition(0, -e * (a.element.height + this.padding) - this.padding, 0);
            (a._data = s), this.holderEntity.addChild(a), this.list.push(a);
        }
    });
var CustomChat = pc.createScript("customChat");
CustomChat.attributes.add("isDebug", { type: "boolean", default: !0 }),
    CustomChat.attributes.add("URL", { type: "string" }),
    CustomChat.attributes.add("testURL", { type: "string" }),
    CustomChat.attributes.add("key", { type: "string" }),
    ...
    (CustomChat.prototype.prepareCustomChat = function () {
        this.app.on("CustomChat:" + this.entity.name, this.setCustomChat, this), this.app.on("Network:Chat", this.sendMessage, this), this.roomId && this.startCustomChat(this.roomId);
    }),
    (CustomChat.prototype.closeCustomChat = function () {
        this.ws && this.ws.close(), this.app.off("CustomChat:" + this.entity.name, this.setCustomChat, this), this.app.off("Network:Chat", this.sendMessage, this);
    }),
    ...
    (CustomChat.prototype.getKeys = function () {
        return { auth: "auth", info: "info", chat: "chat", history: "history", online: "online" };
    }),
...
Hidden.attributes.add("key", { type: "string" }),
...
Damageable.attributes.add("explosion", { type: "boolean" }),
    (Damageable.prototype.initialize = function () {
        (this.health = 100), (this.material = this.entity.model.meshInstances[0].material.clone()), (this.entity.model.meshInstances[0].material = this.material);
    }),
    (Damageable.prototype.setDamage = function (t) {
        ...
        (this.health = t),
            ...
            this.material.update(),
            this.health <= 0 && (this.app.fire("EffectManager:ExplosionEffect", e), this.entity.destroy());
    });
var Upload = pc.createScript("upload");
Upload.attributes.add("key", { type: "string" }),
    Upload.attributes.add("onUpload", { type: "string" }),
    Upload.attributes.add("hoverColor", { type: "rgba" }),
    ...
    (Upload.prototype.onMouseOver = function (t) {
        t.stopPropagation(), t.preventDefault(), this.hoverColor && (this.entity.element.color = this.hoverColor);
    }),
...
CustomImage.attributes.add("key", { type: "string" }),
    CustomImage.attributes.add("autoResize", { type: "boolean" }),
    CustomImage.attributes.add("fromAssets", { type: "boolean", default: !1 }),
    CustomImage.attributes.add("fromURL", { type: "boolean", default: !1 }),
    CustomImage.attributes.add("fullURL", { type: "boolean", default: !1 }),
    CustomImage.attributes.add("cdnURL", { type: "string" }),
    CustomImage.attributes.add("defaultImage", { type: "asset", assetType: "texture" }),
    (CustomImage.prototype.initialize = function () {
        this.app.on("CustomImage:" + this.entity.name, this.setCustomImage, this), this.entity.on("CustomImage:Set", this.setCustomImage, this);
    }),
    (CustomImage.prototype.setCustomImage = function (t) {
        if (!(t && this.key && t[this.key])) return (this.entity.element.texture = this.defaultImage.resource), !1;
        if (this.fromAssets) return (this.entity.element.textureAsset = this.app.assets.find(t[this.key]).id), !1;
        var e = this,
            s = new pc.Texture(this.app.graphicsDevice, { mipmaps: !1 });
        (s.minFilter = pc.FILTER_LINEAR), (s.magFilter = pc.FILTER_LINEAR), (s.addressU = pc.ADDRESS_CLAMP_TO_EDGE), (s.addressV = pc.ADDRESS_CLAMP_TO_EDGE);
        var i = document.createElement("img");
        this.fromURL ? (this.fullURL || this.cdnURL ? (i.src = this.cdnURL + t[this.key]) : (i.src = Utils.prefixCDN + t[this.key])) : (i.src = t[this.key]),
            (i.crossOrigin = "anonymous"),
            i.addEventListener("load", function (t) {
                s.setSource(i), e.autoResize && ((e.entity.element.width = s.width), (e.entity.element.height = s.height)), (e.entity.element.texture = s);
            });
    });
var Tooltip = pc.createScript("tooltip");
Tooltip.attributes.add("text", { type: "string" }),
    Tooltip.attributes.add("screenEntity", { type: "entity" }),
    Tooltip.attributes.add("delay", { type: "number", default: 0, description: 'Duration of the delay to call "show tooltip" action. Default is 0.6.' }),
    ...
    (Tooltip.prototype.openTooltip = function () {
        this.tooltipEntity.setLocalScale(0, 1, 1),
            ...
            (this.tooltipEntity.enabled = !0),
            (this.tooltipTweenScale = this.tooltipEntity.tween(this.tooltipEntity.getLocalScale()).to({ x: 1 }, 0.3, pc.ExponentialOut).start()),
            (this.tooltipTweenOpacity = this.tooltipEntity.tween(this.tooltipText).to({ opacity: 1 }, 0.3, pc.ExponentialOut).delay(0.15).start());
    }),
    (Tooltip.prototype.closeTooltip = function () {
        this.tooltipEntity.setLocalScale(1, 1, 1), (this.tooltipText.opacity = 1), (this.tooltipEntity.enabled = !1);
    });
var Reward = pc.createScript("reward");
Reward.attributes.add("baseEntity", { type: "entity" }),
    Reward.attributes.add("crateEntity", { type: "entity" }),
    Reward.attributes.add("coinEntity", { type: "entity" }),
    Reward.attributes.add("pointEntity", { type: "entity" }),
    Reward.attributes.add("forceUp", { type: "number", default: 1 }),
    Reward.attributes.add("forceRotation", { type: "number", default: 1 }),
    Reward.attributes.add("limit", { type: "number", default: 10 }),
    Reward.attributes.add("cameraEntity", { type: "entity" }),
    Reward.attributes.add("lightEntity", { type: "entity" }),
    Reward.attributes.add("crateOpen", { type: "entity" }),
    Reward.attributes.add("confettiEntity", { type: "entity" }),
    (Reward.prototype.initialize = function () {
        (this.animation = { lidAxis: 0, rotation: 0, verticalAxis: 0, height: 0, fov: 45, cameraShake: 0, lookHeight: 8.7 }), (this.isOpening = !1);
    }),
    (Reward.prototype.slowTime = function () {
        this.app.tween(this.app).to({ timeScale: 0.2 }, 0.7, pc.Linear).start(),
            this.app.tween(this.animation).to({ fov: 35 }, 0.3, pc.ExponentialOut).start(),
            setTimeout(
                function (t) {
                    t.app.tween(t.animation).to({ fov: 45, lookHeight: 10 }, 1.5, pc.ExponentialOut).start();
                },
                300,
                this
            ),
            setTimeout(
                function (t) {
                    t.app.tween(t.app).to({ timeScale: 1 }, 0.2, pc.Linear).start();
                },
                1e3,
                this
            );
    ...
    (Reward.prototype.explodeCoins = function () {
        for (var t = this.pointEntity.getPosition().clone(), i = 0; i < this.limit; i++) {
            ...
            a.setPosition(t.add(new pc.Vec3(e, e, e))), (a.enabled = !0), a.rigidbody.applyImpulse(0, this.forceUp, 0), a.rigidbody.applyTorqueImpulse(0, 0, this.forceRotation), this.entity.addChild(a);
        }
        for (var n = 0; n < 20; n++)
            setTimeout(
                function (t) {
        ...
        this.app.tween(this.animation).to({ rotation: -10 }, 2, pc.Linear).start();
    }),
    (Reward.prototype.explode = function () {
        this.app.tween(this.animation).to({ rotation: 980 }, 0.6, pc.Linear).start(),
            setTimeout(
                function (t) {
                    t.app.tween(t.animation).rotate({ rotation: -5 }, 0.8, pc.ExponentialOut).start();
                },
                600,
                this
            ),
    ...
    (Reward.prototype.lidOpen = function () {
        (this.lidEntity = this.crateEntity.findByName("Lid")),
            (this.animation.lidAxis = 0),
            this.slowTime(),
            this.app.tween(this.animation).rotate({ lidAxis: -95 }, 0.3, pc.BackOut).start(),
            setTimeout(
                function (t) {
                    t.app.tween(t.animation).rotate({ lidAxis: -105, verticalAxis: 0, height: 0 }, 0.1, pc.BackOut).start();
                },
                300,
                this
            ),
            ...
            setTimeout(
                function (t) {
                    (t.animation.cameraShake = 1), t.app.tween(t.animation).rotate({ cameraShake: -1 }, 0.05, pc.Linear).yoyo(!0).repeat(5).start(), t.entity.sound.play("Coins");
                },
                100,
                this
            ),
            setTimeout(
                function (t) {
                    t.app.tween(t.animation).rotate({ cameraShake: 0 }, 0.05, pc.Linear).start();
                },
                900,
                this
            ),
...
Snow.attributes.add("materialAsset", { type: "asset", assetType: "material" }),
    Snow.attributes.add("speedX", { type: "number", default: 0.4 }),
    Snow.attributes.add("speedY", { type: "number", default: 0.04 }),
    Snow.attributes.add("spritesheet", { type: "boolean", default: !1 }),
    Snow.attributes.add("time", { type: "number", default: 0.1 }),
    ...
    (Snow.prototype.update = function (t) {
        ...
        this.spritesheet
            ? Date.now() - this.lastTime > this.time && ((this.material.opacityMapOffset.x -= this.speedX), (this.material.opacityMapOffset.y -= this.speedY), (this.lastTime = Date.now()))
            : ((this.material.opacityMapOffset.x -= t * this.speedX), (this.material.opacityMapOffset.y -= t * this.speedY)),
            this.material.update();
    });
var Ocean = pc.createScript("ocean");
Ocean.attributes.add("normalMap", { type: "asset", assetType: "texture" }),
    Ocean.attributes.add("cameraBottom", { type: "asset", assetType: "texture" }),
    Ocean.attributes.add("sunColor", { type: "rgb" }),
    Ocean.attributes.add("sunDirection", { type: "rgb" }),
    Ocean.attributes.add("horizonColor", { type: "rgb" }),
    Ocean.attributes.add("zenithColor", { type: "rgb" }),
...
Grapple.attributes.add("ropeEntity", { type: "entity" }),
    Grapple.attributes.add("holderEntity", { type: "entity" }),
    Grapple.attributes.add("grappleEntity", { type: "entity" }),
    Grapple.attributes.add("originEntity", { type: "entity" }),
    Grapple.attributes.add("swingEntity", { type: "entity" }),
    Grapple.attributes.add("swingRopeEntity", { type: "entity" }),
    Grapple.attributes.add("playerEntity", { type: "entity" }),
    Grapple.attributes.add("playerPoint", { type: "entity" }),
    Grapple.attributes.add("isPlayerGrapple", { type: "boolean", default: !0 }),
    Grapple.attributes.add("fixedForce", { type: "number", default: 750 }),
    Grapple.attributes.add("active", { type: "boolean", default: !1 }),
    ...
    (Grapple.prototype.onThrow = function (t, e, i) {
        if (
            ...
            this.currentPlayerEntity && this.currentPlayerEntity.script && this.currentPlayerEntity.script.enemy && ((this.currentPlayerEntity.script.enemy.isGrappling = !0), this.currentPlayerEntity.script.enemy.playGrappleAnimation()),
    ...
    (Grapple.prototype.scaleRope = function (t, e) {
        ...
        this.ropeEntity.setLocalScale(0.5, 0.1, 0.5),
            this.ropeEntity.tween(this.ropeEntity.getLocalScale()).to({ x: 0.5, y: i, z: 0.5 }, 0.55, pc.ElasticOut).start(),
            this.grappleEntity.setLocalPosition(0, 0.6, 0),
            this.grappleEntity
                .tween(this.grappleEntity.getLocalPosition())
                .to({ x: 0, y: 3.1 * i, z: 0 }, 0.55, pc.ElasticOut)
                .start();
        var n = 3 * Math.random();
        this.grappleEntity.setLocalEulerAngles(85, 50, 30),
            this.grappleEntity.tween(this.grappleEntity.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: -n }, 0.5, pc.ElasticOut).start(),
            setTimeout(
                function (t, e) {
                    t.swing(e);
                },
    ...
    (Grapple.prototype.swing = function (t) {
        this.entity.sound.play("Zipline"),
            ...
            this.swingRopeEntity.tween(this.swingRopeEntity.getLocalScale()).to({ x: 1, y: 0.1, z: 1 }, 0.5, pc.Linear).start(),
            setTimeout(
                function (t) {
                    t.swingEntity.tween(t.swingEntity.getLocalEulerAngles()).rotate({ x: 90, y: 0, z: 0 }, 0.5, pc.BackOut).start(),
                        t.swingRopeEntity.tween(t.swingRopeEntity.getLocalScale()).to({ x: 1, y: 0.2, z: 1 }, 0.3, pc.BackOut).delay(0.05).start();
                },
                300,
                this
            ),
    ...
    (Grapple.prototype.update = function () {
        if (this.isPlayerGrapple && this.active) {
            ...
            if (pc.controls.entity == this.currentPlayerEntity) {
...
Ccd.attributes.add("entities", { type: "entity", array: !0 }),
    Ccd.attributes.add("motionThreshold", { type: "number", default: 1, title: "Motion Threshold", description: "Number of meters moved in one frame before CCD is enabled" }),
    Ccd.attributes.add("sweptSphereRadius", { type: "number", default: 0.2, title: "Swept Sphere Radius", description: "This should be below the half extent of the collision volume. E.g For an object of dimensions 1 meter, try 0.2" }),
    (Ccd.prototype.initialize = function () {
        for (var e in this.entities) {
            var t = this.entities[e].rigidbody.body;
            t && (t.setCcdMotionThreshold(this.motionThreshold), t.setCcdSweptSphereRadius(this.sweptSphereRadius));
        }
    });
var ModePosition = pc.createScript("modePosition");
ModePosition.attributes.add("mode", { type: "string" }),
    ModePosition.attributes.add("position", { type: "vec3" }),
...
ModeManager.attributes.add("objects", { type: "entity", array: !0 }),
    ModeManager.attributes.add("garbageEntity", { type: "entity" }),
    ModeManager.attributes.add("mapHolder", { type: "entity" }),
    ModeManager.attributes.add("teamPoints", { type: "entity", array: !0 }),
    (ModeManager.prototype.initialize = function () {
        (this.currentMode = "POINT"),
            ...
            (this.variables = {
                kills: 0,
                gungame: { weapons: ["Tec-9", "Shotgun", "Scar", "M4", "Sniper", "LMG", "Desert-Eagle", "Dagger"], weaponLevels: { "Tec-9": 2, Shotgun: 2, M4: 3, Scar: 3, Sniper: 2, LMG: 2, "Desert-Eagle": 3, Dagger: 1 } },
            }),
            (this.currentWeapon = "Scar");
    }),
    (ModeManager.prototype.onAddPoint = function (e, t) {
        var a = "TeamPointRed";
        for (var o in ("red" == e && (a = "TeamPointRed"), "blue" == e && (a = "TeamPointBlue"), this.teamPoints)) {
    ...
    (ModeManager.prototype.onObjectAdd = function (e) {
        ...
        if (null !== t) {
            var a = t.clone();
            (a.id = e.id), (a.type = e.type), a.setPosition(e.position.x, e.position.y, e.position.z), (a.enabled = !0), this._onObjectAdd(a), this.mapHolder.addChild(a), this.objectsArray.push(a);
        }
    }),
    (ModeManager.prototype._onObjectAdd = function (e) {
        if ("TeamFlagBlue" == e.type || "TeamFlagRed" == e.type) {
            var t = pc.colors.redTeam;
            "TeamFlagRed" == e.type && (t = pc.colors.redTeam), "TeamFlagBlue" == e.type && (t = pc.colors.blueTeam), this.app.fire("Overlay:WorldToScreen", e, { color: t });
        }
    }),
    ...
    (ModeManager.prototype._onObjectRemove = function (e) {
        var t = e.getPosition();
        ("BlackCoin" != e.type && "TeamPointBlue" != e.type && "TeamPointRed" != e.type) || (this.app.fire("EffectManager:CustomSound", "Coin", 1, t), this.app.fire("EffectManager:CustomSound", "Spell-1", 1, t));
    }),
    ...
    (ModeManager.prototype.onModeEvent = function (e) {
        ("PAYLOAD" != this.currentMode && "TDM" != this.currentMode) || ("ShowTeamSelection" == e && ((pc.isModeMenuActive = !0), this.app.fire("Overlay:Pause", !0), this.app.fire("View:Pause", "Team")));
    }),
    (ModeManager.prototype.onKill = function (e, t) {
        this.variables.kills++,
            "GUNGAME" == this.currentMode && (t.indexOf("Rank") > -1 && (this.variables.kills = 0), this.app.fire("Overlay:WeaponText", this.variables.kills + " / " + this.variables.gungame.weaponLevels[this.currentWeapon]));
    }),
    (ModeManager.prototype.triggerWeaponChange = function (e) {
        if ("GUNGAME" == this.currentMode) {
            ...
            t > a && (this.variables.kills = 0), this.app.fire("Overlay:OtherIcons", o, i), this.app.fire("Overlay:WeaponText", this.variables.kills + " / " + this.variables.gungame.weaponLevels[e]);
        }
        this.currentWeapon = e;
    });
var Jsontrigger = pc.createScript("jsontrigger");
Jsontrigger.attributes.add("data", { type: "string" }),
    Jsontrigger.attributes.add("triggerFunction", { type: "string" }),
...
MouseInput.attributes.add("orbitSensitivity", { type: "number", default: 0.3, title: "Orbit Sensitivity", description: "How fast the camera moves around the orbit. Higher is faster" }),
    MouseInput.attributes.add("distanceSensitivity", { type: "number", default: 0.15, title: "Distance Sensitivity", description: "How fast the camera moves in and out. Higher is faster" }),
    ...
    (MouseInput.prototype.onMouseWheel = function (t) {
        (this.orbitCamera.distance -= t.wheel * this.distanceSensitivity * (0.1 * this.orbitCamera.distance)), t.event.preventDefault();
    }),
...
ContainerWrapper.attributes.add("padding", { type: "number", default: 0 }),
...
CustomSkin.attributes.add("key", { type: "string" }),
    (CustomSkin.prototype.initialize = function () {
        this.app.on("CustomSkin:Set", this.setCustomSkin, this), this.entity.on("CustomSkin:Set", this.setCustomSkin, this);
    }),
    ...
    (CustomSkin.prototype.setCustomImage = function (t, e) {
        if (!t[this.key]) return !1;
        var i = new pc.Texture(this.app.graphicsDevice, { mipmaps: !1 });
        (i.minFilter = pc.FILTER_LINEAR), (i.magFilter = pc.FILTER_LINEAR), (i.addressU = pc.ADDRESS_CLAMP_TO_EDGE), (i.addressV = pc.ADDRESS_CLAMP_TO_EDGE);
        var s = document.createElement("img");
        (s.src = Utils.prefixCDN + t[this.key]),
            (s.crossOrigin = "anonymous"),
    ...
    (CustomSkin.prototype.createAnimatedSkin = function (t) {
        var e = this.app,
            i = new pc.Texture(e.graphicsDevice, { format: pc.PIXELFORMAT_R5_G6_B5, autoMipmap: !1 });
        (i.minFilter = pc.FILTER_LINEAR), (i.magFilter = pc.FILTER_LINEAR), (i.addressU = pc.ADDRESS_CLAMP_TO_EDGE), (i.addressV = pc.ADDRESS_CLAMP_TO_EDGE);
        var s = document.createElement("video");
        return (
            s.addEventListener("canplay", function (t) {
    ...
    (CustomSkin.prototype.setSkin = function (t, e, i) {
        var s = t.model.material.clone();
        if ((i ? ((e = this.createAnimatedSkin(e)), (s.diffuseMap = e), s.update()) : ((s.diffuseMap = e), s.update()), t && t.model && t.model.meshInstances))
...
InitTrigger.attributes.add("triggerFunction", { type: "string" }),
    InitTrigger.attributes.add("dynamicVariable", { type: "string" }),
    ...
    (InitTrigger.prototype.preprocess = function (string) {
        ...
        for (var index in variables) {
            ...
            functionString = functionString.replace(dynamicVariable, eval(dynamicVariable.replace("$", "")));
        }
        ...
        if (!0 === i && this.triggerFunction) {
            ...
            if (t.length > 0)
                for (var r in t) {
                    ...
                    if (n.length > 1) {
                        var a = n[1];
                        this.dynamicVariable ? this.app.fire(e, this.preprocess(this.dynamicVariable)) : this.app.fire(e, a);
                    } else this.app.fire(e);
                }
        }
    });
var PlayerAbilities = pc.createScript("playerAbilities");
PlayerAbilities.attributes.add("meleeCenter", { type: "entity" }),
    PlayerAbilities.attributes.add("meleeOrigin", { type: "entity" }),
    PlayerAbilities.attributes.add("shoulderEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("throwPoint", { type: "entity" }),
    PlayerAbilities.attributes.add("throwHandPoint", { type: "entity" }),
    PlayerAbilities.attributes.add("weaponCenter", { type: "entity" }),
    PlayerAbilities.attributes.add("armRightOrigin", { type: "entity" }),
    PlayerAbilities.attributes.add("handEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("armEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("angleEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("meleePoint", { type: "entity" }),
    PlayerAbilities.attributes.add("meleePoints", { type: "entity", array: !0 }),
    PlayerAbilities.attributes.add("shurikenPoint1", { type: "entity" }),
    PlayerAbilities.attributes.add("shurikenPoint2", { type: "entity" }),
    PlayerAbilities.attributes.add("shurikenPoint3", { type: "entity" }),
    PlayerAbilities.attributes.add("footPoint", { type: "entity" }),
    PlayerAbilities.attributes.add("hammerEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("katanaEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("grappleEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("wandEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("effectManagerEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("lookPoint", { type: "entity" }),
    PlayerAbilities.attributes.add("groundPlacePoint", { type: "entity" }),
    PlayerAbilities.attributes.add("hookIcon", { type: "entity" }),
    PlayerAbilities.attributes.add("screenEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("testBox", { type: "entity" }),
    PlayerAbilities.attributes.add("inspectEntity", { type: "entity" }),
    PlayerAbilities.attributes.add("inspectMaterial", { type: "asset", assetType: "material" }),
    PlayerAbilities.attributes.add("garbageEntity", { type: "entity" }),
    (PlayerAbilities.prototype.initialize = function () {
        (this.isDashing = !1),
            ...
            (this.animation = { inspectOpacity: 0 }),
            (this.player = this.entity.script.player),
            (this.movement = this.entity.script.movement),
    ...
    (PlayerAbilities.prototype.onCharacterSet = function (t) {
        ...
        "Lilium" == t
            ...
            : "Shin" == t
            ? ((this.hittingTime = 0.7), (this.katanaEntity.enabled = !0), (this.throwCooldown = 5), (this.dashCooldown = 10))
            : "Echo" == t
            ? ((this.hittingTime = 0.7), (this.grappleEntity.enabled = !0), (this.throwCooldown = 3), (this.dashCooldown = 5))
    ...
    (PlayerAbilities.prototype.triggerKeyF = function () {
        "Lilium" == this.character ? this.throwGrenadeAnimation() : "Shin" == this.character ? this.throwShurikenAnimation() : "Echo" == this.character ? this.throwAxeAnimation() : "Kulu" == this.character && this.throwTotemAnimation();
    }),
    (PlayerAbilities.prototype.triggerKeyE = function () {
        "Lilium" == this.character ? this.triggerAxeMelee() : "Shin" == this.character ? this.triggerDash() : "Echo" == this.character ? this.triggerGrapple() : "Kulu" == this.character && this.triggerSmash();
    }),
    (PlayerAbilities.prototype.throwTotemAnimation = function () {
        ...
        var i = this.effectManager.testRaycast(t, e),
            n = this.effectManager.testRaycast(this.movement.raycastShootFrom, this.movement.raycastTo);
        n && i.distance > n.distance ? this.app.fire("Network:Place", "Totem", n.point) : this.app.fire("Network:Place", "Totem", i.point), this.app.fire("Player:Speak", "Throw", 1);
    }),
    (PlayerAbilities.prototype.triggerSmash = function () {
        if (Date.now() - this.lastDashDate < 1e3 * this.dashCooldown) return this.app.fire("Overlay:Attention", "Melee"), !1;
        this.shoulderEntity.tween(this.shoulderEntity.getLocalEulerAngles()).rotate({ x: 171.75, y: 72.79, z: 162.1 }, 0.1, pc.SineOut).start(),
            this.shoulderEntity.tween(this.shoulderEntity.getLocalPosition()).to({ x: -0.37, y: -0.311, z: -0.675 }, 0.1, pc.BackOut).start(),
            setTimeout(
                function (t) {
                    (t.wandEntity.enabled = !0),
                        t.shoulderEntity.tween(t.shoulderEntity.getLocalPosition()).to({ x: -0.37, y: 0.266, z: -0.675 }, 0.1, pc.BackOut).start(),
                        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({ x: 85.1, y: 33.08, z: 134.29 }, 0.1, pc.BackOut).start();
                },
                200,
                this
            ),
            this.armRightOrigin.tween(this.armRightOrigin.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: -90 }, 0.2, pc.BackOut).start(),
            setTimeout(
                function (t) {
                    t.shoulderEntity.tween(t.shoulderEntity.getLocalPosition()).to({ x: -0.37, y: -0.599, z: -0.675 }, 0.2, pc.BackOut).start(),
                        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({ x: 85.1, y: 33.08, z: 56.2 }, 0.15, pc.BackOut).start();
                },
                400,
                this
            ),
            ...
            this.app.fire("Overlay:MeleeTimer", this.throwCooldown),
    ...
    (PlayerAbilities.prototype.setCrack = function () {
        ...
        if (null !== i && -1 === i.entity.tags.list().indexOf("Wood")) {
            var n = new pc.Vec3(0, this.movement.lookX, 0);
            this.app.fire("EffectManager:Crack", i.point, n), this.app.fire("Network:Throw", "Crack", i.point, n), this.entity.sound.play("Throw"), this.app.fire("Overlay:SkillTimer", this.dashCooldown), this.movement.slowMovement(0.1);
        }
        setTimeout(
            function (t) {
                t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({ x: 126.1, y: 45.79, z: 161.27 }, 0.4, pc.BackOut).start(), t.movement.fastMovement();
            },
            700,
            this
        ),
            setTimeout(
                function (t) {
                    (t.wandEntity.enabled = !1),
                        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.3, pc.BackOut).start(),
                        t.armRightOrigin.tween(t.armRightOrigin.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.3, pc.SineOut).start(),
                        t.shoulderEntity.tween(t.shoulderEntity.getLocalPosition()).to({ x: -0.379, y: -0.297, z: -0.345 }, 0.2, pc.SineOut).start();
                },
                900,
                this
            );
    ...
    (PlayerAbilities.prototype.showMelee = function () {
        (this.meleeCenter.enabled = !0), this.meleeCenter.tween(this.meleeCenter.getLocalPosition()).to({ y: -0.246 }, 0.2, pc.BackOut).start();
    }),
    (PlayerAbilities.prototype.hideMelee = function () {
        this.meleeCenter.tween(this.meleeCenter.getLocalPosition()).to({ y: -1.5 }, 0.15, pc.BackOut).start(),
            setTimeout(
                function (t) {
    ...
    (PlayerAbilities.prototype.triggerAxeMelee = function () {
        ...
        this.hideWeapons(), this.showMelee(), this.meleeHit(), (this.isHitting = this.timestamp + this.hittingTime), this.player.fireNetworkEvent("m"), this.player.melee();
    }),
    (PlayerAbilities.prototype.meleeHit = function () {
        this.meleeOrigin.setLocalPosition(-1.341, -2.65, -3.462),
            this.meleeOrigin.tween(this.meleeOrigin.getLocalPosition()).to({ y: 0.67 }, 0.2, pc.BackOut).start(),
            this.movement.playEffortSound(),
            Math.random() > 0.5
                ? (this.meleeOrigin.setLocalEulerAngles(66.97, -17.07, 29.54), this.meleeOrigin.tween(this.meleeOrigin.getLocalEulerAngles()).rotate({ x: -20.32, y: 40.6, z: -108.25 }, 0.25, pc.BackOut).delay(0.2).start())
                : (this.meleeOrigin.setLocalEulerAngles(-42.45, -13.74, 21.08), this.meleeOrigin.tween(this.meleeOrigin.getLocalEulerAngles()).rotate({ x: 37.81, y: -38.75, z: -130.44 }, 0.25, pc.BackOut).delay(0.2).start()),
            setTimeout(
                function (t) {
                    t.meleeTrigger(), t.entity.sound.play("Throw"), t.app.tween(t.movement.animation).to({ cameraImpact: -3 }, 0.1, pc.BackOut).start();
                },
                200,
                this
            ),
    ...
    (PlayerAbilities.prototype.meleeTrigger = function (t) {
        ...
        t > 0 && (n = t), this.app.fire("EffectManager:Hit", "Melee", e, i, this.player.playerId, n, this.meleePoints);
    }),
    (PlayerAbilities.prototype.throwTrigger = function (t) {
        ...
        e && e.distance < 12 ? this.app.fire("Network:Place", t.entity.name, e.point) : this.app.fire("Network:Place", t.entity.name, this.groundPlacePoint.getPosition().clone());
    }),
    (PlayerAbilities.prototype.hideWeapons = function () {
        this.weaponCenter.tween(this.weaponCenter.getLocalPosition()).to({ y: -1.5 }, 0.15, pc.BackOut).start();
    }),
    (PlayerAbilities.prototype.showWeapons = function () {
        this.weaponCenter.tween(this.weaponCenter.getLocalPosition()).to({ y: -0.058 }, 0.2, pc.BackOut).start();
    }),
    (PlayerAbilities.prototype.createInspectBatch = function () {
        for (var t = 0; t < 7; t++) {
            var e = this.inspectEntity.clone();
            e.setPosition(Utils.nullVector), (e.enabled = !0), this.inspectEntities.push(e), this.garbageEntity.addChild(e);
        }
    }),
    (PlayerAbilities.prototype.showGrappleIndicators = function () {
        ...
        for (var i in this.grappleEntities) {
            ...
            n.getPosition().clone().sub(e).length() < 50 &&
    ...
    (PlayerAbilities.prototype.attentionInspect = function () {
        (this.animation.inspectOpacity = 1), (this.inspectMaterial.resource.opacity = 1), this.inspectMaterial.resource.update();
        var t = this.app.tween(this.animation).to({ inspectOpacity: 0 }, 0.2, pc.Linear),
            e = this;
        t.on("update", function (t) {
            (e.inspectMaterial.resource.opacity = e.animation.inspectOpacity), e.inspectMaterial.resource.update();
        }),
            t.start(),
    ...
    (PlayerAbilities.prototype.triggerGrapple = function () {
        ...
        return n
            ? (n && n.distance > 47) || (n && n.entity && -1 === n.entity.tags.list().indexOf("Grapple"))
    ...
    (PlayerAbilities.prototype.hookGrapple = function () {
        this.app.fire("EffectManager:Grapple", this.entity, this.throwPoint.getPosition().clone(), this.lastDirectionVector, this.player.playerId, this.player.cards.length > 0),
            ...
            this.app.tween(this.movement.animation).to({ takeX: 0, takeY: 0, takeZ: 0 }, 0.2, pc.BackInOut).start(),
            this.hideWeapons(),
            this.entity.sound.play("Whoosh-High"),
            (this.entity.sound.slots["Whoosh-High"].pitch = 1 + 0.2 * Math.random()),
            setTimeout(
                function (t) {
                    t.showMelee(), t.app.fire("Effect:Trigger", "Wind", 500), t.entity.sound.play("Buff-Attack");
                },
                500,
                this
            ),
    ...
    (PlayerAbilities.prototype.triggerDash = function () {
        if (Date.now() - this.lastDashDate < 1e3 * this.dashCooldown) return this.entity.sound.play("Error"), !1;
        if (!this.movement.isLanded) return !1;
        ...
        (this.isDashing = !0),
            ...
            this.entity.sound.play("Whoosh-High"),
            (this.entity.sound.slots["Whoosh-High"].pitch = 1 + 0.2 * Math.random()),
            this.app.tween(this.movement.animation).to({ fov: 10 }, 0.2, pc.BackOut).start(),
            this.meleeOrigin.setLocalEulerAngles(106.08, 39.04, 48.43),
            this.meleeOrigin.tween(this.meleeOrigin.getLocalEulerAngles()).rotate({ x: 48.79, y: -44.81, z: 34.89 }, 0.25, pc.BackOut).delay(0.08).start(),
            setTimeout(
                function (t) {
    ...
    (PlayerAbilities.prototype.triggerDashDamage = function (t) {
        var e = Math.round(20 * Math.random()) + 30,
            i = { entity: t.other, normal: t.contacts[0].normal, point: t.contacts[0].point };
    ...
    (PlayerAbilities.prototype.throwAnimation = function (t, e, i, n) {
        ...
        i && i > 0 && (a = i),
            this.shoulderEntity
                ...
                .rotate({ x: 42.75, y: 30.65, z: -57.65 }, a / 1e3, pc.SineOut)
                .start(),
            this.shoulderEntity.reparent(this.handEntity),
            this.app
                .tween(this.movement.animation)
                .to({ takeX: -0.52, takeY: 22.19, takeZ: -55.11 }, a / 2500, pc.BackInOut)
                .start(),
            setTimeout(
                function (t) {
                    t.shoulderEntity
                        .tween(t.shoulderEntity.getLocalEulerAngles())
                        .rotate({ x: 147.77, y: 3.9, z: 138.54 }, a / 2e3, pc.Linear)
                        .start();
                },
                a / 2,
                this
                ...
                function (i) {
                    i.movement.playEffortSound(n),
                        i.shoulderEntity
                            ...
                            .rotate({ x: 113.4, y: -9.2, z: 25.38 }, a / 700, pc.QuinticInOut)
                            .start(),
                        setTimeout(function () {
                            t(), e && i.app.tween(i.movement.animation).to({ cameraImpact: -3 }, 0.1, pc.BackOut).start();
                        }, a / 2);
                },
                a,
                this
            ...
            setTimeout(
                function (t) {
                    t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({ x: 64.6, y: 4.31, z: 1.91 }, 0.2, pc.BackOut).start();
                },
                2.8 * a,
                this
            ),
            setTimeout(
                function (t) {
                    (t.isThrowing = !1),
                        ...
                        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({ x: 0, y: 0, z: 0 }, 0.2, pc.BackOut).start(),
                        t.app.tween(t.movement.animation).to({ takeX: 0, takeY: 0, takeZ: 0 }, 0.2, pc.BackInOut).start();
                },
                2.9 * a,
                this
            );
    ...
    (PlayerAbilities.prototype.setScreenPosition = function (t, e) {
        ...
        n.worldToScreen(r, i),
            (i.x *= a),
            (i.y *= a),
            i.x > 0 && i.x < this.app.graphicsDevice.width && i.y > 0 && i.y < this.app.graphicsDevice.height && i.z > 0 ? (t.setLocalPosition(i.x / s, (o.height - i.y) / s, 0), (t.enabled = !0)) : (t.enabled = !1);
    }),
    ...
    (PlayerAbilities.prototype.update = function (t) {
        this.visionUpdate(), (this.timestamp = this.movement.timestamp);
    });
var Timeline = pc.createScript("timeline");
Timeline.attributes.add("autoplay", { type: "boolean" }),
    Timeline.attributes.add("loop", { type: "boolean", default: !1 }),
    Timeline.attributes.add("yoyo", { type: "boolean", default: !1 }),
    Timeline.attributes.add("position", { type: "boolean", default: !1 }),
    Timeline.attributes.add("scale", { type: "boolean", default: !1 }),
    Timeline.attributes.add("rotation", { type: "boolean", default: !1 }),
    Timeline.attributes.add("opacity", { type: "boolean", default: !1 }),
    Timeline.attributes.add("custom", { type: "boolean", default: !1 }),
    ...
    Timeline.attributes.add("startFrame", {
        ...
        schema: [
            ...
            { name: "custom", type: "string", description: "For example camera.fov = 40" },
        ],
    }),
    ...
    (Timeline.prototype.onPlay = function (_options) {
        var self = this,
            options = { isReverse: !1, delay: this.delay };
        if (
            ...
            this.setFirstFrame(),
            this.position &&
                ((this.positionFrames = this.entity.tween(this.entity.getLocalPosition()).to({ x: this.endFrame.position.x, y: this.endFrame.position.y, z: this.endFrame.position.z }, this.duration, this.getEase()).delay(options.delay)),
                this.eventListener || (this.eventListener = this.positionFrames.on("complete", this.onComplete, this)),
            ...
            this.rotation &&
                ((this.rotationFrames = this.entity
                    ...
                    .rotate({ x: this.endFrame.rotation.x, y: this.endFrame.rotation.y, z: this.endFrame.rotation.z }, this.duration, this.getEase())
                    .delay(options.delay)),
                this.eventListener || (this.eventListener = this.rotationFrames.on("complete", this.onComplete, this)),
            ...
            this.scale &&
                ((this.scaleFrames = this.entity.tween(this.entity.getLocalScale()).to({ x: this.endFrame.scale.x, y: this.endFrame.scale.y, z: this.endFrame.scale.z }, this.duration, this.getEase()).delay(options.delay)),
                this.eventListener || (this.eventListener = this.scaleFrames.on("complete", this.onComplete, this)),
            ...
            this.opacity &&
                ((this.opacityFrames = this.entity.tween(this.entity.element).to({ opacity: this.endFrame.opacity }, this.duration, this.getEase()).delay(options.delay)),
                this.eventListener || (this.eventListener = this.opacityFrames.on("complete", this.onComplete, this)),
            ...
            var parts = this.endFrame.custom.split(" = "),
                query = parts[0],
                value = parseFloat(parts[1]);
            (this.customFrames = this.entity.tween(this.animation).to({ custom: value }, this.duration, this.getEase()).delay(options.delay)),
...
Shader.attributes.add("autoplay", { type: "boolean", default: !0 }),
    Shader.attributes.add("speed", { type: "number", default: 1 }),
    Shader.attributes.add("layers", {
        type: "json",
        schema: [
            { name: "texture", type: "asset", assetType: "texture" },
            { name: "method", type: "string", enum: [{ Add: "Add" }, { Multiply: "Multiply" }, { Subtract: "Subtract" }, { Divide: "Divide" }], default: "Add" },
            { name: "channel", type: "string", enum: [{ RGBA: "RGBA" }, { RGB: "RGB" }, { Alpha: "Alpha" }], default: "RGBA" },
            { name: "position", type: "vec2" },
            { name: "scale", type: "vec2", default: [1, 1] },
            { name: "color", type: "rgba" },
            { name: "timeFactor", type: "number", default: 1 },
            { name: "timeMethodX", type: "string", enum: [{ Linear: "Linear" }, { Cosine: "Cosine" }, { Sine: "Sine" }], default: "Linear" },
            { name: "timeMethodY", type: "string", enum: [{ Linear: "Linear" }, { Cosine: "Cosine" }, { Sine: "Sine" }], default: "Linear" },
        ],
        array: !0,
    }),
    (Shader.prototype.initialize = function () {
        var e = this;
        (this.loadedCount = -1), (this.time = 0), (this.operators = { Add: "+", Subtract: "-", Multiply: "*", Divide: "/" });
    ...
    (Shader.prototype.prepare = function (e) {
        ...
        for (var a in ((t += "varying vec2 vUv0;"), (t += "uniform float uTime;"), this.layers)) {
            this.layers[a];
            (t += "uniform sampler2D layer_" + a + ";"), (t += "uniform vec2 position_" + a + ";"), (t += "uniform vec2 scale_" + a + ";"), (t += "uniform vec4 color_" + a + ";");
        }
        for (var i in ((t += "void main(void){"), (t += "vec4 color = vec4(0.0, 0.0, 0.0, 0.0);"), this.layers)) {
            var r = this.layers[i];
            (t += "vec2 pos_" + i + " = position_" + i + ";"),
                (t += "pos_" + i + ".x = pos_" + i + ".x * "),
                "Linear" == r.timeMethodX ? (t += "uTime") : "Sine" == r.timeMethodX ? (t += "sin(uTime)") : "Cosine" == r.timeMethodX && (t += "cos(uTime)"),
                (t += ";"),
                (t += "pos_" + i + ".y = pos_" + i + ".y"),
                (t += " * "),
                "Linear" == r.timeMethodY ? (t += "uTime") : "Sine" == r.timeMethodY ? (t += "sin(uTime)") : "Cosine" == r.timeMethodY && (t += "cos(uTime)"),
                (t += ";"),
                (t += "vec4 texture_" + i + " = texture2D(layer_" + i + ","),
                (t += "vUv0 * scale_" + i + " + pos_" + i + ");"),
                "Alpha" != r.channel && (t += "color" + this.operators[r.method] + "= texture_" + i + " * color_" + i + ";");
        }
...
Notify.attributes.add("notifyElement", { type: "entity" }),
    ...
    (Notify.prototype.onNotify = function (t) {
        ...
        (n.findByName("Text").element.text = e),
            ...
            n.tween(n.getLocalPosition()).to({ x: 0, y: i, z: 0 }, 0.1, pc.BackOut).start(),
...
Selection.attributes.add("default", { type: "string" }),
    Selection.attributes.add("holderEntity", { type: "entity" }),
    Selection.attributes.add("onSelect", { type: "string" }),
    Selection.attributes.add("onEmpty", { type: "string" }),
    (Selection.prototype.initialize = function () {
        (this.currentSelection = []), this.app.on("Selection:" + this.entity.name, this.onSelection, this), this.app.fire("Selection:" + this.entity.name, JSON.parse(this.default)), this.on("destroy", this.onDestroy, this);
    }),
    ...
    (Selection.prototype.onSelection = function (t) {
        ...
        for (var s in o) {
            var c = o[s];
            c && c.script && c.script.toggle && (this.currentSelection.indexOf(c.id) > -1 ? c.script.toggle.setState(!0) : c.script.toggle.setState(!1));
        }
        0 === this.currentSelection.length && this.onEmptyTrigger(), this.onSelectTrigger(this.currentSelection);
    });
var Toggle = pc.createScript("toggle");
Toggle.attributes.add("show", { type: "entity", array: !0 }),
    Toggle.attributes.add("hide", { type: "entity", array: !0 }),
    Toggle.attributes.add("backgroundEntity", { type: "entity" }),
    Toggle.attributes.add("active", { type: "rgb" }),
    Toggle.attributes.add("inactive", { type: "rgb" }),
    (Toggle.prototype.setState = function (t) {
        for (var e in ((this.backgroundEntity.element.color = !0 === t ? this.active : this.inactive), this.show)) {
...
CustomText.attributes.add("key", { type: "string", default: "message" }),
    (CustomText.prototype.initialize = function () {
        (this.originalText = this.entity.element.text + ""), this.app.on("CustomText:" + this.entity.name, this.setCustomText, this), this.on("destroy", this.onDestroy, this);
    }),
...
DataTransformer.attributes.add("transformers", {
    ...
    DataTransformer.attributes.add("trigger", { type: "string" }),
    (DataTransformer.prototype.initialize = function () {
        this.app.on("DataTransformer:" + this.entity.name, this.setCustomText, this), this.on("destroy", this.onDestroy, this);
    }),
...
NewsSlider.attributes.add("items", {
    ...
    schema: [
        ...
        { name: "thumbnail", type: "asset", assetType: "texture" },
        { name: "backgroundColor", type: "rgb" },
        { name: "strokeColor", type: "rgb" },
    ],
    array: !0,
}),
    NewsSlider.attributes.add("titleEntity", { type: "entity" }),
    NewsSlider.attributes.add("thumbnailEntity", { type: "entity" }),
    NewsSlider.attributes.add("strokeEntity", { type: "entity" }),
    NewsSlider.attributes.add("backgroundEntity", { type: "entity" }),
    NewsSlider.attributes.add("duration", { type: "number", default: 1.5 }),
    ...
    (NewsSlider.prototype.setSlideItem = function () {
        return (
            ...
            (this.sliderTimeout = setTimeout(
                function (t) {
                    t.app.fire("Timeline:Thumbnail", { isReverse: !0 }),
                        t.app.fire("Timeline:Stroke", { isReverse: !0 }),
                        setTimeout(function () {
                            t.setSlideItem();
                        }, 2e3);
                },
...
Conditions.attributes.add("conditions", {
    type: "json",
    schema: [
        { name: "method", type: "string", enum: [{ Query: "Query" }, { GlobalVariable: "GlobalVariable" }], default: "Query" },
    ...
    (Conditions.prototype.initialize = function () {
        this.app.on("Conditions:" + this.entity.name, this.onConditionTrigger, this), this.on("destroy", this.onDestroy, this);
    }),
    ...
    (Conditions.prototype.onConditionTrigger = function (data) {
        for (var conditionIndex in this.conditions) {
            ...
            if ("GlobalVariable" == condition.method) eval(condition.query) && this.triggerAction(condition.action);
            else {
                var query = condition.query.replace(/\|\| /g, "|| data.");
                (query = query.replace(/\&\& /g, "&& data.")), eval("data." + query) && this.triggerAction(condition.action);
            }
        }
    }),
...
Delay.attributes.add("conditions", {
    ...
    (Delay.prototype.initialize = function () {
        this.app.on("Delay:" + this.entity.name, this.onTrigger, this), this.on("destroy", this.onDestroy, this);
    }),
...
Show.attributes.add("conditions", {
    type: "json",
    schema: [
        { name: "name", description: "name is key to trigger specific action", type: "string" },
        { name: "action", type: "string", enum: [{ Show: "Show" }, { Hide: "Hide" }], default: "Show" },
        { name: "elements", type: "entity", array: !0 },
    ],
    array: !0,
}),
    (Show.prototype.initialize = function () {
        this.app.on("Show:" + this.entity.name, this.onConditionTrigger, this), this.on("destroy", this.onDestroy, this);
    }),
...
ConditionPositioning.attributes.add("conditions", {
    ...
    schema: [
        ...
        { name: "scale", type: "vec3", default: [1, 1, 1] },
        { name: "setAnchor", type: "boolean", default: !1 },
        { name: "anchor", type: "vec4", default: [0, 0.5, 0, 0.5] },
        { name: "visible", type: "boolean", default: !0 },
    ],
    array: !0,
}),
    (ConditionPositioning.prototype.initialize = function () {
        this.app.on("ConditionPositioning:" + this.entity.name, this.onConditionTrigger, this), this.on("destroy", this.onDestroy, this);
    }),
    ...
    (ConditionPositioning.prototype.onConditionTrigger = function (data) {
        for (var conditionIndex in this.conditions) {
            ...
            (query = query.replace(/\&\& /g, "&& data.")), eval("data." + query) && this.triggerChanges(condition);
        }
    }),
    (ConditionPositioning.prototype.triggerChanges = function (i) {
        i.entity.setLocalPosition(i.position), i.entity.setLocalScale(i.scale), i.entity.setLocalEulerAngles(i.rotation), i.setAnchor && (i.entity.element.anchor = i.anchor), (i.entity.enabled = i.visible);
    });
...
Water.attributes.add("normal", { type: "asset", assetType: "texture" }),
    Water.attributes.add("foam", { type: "asset", assetType: "texture" }),
    Water.attributes.add("speed", { type: "number", default: 0.1 }),
    Water.attributes.add("scale", { type: "number", default: 2 }),
    (Water.prototype.initialize = function () {
        (this.material = !1),
            (this.loadedCount = 0),
            (this.totalAssetCount = 2),
            this.normal || this.foam || ((this.normal = this.app.assets.find("Water-Normal-Small.jpg")), (this.foam = this.app.assets.find("Foam-Texture.png"))),
...
Ripple.attributes.add("gradient", { type: "asset", assetType: "texture" }),
    Ripple.attributes.add("loop", { type: "boolean", default: !0 }),
    ...
    (Ripple.prototype.onReady = function () {
        this.loop ? (this.material = this.entity.model.meshInstances[0].material) : (this.material = this.entity.model.meshInstances[0].material.clone()),
    ...
    (Ripple.prototype.update = function (t) {
        ...
        this.material.setParameter("scale", this.scale),
            ...
            !0 === this.loop ? ((this.scale += t * this.speed), (this.time = 1)) : ((this.scale += t * this.speed), (this.time = Math.cos(this.scale)));
    });
var Lightmapped = pc.createScript("lightmapped");
(Lightmapped.prototype.initialize = function () {
    var t = this;
    for (var s in ((this.loadedCount = 0), (this.totalCount = 0), (this.assets = []), (this.models = this.entity.findComponents("model")), this.models)) {
        var e = this.models[s];
...
(Trap.prototype.initialize = function () {
    ...
    (Trap.prototype.onTrigger = function () {
        ...
        (this.nextState = 0),
            this.entity.sound && (this.entity.sound.play("Open"), this.app.fire("Overlay:Sound", "Buff-Attack-1"), this.app.fire("Player:Shake", !0)),
    ...
    (Trap.prototype.update = function () {
        if (!this.stick) return !1;
        (this.state = pc.math.lerp(this.state, this.nextState, 0.3)), this.stick.setLocalPosition(0, this.state, 0);
    });
var GroupTrigger = pc.createScript("groupTrigger");
GroupTrigger.attributes.add("entities", { type: "entity", array: !0 }),
    GroupTrigger.attributes.add("timeout", { type: "number", default: 2 }),
...
Splash.attributes.add("gradient", { type: "asset", assetType: "texture" }),
    Splash.attributes.add("speed", { type: "number", default: 1 }),
    ...
    (Splash.prototype.update = function (t) {
        this.isPlaying && (this.material.setParameter("scale", this.scale), this.material.setParameter("time", Math.cos(this.scale + 1)), (this.scale += t * this.speed), (this.time = pc.math.lerp(this.time, 0, 0.01)));
    });
var GroupBatcher = pc.createScript("groupBatcher");
GroupBatcher.attributes.add("groupEntity", { type: "entity" }),
    GroupBatcher.attributes.add("count", { type: "number", default: 3 }),
    GroupBatcher.attributes.add("timeout", { type: "number", default: 2 }),
    GroupBatcher.attributes.add("garbageEntity", { type: "entity" }),
    (GroupBatcher.prototype.initialize = function () {
        ...
        this.groupEntity.destroy(), this.app.on("GroupBatcher:" + this.entity.name, this.onTrigger, this), this.app.on("GroupBatcher:" + this.entity.name + "@Reset", this.onReset, this), this.on("destroy", this.onDestroy, this);
    }),
    ...
    (GroupBatcher.prototype.onTrigger = function (t, i) {
        Date.now() - this.times[this.index] > 1e3 * this.timeout && (this.pool[this.index].fire("GroupTrigger", t), (this.times[this.index] = Date.now())), this.index++, this.index > this.count - 1 && (this.index = 0);
    });
...
(Utils.variables.floatingIndex = 0),
    ...
    (Floating.prototype.onDamage = function (t) {
        (this.nextDamageDirection = this.entity.getPosition().clone().sub(t).scale(0.5)),
            ...
            (this.damageTimer = setTimeout(
                function (t) {
                    (t.nextDamageDirection.x = 0), (t.nextDamageDirection.y = 0), (t.nextDamageDirection.z = 0);
                },
                1e3,
                this
            ));
    ...
    (Floating.prototype.update = function (t) {
        this.entity.setPosition(this.startOffset.x + this.damageDirection.x * Math.sin(2 * this.timestamp), this.startOffset.y + 1 * Math.cos(this.timestamp), this.startOffset.z + this.damageDirection.z * Math.sin(2 * this.timestamp)),
            (this.damageDirection = this.damageDirection.lerp(this.damageDirection, this.nextDamageDirection, 0.05)),
            (this.timestamp += 1 * t);
    });
var BakedPhysicsPlayer = pc.createScript("bakedPhysicsPlayer");
BakedPhysicsPlayer.attributes.add("staticEntity", { type: "entity" }),
    BakedPhysicsPlayer.attributes.add("speed", { type: "number", default: 1 }),
    BakedPhysicsPlayer.attributes.add("autoplay", { type: "boolean", default: !1 }),
    BakedPhysicsPlayer.attributes.add("file", { type: "asset", assetType: "json" }),
    BakedPhysicsPlayer.attributes.add("initTrigger", { type: "string" }),
    BakedPhysicsPlayer.attributes.add("groundTrigger", { type: "string" }),
    (BakedPhysicsPlayer.prototype.initialize = function () {
        ...
        (this.isPlaying = !1),
            ...
            this.file.ready(function (i) {
                ...
                (t.data = e), (t.count = e.count), (t.duration = e.duration), (t.frames = e.frames), (t.childVertices = e.childVertices), (t.childScale = e.childScale);
            }),
    ...
    (BakedPhysicsPlayer.prototype.onPlay = function (t) {
        (this.isPlaying = !0), (this.isHidden = !1), (this.isEnded = !1), (this.frameIndex = 0), (this.frameTime = 0), t && this.entity.setLocalPosition(t), this.showPool(), this.entity.fire(this.initTrigger);
    }),
    ...
    (BakedPhysicsPlayer.prototype.hidePool = function (t) {
        ...
        if (this.childVertices) for (var i = this.pool.length; i--; ) (this.pool[i].triggered = !1), (this.pool[i].enabled = !1);
    ...
    (BakedPhysicsPlayer.prototype.update = function (t) {
        ...
        for (var i = this.pool.length; i--; ) {
            ...
            if (
                (this.childVertices
                    ? (this.pool[a].node.setLocalPosition(100 * s[1], 100 * s[2], 100 * s[3]), this.pool[a].node.setLocalEulerAngles(s[4], s[5], s[6]))
                    : (this.pool[a].setLocalPosition(s[1], s[2], s[3]), this.pool[a].setLocalEulerAngles(s[4], s[5], s[6])),
                this.groundTrigger)
            ) {
                var h = this.pool[a].node.getPosition().clone();
                !this.pool[a].triggered && this.pool[a].isLarge && h.y < 0 && (this.app.fire(this.groundTrigger, h), (this.pool[a].triggered = !0));
            }
        }
...
(SpriteEffect.prototype.initialize = function () {
    this.app.on("SpriteEffect:" + this.entity.name, this.onTrigger, this), this.on("destroy", this.onDestroy, this);
}),
...
AutoResize.attributes.add("entities", { type: "entity", array: !0 }),
    ...
    (AutoResize.prototype.update = function (e) {
        for (var t = this.entities.length; t--; ) {
            ...
            i && i.element && i.element.width && (i.element.width = this.entity.screen.resolution.x / this.entity.screen.scale);
        }
    });
var WorldToScreen = pc.createScript("worldToScreen");
WorldToScreen.attributes.add("guideEntity", { type: "entity" }),
    ...
    (WorldToScreen.prototype.setEntity = function (t, i) {
        ...
        if (-1 === e) {
            ...
            (s.icon = s.findByName("Icon")), i.color && (s.icon.element.color = i.color), this.entity.addChild(s), this.guideEntities.push(s);
        } else this.guideEntities[e].destroy(), this.lockEntities.splice(e, 1), this.guideEntities.splice(e, 1);
    }),
    (WorldToScreen.prototype.updateEntity = function (t) {
        var i = new pc.Vec3(),
            e = this.cameraEntity.camera,
            s = this.app.graphicsDevice.maxPixelRatio;
        if (!this.lockEntities[t].parent) return this.guideEntities[t].destroy(), this.lockEntities.splice(t, 1), this.guideEntities.splice(t, 1), !1;
        ...
        e.worldToScreen(n, i),
            ...
            (i.y *= s),
            i.x > 0 && i.x < this.app.graphicsDevice.width && i.y > 0 && i.y < this.app.graphicsDevice.height && i.z > 0
                ? (this.guideEntities[t].setLocalPosition(i.x / o, (r.height - i.y) / o, 0), (this.guideEntities[t].enabled = !0))
...
Rating.attributes.add("stars", { type: "entity", array: !0 }),
    Rating.attributes.add("hoverColor", { type: "rgb", default: [1, 0.8, 0] }),
    Rating.attributes.add("disableColor", { type: "rgb", default: [0.2, 0.2, 0.2] }),
    Rating.attributes.add("voteHidden", { type: "entity" }),
    (Rating.prototype.initialize = function () {
        for (var t in (this.app.on("Rating:" + this.entity.name, this.onRating, this), this.stars)) {
            var e = this.stars[t];
            (e.element.rating = this), (e.element.currentIndex = parseInt(t) + 1), e.element.on("mouseenter", this.mouseOver, e.element);
    ...
    (Rating.prototype.mouseOver = function () {
        ...
        for (var e in t) {
            var i = t[e];
            this.currentIndex > parseInt(e) ? (i.element.color = this.rating.hoverColor) : (i.element.color = this.rating.disableColor);
        }
    }),
    (Rating.prototype.onRating = function (t) {
        this.voteHidden.script.hidden.getValue();
        this.app.fire("Fetcher:Rating", { score: t, map: pc.displayMap }), this.app.fire("Notify:Notify", "Thank you for your vote!"), this.app.fire("View:Menu", "Custom");
    });
...
(Domcontroller.prototype.initialize = function () {
    ...
    (Domcontroller.prototype.onShow = function () {
        (this.app.scene.layers.getLayerByName("Lightroom").enabled = !0), (this.app.scene.layers.getLayerByName("Lightroom-Top").enabled = !0);
    ...
    (Domcontroller.prototype.onHide = function () {
        (this.app.scene.layers.getLayerByName("Lightroom").enabled = !1), (this.app.scene.layers.getLayerByName("Lightroom-Top").enabled = !1);
        var e = document.querySelectorAll("table, input, .container");
        e.length > 0 &&
            e.forEach(function (e) {
                if (e.setByDOMController) return !1;
                var t = e.style.display + "";
                (e.currentDisplay = t || "block"), "TABLE" == e.tagName && (e.currentDisplay = "table"), (e.style.display = "none"), (e.setByDOMController = !0);
            });
    });
var StateTrigger = pc.createScript("stateTrigger");
StateTrigger.attributes.add("onEnabled", { type: "string" }),
    StateTrigger.attributes.add("onDisabled", { type: "string" }),
...
GroupAction.attributes.add("actions", {
    ...
    schema: [
        { name: "entity", type: "entity" },
        { name: "action", type: "string" },
        { name: "delay", type: "number", default: 0, title: "Delay (1s)" },
        { name: "global", type: "boolean", default: !1 },
    ],
    array: !0,
}),
    (GroupAction.prototype.initialize = function () {
        this.app.on("GroupAction:" + this.entity.name, this.onTrigger, this), this.on("destroy", this.onDestroy, this);
    }),
    ...
    (GroupAction.prototype.triggerAction = function (t, i, o, n) {
        var e = o.split("@");
        t ? (e.length > 1 ? this.app.fire(e[0], e[1]) : this.app.fire(o, n)) : e.length > 1 ? i.fire(e[0], e[1]) : i.fire(o, n);
    }),
...
CustomColor.attributes.add("key", { type: "string", default: "message" }),
    (CustomColor.prototype.initialize = function () {
        this.app.on("CustomColor:" + this.entity.name, this.setCustomColor, this), this.on("destroy", this.onDestroy, this);
    }),
...
Hover.attributes.add("hasOrigin", { type: "boolean", default: !1 }),
    Hover.attributes.add("hoverType", { type: "string", enum: [{ Scale: "Scale" }, { Opacity: "Opacity" }], default: "Scale" }),
    ...
    (Hover.prototype.onSelect = function (t) {
        for (var e in this.items) {
            var i = this.items[e],
                o = i;
            this.hasOrigin && (o = i.findByName("Origin")), "Scale" == this.hoverType ? o && (t == i ? o.setLocalScale(1.15, 1.15, 1.15) : o.setLocalScale(1, 1, 1)) : (i.element.opacity = t == i ? 1 : 0.3);
        }
    }),
...
AttachToBone.attributes.add("relations", {
    ...
    schema: [
        { name: "entity", type: "entity" },
        { name: "bone", type: "string" },
        { name: "attach", type: "boolean", default: !0 },
    ],
    array: !0,
}),
    ...
    (AttachToBone.prototype.onLoad = function () {
        for (var t in this.relations) {
            ...
            e.attach && (e.entity.reparent(this.entity.findByName(e.bone)), e.entity.setLocalScale(100, 100, 100));
        }
    });
var FriendList = pc.createScript("friendList");
(FriendList.prototype.initialize = function () {
    var t = this.app.assets.find("FriendList.css"),
        i = document.createElement("style");
    (i.innerHTML = t.resource),
        document.body.appendChild(i),
        (this.isHashSet = !1),
        this.app.on("FriendList:Show", this.show, this),
        this.app.on("FriendList:SetHash", this.setHash, this),
        this.app.on("FriendList:AddFriend", this.addFriend, this),
        this.app.on("FriendList:SetOnlineCount", this.setOnlineCount, this);
}),
    (FriendList.prototype.show = function (t) {
        chat.open();
    }),
    (FriendList.prototype.setHash = function (t) {
        if (this.isHashSet) return !1;
        chat.init(), chat.connect(t.hash), chat.open(!0), chat.showNotification("Open friends with SHIFT + C"), (this.isHashSet = !0);
    }),
    (FriendList.prototype.addFriend = function (t) {
        pc.app.fire("Page:Menu", "Account"),
            setTimeout(
                function (t) {
                    pc.app.fire("Tab:Profile", "Following");
                },
                500,
                this
            );
    }),
    (FriendList.prototype.setOnlineCount = function (t) {
        this.onlineCounterEntity.element.text = t;
    });
var chat = {
    players: [],
    isOnline: !0,
    ...
    init: function () {
        (document.onkeypress = function (e) {
            67 == e.keyCode && 1 == e.shiftKey && "INPUT" != document.activeElement.tagName && chat.toggle();
        }),
    ...
    onMessage: function (e) {
        var t = new Uint8Array(e.data);
        t = MessagePack.Buffer.from(t);
        var n = this.pack.decode(t);
        n && this.parse(n);
    },
    parse: function (e) {
        if (0 === e.length) return !1;
        this[e[0]](e.splice(1, e.length + 1));
    },
    send: function (e) {
        this.ws && this.ws.readyState == this.ws.OPEN && this.ws.send(this.pack.encode(e));
    },
    ...
    friends: function (e) {
        this.setPlayers(e[0]), Utils.getItem("status") && ((this.footerOption.value = "My Status : " + Utils.getItem("status")), this.footerOption.onchange());
    },
    online: function (e) {
        for (var t in this.players) {
            var n = this.players[t];
            n.username == e[0] && ((n.active = !0), (n.inGame = !1));
        }
        this.setPlayers();
    },
    offline: function (e) {
    ...
    in_game: function (e) {
        for (var t in this.players) {
            var n = this.players[t];
            n.username == e[0] && ((n.active = !0), (n.inGame = !0));
        }
        this.setPlayers();
    },
    invite: function (e) {
    ...
    _sendInvite: function (e) {
        (this.roomId = window.location.hash), this.send(["invite", e, this.roomId]);
    },
    onJoinGame: function () {
        this.send(["in-game", this.roomId]);
    },
    acceptInvite: function (e, t) {
        (window.location.hash = t), this.send(["accept", e, t]);
    },
    cancelInvite: function (e, t) {
        this.send(["cancel", e, t]);
    },
    accept: function (e) {
        console.log(e[0], " accepted your invite!"), chat.showNotification(e[0] + " accepted your invite!");
    },
    decline: function (e) {
        console.log(e[0], " declined your invite!"), chat.showNotification(e[0] + " declined your invite!");
    },
    open: function (e) {
        if (this.isOpen) return !1;
        if (this.wrapper && e) return !1;
        if (((this.isOpen = !0), this.wrapper))
            return (
                (this.wrapper.style.display = "block"),
                setTimeout(
                    function (e) {
                        (pc.isButtonLocked = !0), (e.sidebar.className = "active");
                    },
                    100,
                    this
                ),
        ...
        (this.wrapper = document.createElement("div")),
            ...
            (this.sidebar.onclick = function (e) {
                e.stopPropagation();
            }),
            e ||
                setTimeout(
        ...
        (t.id = "title"), (t.innerHTML = "Friends"), t.appendChild(this.onlineCounter);
        ...
        (i.id = "add-friend"),
            (i.type = "button"),
            (i.innerText = "[+] Click here to add friend"),
            (i.onclick = function () {
                chat.close(), pc.app.fire("FriendList:AddFriend", !0);
            }),
            this.sidebar.appendChild(t),
            this.sidebar.appendChild(n),
            this.sidebar.appendChild(i),
        ...
        (s.id = "footer-description"), (s.innerText = "You need to follow each other in order to use friends system."), this.sidebar.appendChild(s);
        var a = document.createElement("div");
        (a.id = "footer"), (this.footerOption = document.createElement("select")), (this.footerOption.className = "");
        var c = "<option " + (chat.isOnline ? "selected" : "") + ">My Status : Online</option>";
        (c += "<option " + (chat.isOnline ? "" : "selected") + ">My Status : Offline</option>"),
            (this.footerOption.innerHTML = c),
            (this.footerOption.onchange = function () {
                var e = this.value.split(" : ")[1];
                (this.className = "Online" == e ? "online" : "offline"), chat.setStatus(e), Utils.setItem("status", e);
            }),
            a.appendChild(this.footerOption),
            this.sidebar.appendChild(a),
            this.wrapper.appendChild(this.sidebar),
            document.body.appendChild(this.wrapper),
            e && ((this.wrapper.style.display = "none"), (this.isOpen = !1));
    },
    close: function () {
        (pc.isButtonLocked = !1), (this.wrapper.style.display = "none"), (this.sidebar.className = ""), (this.messageUsername = !1), (this.isOpen = !1);
    },
    toggle: function () {
        this.isOpen ? this.close() : this.open();
    },
    setPlayers: function (e) {
        if ((e && (this.players = e), !this.sidebar)) return !1;
        this.emptyWarning.remove(),
            this.playerHolder && this.playerHolder.remove(),
        ...
        for (var n in this.players) {
            var i = this.players[n],
                ...
                a = "";
            if (
                ((a += '<span class="status ' + (i.active ? "online" : "") + '"></span>'), (a += '<span class="username">' + i.username + "</span>"), (s.className = i.active ? "online" : "offline"), (s.innerHTML = a), i.active && !i.inGame)
            ) {
                var c = document.createElement("button");
                (c.innerText = "⚔️ Invite"),
                    (c.username = i.username),
                    (c.className = "invite-button"),
                    (c.onclick = function () {
            ...
            if (i.inGame) {
                ...
                (o.innerText = "Playing Game"), (o.className = "player-status"), s.appendChild(o);
            }
            if (i.active) {
                var h = document.createElement("button");
                (h.innerText = "💭"),
                    (h.username = i.username),
                    (h.className = "invite-button chat-button"),
                    (h.onclick = function () {
            ...
            this.playerHolder.appendChild(s);
        }
        (this.onlineCounter.innerText = "(" + t + ")"), pc.app.fire("CustomText:OnlineFriends", t + " / " + this.players.length);
    },
    showInvite: function (e, t) {
        var n = '<span class="status online"></span><b>' + e + "</b> invites you!",
            i = document.createElement("button");
        (i.className = "invite-button"),
            (i.innerHTML = "⚔️ Accept"),
            (i.data = { username: e, hash: t }),
            (i.onclick = function () {
                this.parentElement.remove(), chat.acceptInvite(this.data.username, this.data.hash);
            });
        var s = document.createElement("button");
        (s.className = "invite-button cancel-button"),
            (s.innerHTML = "Cancel"),
            (s.data = { username: e, hash: t }),
            (s.onclick = function () {
                this.parentElement.remove(), chat.open(), chat.cancelInvite(this.data.username, this.data.hash);
            });
        var a = document.createElement("div");
        (a.className = "invite-notification"),
            (a.innerHTML = n),
            a.appendChild(s),
            a.appendChild(i),
            setTimeout(
                function (e) {
                    e.className = "invite-notification active";
                },
                100,
                a
            ),
            this.notificationHolder.appendChild(a);
    },
    showNotification: function (e, t, n) {
        var i = "" + e,
            s = document.createElement("div");
        (s.className = "invite-notification"),
            (s.innerHTML = i),
            t &&
                n &&
                (s.onclick = function () {
                    "chat" == t && chat.openMessagePanel(n);
                }),
            setTimeout(
                function (e) {
                    e.className = "invite-notification active";
            ...
            this.notificationHolder.appendChild(s);
    },
    closeMessagePanel: function () {
        this.chatPanel.remove(), (this.messageUsername = !1), (this.isChatPanelOpen = !1), (this.chatPanel = !1);
    },
    openMessagePanel: function (e) {
        if ((chat.open(), chat.messageUsername != e && this.chatMessages && ((this.chatMessages.innerHTML = ""), chat.messages[e])))
            for (var t in ((this.chatUsername.innerHTML = "💭 <span>" + e + "</span>"), chat.messages[e])) {
                var n = chat.messages[e][t];
                ((s = document.createElement("li")).innerHTML = "<b>" + n[0] + " :</b> " + n[1]), (s.className = n[2] ? "me" : ""), this.chatMessages.appendChild(s), (this.chatMessages.scrollTop = 1e5);
            }
        if (((chat.messageUsername = e), this.chatPanel)) return this.chatInputBox.focus(), (this.isChatPanelOpen = !0), !1;
        (this.chatPanel = document.createElement("div")),
            (this.chatPanel.id = "chat-panel"),
            (this.chatPanel.onclick = function (e) {
                e.stopPropagation(), chat.chatInputBox.focus();
            }),
            (this.chatTitle = document.createElement("div")),
            (this.chatTitle.id = "chat-title"),
            (this.chatUsername = document.createElement("span")),
            (this.chatUsername.innerHTML = "💭 <span>" + e + "</span>");
        ...
        if (
            ...
            this.chatTitle.appendChild(i),
            (this.chatMessages = document.createElement("div")),
            (this.chatMessages.id = "chat-messages"),
            chat.messages[e])
        )
            for (var t in chat.messages[e]) {
                var s;
                n = chat.messages[e][t];
                ((s = document.createElement("li")).innerHTML = "<b>" + n[0] + " :</b> " + n[1]), (s.className = n[2] ? "me" : ""), this.chatMessages.appendChild(s), (this.chatMessages.scrollTop = 1e5);
            }
        (this.chatInputBox = document.createElement("input")),
            ...
            (this.chatInputBox.onkeydown = function (e) {
                "Enter" == e.key && (document.activeElement == this && this.value.length > 0 ? (chat.sendMessage(this.value), (this.value = "")) : this.focus());
            }),
            ...
            (chat.isChatPanelOpen = !0);
    },
    notification: function (e) {
        chat.messageUsername != e[2] && chat.showNotification(e[0], e[1], e[2]);
    },
    sendMessage: function (e) {
        this.send(["message", chat.messageUsername, e]);
    },
    message: function (e) {
        if ((chat.messages[e[0]] || (chat.messages[e[0]] = []), chat.messages[e[3]] || (chat.messages[e[3]] = []), chat.messages[e[0]].push(e), chat.myUsername == e[0] && chat.messages[e[3]].push(e), !chat.chatMessages)) return !1;
        if (chat.messageUsername == e[0] || chat.myUsername == e[0]) {
            var t = document.createElement("li");
            (t.innerHTML = "<b>" + e[0] + " :</b> " + e[1]), (t.className = e[2] ? "me" : ""), chat.chatMessages.appendChild(t), (chat.chatMessages.scrollTop = 1e5);
        }
    },
};
var Select = pc.createScript("select");
Select.attributes.add("options", { type: "string", array: !0 }),
    Select.attributes.add("defaultIndex", { type: "number", default: 0 }),
    Select.attributes.add("fontSize", { type: "number", default: 1 }),
    Select.attributes.add("padding", { type: "number", default: 0 }),
    Select.attributes.add("scaleUnit", { type: "string", enum: [{ "Viewport Width": "vw" }, { "Viewport Height": "vh" }, { Pixel: "px" }], default: "vw" }),
    ...
    Select.attributes.add("triggerChange", { type: "string" }),
    Select.attributes.add("key", { type: "string" }),
    Select.attributes.add("containerEntity", { type: "entity" }),
    ...
    (Select.prototype.createElement = function () {
        ...
        this.options)) {
            ...
            (n.value = i), (n.innerText = i), this.defaultIndex == parseInt(e) && (n.selected = !0), this.element.appendChild(n);
        }
        ((this.element.selectedIndex = this.defaultIndex), (this.element.onchange = this.onChange.bind(this)), this._updateStyle(), this.storeValue) &&
    ...
    (Select.prototype.onDestroy = function () {
        (this.isDestroyed = !0), this.element && this.element.remove(), this.app.off("Select:" + this.entity.name, this.setValue, this);
    }),
    (Select.prototype.onChange = function () {
        if ((this.storeValue && window.localStorage.setItem(this.entity._guid, this.element.selectedIndex), this.triggerChange)) {
        ...
        if (t.entity && t.entity.element && t.entity.element.screenCorners) {
            ...
            if (this.containerEntity) {
                var r = this.containerEntity.scaleX,
                    a = this.containerEntity.scaleY;
                (n = (e[0].x - this.containerEntity.offsetLeft) / r),
                    (s = (e[0].y - this.containerEntity.offsetTop) / a - o + this.containerEntity.element.height),
                    this.containerEntity && this.containerEntity.script.container.autoResize && ((this.element.style.transform = "scale(" + 1 / r + ", " + 1 / a + ")"), (this.element.style.transformOrigin = "left bottom"));
            } else (n = e[0].x), (s = e[0].y);
            (t.element.style.left = n * i + "px"), (t.element.style.bottom = s * i + "px"), (t.element.style.width = l + "px"), (t.element.style.height = o + "px");
        }
    }),
...
Scrollview.attributes.add("speed", { type: "number", default: 1 }),
    (Scrollview.prototype.initialize = function () {
        this.entity.scrollview.on("set:scroll", this.setScroll, this), this.entity.element.on("mousewheel", this.onWheel, this);
    }),
    (Scrollview.prototype.onWheel = function (e) {
        e.event.deltaY > 0 ? (this.entity.scrollview.scroll.y = -this.speed) : (this.entity.scrollview.scroll.y = 1 + this.speed);
    }),
...
var hardwareCheck = {
    ...
    checkHardware: function () {
        if (!window.localStorage.getItem("HardwareCheck")) {
            var e = document.querySelector("#application-canvas").getContext("webgl2"),
                t = document.querySelector("#application-canvas").getContext("webgl2").getExtension("WEBGL_debug_renderer_info");
            "Google SwiftShader" == e.getParameter(t.UNMASKED_RENDERER_WEBGL) && this.showAlert();
        }
    },
    close: function () {
    ...
    showAlert: function () {
        var e = document.createElement("div");
        (e.innerHTML =
            '<h4>Better Performance</h4><p>Looks like you have performance issues, in order to have a better performance</p><p>enable hardware acceleration for your browser.</p><br><p>In Chrome, go to <b>Chrome Menu > Settings > Advanced</b>. Under System, enable Use <b>hardware acceleration</b> when available.</p><p>Relaunch your browser if needed.</p><br><p><a href="javascript:hardwareCheck.close()">Click here to close that screen.</a></p>'),
            (e.style.background = "#fff"),
            (e.style.boxShadow = "0px 0px 50px #000"),
            (e.style.position = "fixed"),
            (e.style.width = "600px"),
            (e.style.left = "50%"),
            (e.style.top = "50%"),
            (e.style.transform = "translate(-50%, -50%)"),
            (e.style.padding = "30px 30px"),
...
CustomCss.attributes.add("files", { type: "asset", assetType: "css", array: !0 }),
        ...
        for (var t in this.files) {
            ...
            this.app.assets.load(a),
                a.ready(function (t) {
                    ...
                    (a.innerHTML = t.resource), document.body.appendChild(a), s++, e === s && pc.app.fire("CustomCSS:Loaded", !0);
                });
        }
    });
var accountManager = {
        ...
        init: function () {
            Credentials.createElement(),
                ...
                pc.app.on("AccountManager:Signup", function () {
                    (Credentials.shadow.className = "active"), accountManager.switch("Signup"), (pc.isButtonLocked = !0);
                }),
                pc.app.on("AccountManager:Login", function () {
                    (Credentials.shadow.className = "active"), accountManager.switch("Login"), (pc.isButtonLocked = !0);
                });
        },
        switch: function (e) {
            "Login" == e && (Credentials.navbarLogin.classList.remove("inactive"), Credentials.navbarSignup.classList.add("inactive"), Credentials.loginModal.classList.remove("inactive"), Credentials.signupModal.classList.remove("active")),
                "Signup" == e && (Credentials.navbarLogin.classList.add("inactive"), Credentials.navbarSignup.classList.remove("inactive"), Credentials.loginModal.classList.add("inactive"), Credentials.signupModal.classList.add("active"));
        },
        close: function () {
        ...
        login: function (e) {
            ...
            (n.style.backgroundColor = "#870909"),
                ...
                setTimeout(function () {
                    (n.innerHTML = 'Enter your username and password for Login. If you dont have an account, go to "Create Account" menu.'), (n.style.backgroundColor = "#14171f"), (n.style.width = "fit-content");
                }, 5e3),
                1 == e.success && (pc.app.fire("Trigger:Login", !0), pc.app.fire("Fetcher:MiniProfile", !0), accountManager.close());
        },
        signup: function (e) {
            ...
            (n.style.backgroundColor = "#870909"),
                (n.style.width = "70%"),
                (n.innerHTML = "" + e.message),
                !0 === e.success && (pc.app.fire("Fetcher:MiniProfile", !0), accountManager.close()),
                setTimeout(function () {
                    (n.innerHTML = 'If you have an account already, go to "Login" menu.'), (n.style.backgroundColor = "#14171f"), (n.style.width = "fit-content");
                }, 5e3);
        },
    ...
    Credentials = {
        ...
        LoginModal: function () {
            ...
            (e.id = "login-Form"), (loginHeaderTitle = document.createElement("div")), (loginHeaderTitle.id = "modal-title");
            var n = document.createElement("div");
            n.id = "modal-login-info";
            var t = document.createElement("p");
            (t.id = "modal-login-text"), (t.innerHTML = 'Enter your username and password for Login. If you dont have an account, go to "Create Account" menu.');
            var a = document.createElement("div");
            a.id = "modal-login-body";
            var i = document.createElement("div");
            (i.id = "modal-login-username-container"), (i.innerHTML = "<p>Username</p>");
            var o = document.createElement("input");
            (o.id = "login_username"), (o.name = "loginUsername"), (o.placeholder = "Username"), (o.type = "text");
            var d = document.createElement("div");
            (d.id = "modal-login-password-container"), (d.innerHTML = "<p>Password</p>");
            var r = document.createElement("input");
            (r.id = "login_password"), (r.name = "loginPassword"), (r.placeholder = "Password"), (r.type = "password");
            var s = document.createElement("div");
            (s.id = "modal-login-button-container"),
                ...
                loginButton.addEventListener("click", function (e) {
                    ...
                    accountManager.service("?request=login", { username: t, password: a }, accountManager.login);
                }),
        ...
        SignupModal: function () {
            var e = document.createElement("form");
            (e.id = "signup-Form"), (signupHeaderTitle = document.createElement("div")), (signupHeaderTitle.id = "modal-title");
            var n = document.createElement("div");
            n.id = "modal-signup-info";
            var t = document.createElement("p");
            (t.id = "modal-signup-text"), (t.innerHTML = 'If you have an account already, go to "Login" menu.');
            var a = document.createElement("div");
            a.id = "modal-signup-body";
            var i = document.createElement("div");
            (i.id = "modal-signup-username-container"), (i.innerHTML = "<p>Username</p>");
            var o = document.createElement("input");
            (o.id = "signup_username"), (o.placeholder = "Username"), (o.type = "text"), (o.name = "signupUsername");
            var d = document.createElement("div");
            (d.id = "modal-signup-password-container"), (d.innerHTML = "<p>Password</p>");
            var r = document.createElement("input");
            (r.id = "signup_password"), (r.placeholder = "Password"), (r.type = "password"), (r.name = "signupPassword");
            var s = document.createElement("div");
            ...
            c.classList.add("signup-button"),
                ...
                c.addEventListener("click", function (e) {
                    ...
                    accountManager.service("?request=create_account", { username: t, password: a }, accountManager.signup);
                }),
...
Fresnel.attributes.add("MeshInstance", { type: "number", default: 0 }),
    Fresnel.attributes.add("Power", { type: "number", default: 5 }),
    Fresnel.attributes.add("Stroke", { type: "number", default: 0.5 }),
    Fresnel.attributes.add("colourA", { type: "rgba" }),
    Fresnel.attributes.add("colourB", { type: "rgba" }),
    Fresnel.attributes.add("burningSpeed", { type: "number", default: 0.2 }),
    Fresnel.attributes.add("burningTexture", { type: "asset", assetType: "texture" }),
    (Fresnel.prototype.initialize = function () {
        (this.isLoaded = !1), (this.isTextureLoaded = !1), (this.time = 0), (this.isBurning = !1), (this.intensity = 0);
        var e = this;
    ...
    (Fresnel.prototype.onLoaded = function () {
        (this.material = this.entity.model.meshInstances[parseInt(this.MeshInstance)].material.clone()),
    ...
    (Fresnel.prototype.update = function (e) {
        if (!this.isLoaded) return !1;
        this.isBurning && this.isTextureLoaded && (this.material.setParameter("time", this.time), (this.time += e * this.burningSpeed)),
            Date.now() - this.lastDamage < 2e3 && Date.now() - this.lastDamage > 100 && (this.material.setParameter("material_emissiveIntensity", this.intensity), (this.intensity = pc.math.lerp(this.intensity, 0, 0.25)));
    });
var DealtDamage = pc.createScript("dealtDamage");
DealtDamage.attributes.add("numberEntity", { type: "entity" }),
    (DealtDamage.prototype.initialize = function () {
        (this.numbers = []), (this.lastDamage = 100), (this.cameraEntity = this.app.root.findByName("Lens")), (this.numberEntity.enabled = !1), this.app.on("DealtDamage:Trigger", this.onDamageDealt, this);
    }),
    ...
    (DealtDamage.prototype.onDamageDealt = function (t, e, a) {
        ...
        (i.element.text = t > 0 ? Math.round(t) + "" : t), (i.player = e), (i.element.offsetX = 50 * Math.random() - 50 * Math.random()), (i.element.offsetY = 20 * -Math.random() + 50), (i.element.opacity = 0);
        var n = 2,
            o = 0.8;
        a && ((n = 3), (o = 1), (i.element.color = pc.colors.explosive)), (this.lastDamage = t);
        var s = i.tween(i.getLocalScale()).to({ x: n, y: n, z: n }, 0.3, pc.BounceOut);
        s.on("complete", function () {
            this.entity.tween(this.entity.getLocalScale()).to({ x: 1, y: 1, z: 1 }, 0.5, pc.BounceOut).start();
        }),
            s.start(),
            this.entity.sound.play("Hit-Impact"),
            i
                .tween(i.element)
                .to({ opacity: 1 }, 0.4, pc.Linear)
                .start()
                .on("complete", function () {
                    i.tween(i.element).to({ opacity: 0, offsetY: 150 }, o, pc.Linear).start();
                }),
            setTimeout(
                function (t, e) {
                    t.destroyEntity(e);
    ...
    (DealtDamage.prototype.updateNumberPosition = function (t) {
        ...
        return (
            ...
            (e.x *= i),
            (e.y *= i),
            void (e.x > 0 && e.x < this.app.graphicsDevice.width && e.y > 0 && e.y < this.app.graphicsDevice.height && e.z > 0
                ? (t.setLocalPosition(e.x / n + t.element.offsetX, (o.height - e.y) / n + t.element.offsetY, 0), (t.element.outlineThickness = t.element.opacity), (t.enabled = !0))
                : (t.enabled = !1)))
        );
    }),
...
MapLoader.attributes.add("mapHolder", { type: "entity" }),
    MapLoader.attributes.add("lightEntity", { type: "entity" }),
    ...
    (MapLoader.prototype.onDestroy = function () {
        this.app.off("MapLoader:Load", this.setMap, this), this.app.off("MapLoader:Clear", this.clearMap, this), this.app.off("MapLoader:Remove", this.removeItem, this);
    }),
    (MapLoader.prototype.setMap = function (t) {
        (this.mapData = t), this.prepare();
    }),
    (MapLoader.prototype.loadMap = function () {
        var t = "https://maps.venge.io/" + this.mapData.hash + ".json";
        this.service(t, this.placeModels.bind(this));
    }),
    (MapLoader.prototype.clearMap = function () {
        for (var t = this.mapEntities.length; t--; ) this.mapEntities[t] && this.mapEntities[t].destroy();
    }),
    (MapLoader.prototype.placeModels = function (t) {
        this.clearMap();
        var e = t.objects;
        for (var a in e) this.createObject(e[a]);
        this.setSkybox(t.skybox), this.app.fire("BatchManager:Generate", !0);
    }),
    (MapLoader.prototype.setSkybox = function (t) {
        var e = this.app.assets.find(t.name);
        if (!t) return !1;
        this.app.assets.load(e),
            e.ready(function () {
                pc.app.scene.skybox = e.resource;
            });
        var a = this.lightEntity.clone();
        (a.light.color = Utils.hex2RGB(t.sunColor)), (a.light.intensity = t.intensity), (a.enabled = !0), this.mapHolder.addChild(a), this.mapEntities.push(a);
        var i = Utils.hex2RGB(t.ambientColor);
        (this.app.scene.ambientLight.r = i.r), (this.app.scene.ambientLight.g = i.g), (this.app.scene.ambientLight.b = i.b), (this.app.scene.skyboxIntensity = t.skyboxIntensity), this.app.fire("Loader:SetSkybox", t);
    }),
    (MapLoader.prototype.findItemByName = function (t) {
        var e = !1;
        for (var a in this.entities) {
            var i = this.entities[a];
            t == i.name && (e = i);
        }
        return e;
    }),
    (MapLoader.prototype.createCustomObject = function (t) {
        var e = new pc.Entity(t.name);
        if (("CapturePoint" == t.name && e.tags.add("Objective"), t.tags)) for (var a in t.tags) e.tags.add(t.tags[a]);
        e.setLocalPosition(t.position[0], t.position[1], t.position[2]), (e.enabled = !0), this.mapHolder.addChild(e), this.mapEntities.push(e);
    }),
    (MapLoader.prototype.createObject = function (t) {
        var e = this.findItemByName(t.name);
        if (!e) return this.createCustomObject(t), !1;
        if (e.tags.list().indexOf("Hidden") > -1) return !1;
        var a = e.clone();
        if (
            ((a.model.castShadows = !0),
            (a.model.receiveShadows = !0),
            this.app.fire("BatchManager:Create", a),
            t.script_data && (a.addComponent("script"), a.script.create(t.script_data.name, t.script_data.attributes)),
            t.guid && (a.server_id = t.guid),
            t.tags)
        )
            for (var i in t.tags) a.tags.add(t.tags[i]);
        a.setEulerAngles(t.rotation.x, t.rotation.y, t.rotation.z), a.setPosition(t.position.x, t.position.y, t.position.z), (a.enabled = !0), this.mapHolder.addChild(a), this.mapEntities.push(a);
    }),
    (MapLoader.prototype.removeItem = function (t) {
        for (var e in this.mapEntities) {
            var a = this.mapEntities[e];
            if (a && a.server_id == t) {
                a.setPosition(1e3, 1e3, 1e3);
                var i = a.findByName("Collision");
                i && i.destroy();
            }
        }
    }),
    (MapLoader.prototype.prepare = function () {
        this.service("https://gateway.venge.io/editor.php?hash=" + this.mapData.hash, this.setModels.bind(this));
    }),
    (MapLoader.prototype.setModels = function (t) {
        for (var e in ((this.loadedModelsCount = 0), (this.totalModelsCount = t.length - 1), t)) {
            var a = t[e];
            this.loadModel(a);
        }
    }),
    (MapLoader.prototype.loadModel = function (t) {
        var e = this;
        if (t.model.search(".json") > -1) return !1;
        this.app.assets.loadFromUrl(t.model, "container", function (a, i) {
            var o = new pc.Entity(t.name);
            for (var s in (o.addComponent("model"), (o.model.asset = i.resource.model), t.textures)) {
                var r = t.textures[s];
                e.loadTexture(s, r, o);
            }
            for (var n in (o.setLocalScale(t.scale[0], t.scale[1], t.scale[2]), t.children)) {
                var p = t.children[n],
                    d = new pc.Entity(p.name);
                for (var l in (d.addComponent("collision", p.collision), d.addComponent("rigidbody", { friction: 0.5, restitution: 0.5, type: pc.BODYTYPE_STATIC }), p.tags)) {
                    var h = p.tags[l];
                    d.tags.add(h);
                }
                d.setLocalPosition(p.position[0], p.position[1], p.position[2]), d.setLocalEulerAngles(p.rotation[0], p.rotation[1], p.rotation[2]), o.addChild(d);
            }
            for (var c in t.tags) o.tags.add(t.tags[c]);
            (o.enabled = !1), e.mapHolder.addChild(o), e.entities.push(o), e.loadedModelsCount++, e.loadedModelsCount == e.totalModelsCount && e.loadMap();
        });
    }),
    (MapLoader.prototype.loadTexture = function (t, e, a) {
        var i = new pc.StandardMaterial();
        e.diffuseTexture &&
            this.app.assets.loadFromUrl(e.diffuseTexture, "texture", function (o, s) {
                s &&
                    s.resource &&
                    ((i.diffuseMap = s.resource),
                    e.diffuseTiling && ((i.diffuseMapTiling.x = e.diffuseTiling[0]), (i.diffuseMapTiling.y = e.diffuseTiling[1])),
                    e.diffuseColor && ((i.diffuseTint = !0), (i.diffuse = new pc.Color(e.diffuseColor[0], e.diffuseColor[1], e.diffuseColor[2]))),
                    (a.model.meshInstances[t].material = i));
            }),
            e.opacityTexture &&
                this.app.assets.loadFromUrl(e.opacityTexture, "texture", function (t, e) {
                    e && e.resource && ((i.opacityMap = e.resource), (i.opacityMapChannel = "a"), (i.blendType = pc.BLEND_NORMAL), (i.cull = pc.CULLFACE_NONE));
                });
    }),
    (MapLoader.prototype.service = function (t, e) {
        var a = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
        a.open("GET", t),
            (a.onreadystatechange = function () {
                a.readyState > 3 && 200 == a.status && e(JSON.parse(a.responseText));
            }),
...
(BatchManager.prototype.initialize = function () {
    (this.worldLayer = this.app.scene.layers.getLayerByName("World")), (this.lastBatchId = 1e4), (this.groupIds = []), this.app.on("BatchManager:Create", this.createBatch, this), this.app.on("BatchManager:Generate", this.generate, this);
}),
    ...
    (BatchManager.prototype.createBatch = function (a) {
        ...
        console.log("[DEBUG] Batch group created : ", a.name),
            t || (this.lastBatchId++, this.app.batcher.addGroup(a.name, !0, 100, this.lastBatchId), (t = this.app.batcher.getGroupByName(a.name)), this.groupIds.push(t.id)),
            (a.model.batchGroupId = t.id);
    });
var Banner = pc.createScript("banner");
Banner.attributes.add("bannerEntity", { type: "entity" }),
    Banner.attributes.add("groupEntity", { type: "entity" }),
    Banner.attributes.add("dotEntity", { type: "entity" }),
    Banner.attributes.add("dotHolder", { type: "entity" }),
    Banner.attributes.add("width", { type: "number", default: 512 }),
    Banner.attributes.add("duration", { type: "number", default: 5 }),
    ...
    (Banner.prototype.setBannerIndex = function () {
        ...
        if (!this.groupEntity || !this.groupEntity.tween) return !1;
        for (var n in (this.groupEntity.tween(this.groupEntity.getLocalPosition()).to({ x: t, y: 0, z: 0 }, 0.6, pc.ExponentialOut).start(), this.dots)) {
            this.dots[n].setLocalScale(1, 1, 1);
        }
        var e = this.dots[this.index];
        e.tween(e.getLocalScale()).to({ x: 2, y: 2, z: 2 }, 0.4, pc.ExponentialOut).start();
    }),
    (Banner.prototype.setBanners = function (t) {
        ...
        for (var n in t.banners) {
            ...
            a.setLocalPosition(i, 0, 0),
                "Fire" == e.type ? (a.script.button.fireFunction = e.action) : (a.script.button.triggerFunction = 'window.open("' + e.action + '")'),
                (a.enabled = !0),
...
(EventButton.prototype.initialize = function () {
    (this.currentKey = !1), (this.currentEvent = !1), this.entity.on("EventButton:Set", this.setEvent, this), this.entity.element.on("click", this.onClick, this);
}),
...
TypingText.attributes.add("speed", { type: "number", default: 1 }),
    TypingText.attributes.add("background", { type: "entity" }),
    ...
    (TypingText.prototype.onSet = function (t) {
        (this.text = t.split("")), (this.index = 0), this.entity.sound && this.entity.sound.play("Count");
    }),
...
Quests.attributes.add("cardEntity", { type: "entity" }),
    Quests.attributes.add("holderEntity", { type: "entity" }),
    Quests.attributes.add("closeButtonEntity", { type: "entity" }),
    (Quests.prototype.initialize = function () {
        (this.index = 0), (this.realIndex = 0), (this.quests = []), (this.originalQuests = []), this.app.on("Quests:Set", this.showQuests, this), this.app.on("Quests:Close", this.closeQuests, this), this.on("destroy", this.onDestroy, this);
    }),
    (Quests.prototype.onDestroy = function () {
        this.app.off("Quests:Set", this.showQuests, this), this.app.off("Quests:Close", this.closeQuests, this);
    }),
    (Quests.prototype.closeQuests = function () {
        (this.holderEntity.enabled = !1), (this.closeButtonEntity.enabled = !1);
    }),
    ...
    (Quests.prototype.showQuests = function (t) {
        0 === this.quests.length && t && ((this.originalQuests = t.quests), (this.quests = this.filter(t.quests))), this.setQuest();
    }),
    ...
    (Quests.prototype.setQuest = function () {
        ...
        var e = this.cardEntity.clone(),
            ...
            a = 0;
        (e.enabled = !0), (s.element.textureAsset = this.app.assets.find(t.icon)), (e.sound.pitch = 0.8 + 0.1 * this.index), (u.enabled = !1), (h.enabled = !1), e.setLocalPosition(0, -98 * this.realIndex, 0);
        ...
        if (
            ...
            t.total == t.goal &&
                (setTimeout(
                    function (t) {
                        (u.enabled = !0), e.tween(e.getLocalScale()).to({ x: 1.1, y: 1.1, z: 1.1 }, 0.2, pc.BackOut).start(), t.entity.sound.play("Successful");
                    },
                    1500,
                    this
                ),
            ...
            this.realIndex++,
            setTimeout(function () {
                e.tween(e.getLocalScale()).to({ x: 0.9, y: 0.9, z: 0.9 }, 0.2, pc.BackOut).start();
            }, 1600 + a),
        ...
        this.holderEntity
            ...
            .to({ height: 98 * (this.realIndex + 1) }, 0.5, pc.BackOut)
            .delay(1.5 + 0.001 * a)
            .start(),
            setTimeout(
                function (t) {
...
Camera.attributes.add("maxShakeDuration", { type: "number", default: 0.15 }),
    Camera.attributes.add("shakeAmount", { type: "number", default: 0.1 }),
    (Camera.prototype.initialize = function () {
        (this.cameraOffset = new pc.Vec3(0, 0, 0)), (this.shakeDuration = 0), this.app.on("Camera:Shake", this.onCameraShake, this), this.on("destroy", this.onDestroy, this), (pc.dt = 1 / 60);
    }),
    (Camera.prototype.fixedUpdate = function (t, a) {
        return 1 - Math.pow(t * pc.dt, a);
    }),
    (Camera.prototype.onDestroy = function (t) {
        this.app.off("Camera:Shake", this.onCameraShake, this);
    }),
    (Camera.prototype.onCameraShake = function (t, a) {
        (this.shakeDuration = a), (this.currentShakeAmount = this.shakeAmount * t);
    }),
    (Camera.prototype.update = function (t) {
        if (this.shakeDuration > 0)
            ...
            var a = this.fixedUpdate(0.1, t);
            (this.cameraOffset.x = pc.math.lerp(this.cameraOffset.x, 0, a)), (this.cameraOffset.y = pc.math.lerp(this.cameraOffset.x, 0, a)), (this.cameraOffset.z = pc.math.lerp(this.cameraOffset.x, 0, a));
        }
        (this.shakeDuration -= t), this.entity.setLocalPosition(this.cameraOffset.x, this.cameraOffset.y, this.cameraOffset.z);
    });
var Totem = pc.createScript("totem");
Totem.attributes.add("objectId", { type: "string", default: "None" }),
    Totem.attributes.add("collisionEntity", { type: "entity" }),
    (Totem.prototype.initialize = function () {
        var t = this;
        (this.collisionEntity.onShoot = function () {
            t.app.fire("Network:ShootTrigger", t.objectId);
        }),
            this.app.on("Mode:RemoveObject", this.onRemove, this);
    }),
